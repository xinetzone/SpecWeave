...
bash .trae/specs/caffe-framework/caffe-ffi-conv-v4-milestone/deploy/build.sh --cn --profile latency
```
...
```bash
cd .trae/specs/caffe-framework/caffe-ffi-conv-v4-milestone/deploy
