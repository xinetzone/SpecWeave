...
1. [gap_analysis_report.md](../../../../docs/retrospective/archives/spec-working-notes/caffe-framework/caffex-vs-caffe-ffi-gap-analysis/gap_analysis_report.md): 新增第十一章「Conv GEMM调度优化实施」
2. `.trae/specs/caffe-framework/conv-gemm-optimization/` 新增 spec 文档集：
