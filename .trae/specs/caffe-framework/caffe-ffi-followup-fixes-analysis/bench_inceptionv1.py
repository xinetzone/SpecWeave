...
def _add_project_paths():
    ...
    # bench_inceptionv1.py is at: <repo>/.trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/bench_inceptionv1.py
...
def main():
    ...
    if args.proto is None or args.model is None:
        ...
        search_dirs = [
            ...
            Path("/SpecWeave/.trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/converted_models"),
