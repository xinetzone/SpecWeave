...
MODEL_DIR = "/SpecWeave/.trae/specs/caffe-framework/caffe-comprehensive-comparison-test/test-assets/models"
...
def main():
    ...
    report_path = "/SpecWeave/.trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/benchmark_results.json"
