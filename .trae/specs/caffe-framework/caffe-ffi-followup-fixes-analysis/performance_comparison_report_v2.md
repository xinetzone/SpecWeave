...
python .trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/convert_sdk_models.py

# 扫描所有 sdk_* 目录（sdk_full_test, sdk_caffe, sdk_test, sdk_test2, sdk_test3）
python .trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/convert_sdk_models.py --all

# 仅扫描不转换（dry-run）
python .trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/convert_sdk_models.py --dry-run

# 指定输出目录
python .trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/convert_sdk_models.py -o output/path

# 指定目录列表
python .trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/convert_sdk_models.py --sdk-dirs sdk_full_test,sdk_test2
```
...
docker exec -it caffe-ffi-jupyter bash /SpecWeave/.trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/build_and_bench.sh
