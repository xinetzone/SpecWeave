...
# 用法：
#   在容器内（已挂载 /SpecWeave）：
#     bash /SpecWeave/.trae/specs/caffe-framework/caffe-ffi-followup-fixes-analysis/container_build_verify.sh
#   强制重编译：
...
CONDA_ENV="caffe-ffi"
MODEL_DIR="$REPO_ROOT/.trae/specs/caffe-framework/caffe-comprehensive-comparison-test/test-assets/models"
