...
- [x] Task 1: R — 信源采集与事实登记（G1）
  ...
  - [x] 1.4 产出 `.trae/specs/classics-knowledge/create-yinfujing-okf-wiki/facts.md`：≥30 条编号事实，纯客观描述（禁因果词），每条带信源 URL
- [x] Task 2: I — 洞察提炼（G2），依赖 Task 1
  - [x] 2.1 产出 `.trae/specs/classics-knowledge/create-yinfujing-okf-wiki/insights.md`：≥3 条四元组洞察（现象+根因+影响+建议），重点覆盖"托名层/文本层之分"与"丹道/兵机双线解读"
