...
- **AND** 应与 [workflows.md §工作流一](../../../../apps/ai-agents/zhujian-wudao/.agents/workflows.md) 和 [workflows.md §工作流二](../../../../apps/ai-agents/zhujian-wudao/.agents/workflows.md) 保持对齐
...
- **WHEN** 角色在职责描述中引用项目文件
- **THEN** 必须使用相对路径引用（遵循 [conventions.md §交叉引用格式](../../../../apps/ai-agents/zhujian-wudao/.agents/conventions.md)）
