...
> 本目录是 SpecWeave 项目所有规格文档（spec）的指挥中心，按 13 大主题分类组织。本文档由 docgen（C-6）于 **2026-09-15** 自动生成；详细 spec 列表见各主题 README。
...
| [okf-wiki-ecosystem](./okf-wiki-ecosystem/README.md) | 134 | 72 | 7 | 55 | 🔧 [查看](./okf-wiki-ecosystem/README.md) |
...
| [infra-env](./infra-env/README.md) | 28 | 13 | 2 | 13 | 🔧 [查看](./infra-env/README.md) |
| **合计** | **605** | **415** | **51** | **139** | &mdash; |
...
8. [okf-wiki-ecosystem](./okf-wiki-ecosystem/README.md) — 134 spec：外部源码、官方文档、博客文章的知识化转译（OKF 知识包/Wiki 教程）spec
...
13. [infra-env](./infra-env/README.md) — 28 spec：Docker/devcontainer/conda/Jupyter 环境搭建与运维 spec
...
*本看板由 docgen（C-6）于 2026-09-15 生成，后续自动维护。*
