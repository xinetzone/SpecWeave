...
source: .trae/specs/migration-archival/migrate-learning-to-okf-bundles/spec.md（分类映射表）+ docs/knowledge/learning/ 实测（PowerShell Get-ChildItem -Recurse，2026-09-02）
type: facts-ledger
---
