...
- **Description**:
  ...
  - 事实写入 `.trae/specs/coze-dev-okf-wiki/coze-py/facts.md`
...
- **Description**:
  ...
  - 洞察写入 `.trae/specs/coze-dev-okf-wiki/coze-py/insights.md`
...
- **Description**:
  ...
  - 事实写入 `.trae/specs/coze-dev-okf-wiki/coze-studio/facts.md`
...
- **Description**:
  ...
  - 洞察写入 `.trae/specs/coze-dev-okf-wiki/coze-studio/insights.md`
...
- **Description**:
  ...
  - 事实写入 `.trae/specs/coze-dev-okf-wiki/cozeloop-python/facts.md`
...
- **Description**:
  ...
  - 设计知识地图
  - 洞察写入 `.trae/specs/coze-dev-okf-wiki/cozeloop-python/insights.md`
