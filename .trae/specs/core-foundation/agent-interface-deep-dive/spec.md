...
## Background & Context
- **前置资产**：
  - 已有通用wiki：[interface-api-abi-protocol-wiki/](file:///d:/spaces/SpecWeave/docs/knowledge/learning/interface-api-abi-protocol-wiki/)（基础定义参考）
  - 已有Agent协议wiki：[agent-communication-protocols/](file:///d:/spaces/SpecWeave/docs/knowledge/learning/agent-communication-protocols/)（MCP/ACP/A2A/ANP详解）
