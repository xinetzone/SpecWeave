...
## Background & Context
- **前置资产**：
  - 已有通用wiki：[interface-api-abi-protocol-wiki/](../../../../docs/knowledge/learning/01-agent-protocols-interfaces/interface-api-abi-protocol-wiki/README.md)（基础定义参考）
  - 已有Agent协议wiki：[agent-communication-protocols/](../../../../docs/knowledge/learning/01-agent-protocols-interfaces/agent-communication-protocols/README.md)（MCP/ACP/A2A/ANP详解）
