...
- **Description**:
  ...
  - 创建 `.trae/specs/onnx-ecosystem-okf-wiki/` 下的工作目录
- **Test Requirements**:
...
- **Description**:
  ...
  - 提取 ≥50 条编号事实（F-001起），写入 `.trae/specs/onnx-ecosystem-okf-wiki/onnx/facts.md`
...
- **Description**:
  ...
  - 写入 `.trae/specs/onnx-ecosystem-okf-wiki/onnx/insights.md`
- **Test Requirements**:
...
- **Description**:
  ...
  - 提取 ≥30 条事实，写入 `.trae/specs/onnx-ecosystem-okf-wiki/ir-py/facts.md`
