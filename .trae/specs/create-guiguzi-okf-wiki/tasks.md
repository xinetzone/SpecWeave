...
- [x] Task 1: R — 信源采集与事实登记（G1）
  ...
  - [x] 1.5 产出 `.trae/specs/create-guiguzi-okf-wiki/facts.md`：≥30 条编号事实（实际 42 条），纯客观描述（禁因果词），每条带信源 URL
- [x] Task 2: I — 洞察提炼（G2），依赖 Task 1
  - [x] 2.1 产出 `.trae/specs/create-guiguzi-okf-wiki/insights.md`：4 条四元组洞察（现象+根因+影响+建议），覆盖"托名层/文本层之分"与"纵横术与兵家/道家关系"
