...
```mermaid
flowchart TD
    A["确定横评目标<br/>Hy3正式版能力验证"] --> B["选择对比模型<br/>DeepSeek-v4-pro / GLM-5.2"]
    B --> C["变量归一设计<br/>统一任务/提示词/评分"]
    C --> D["搭建测试环境<br/>带loop的Agent环境<br/>Claude Code / WorkBuddy<br/>全部走API实跑"]
    D --> E["执行6个测试场景"]
    E --> E1["3D魔方<br/>逻辑推理+建模细节"]
    E --> E2["切水果<br/>自我规划+物理合理性"]
    E --> E3["电子鼓机<br/>Web Audio+前端审美"]
    E --> E4["民宿官网<br/>品牌理解+视觉设计"]
    E --> E5["财报长任务<br/>工具调用+长程稳定性"]
    E --> E6["文风续写<br/>风格模仿+文字质感"]
    E1 & E2 & E3 & E4 & E5 & E6 --> F["双维度评分"]
    F --> F1["任务完成度<br/>是否完成/是否可用/是否出错"]
    F --> F2["输出质量<br/>细节/审美/逻辑/创意"]
    F1 & F2 --> G["单任务排名"]
    G --> H["综合能力分析<br/>Coding/Agentic/写作/性价比"]
    H --> I["最终结论输出"]
```
