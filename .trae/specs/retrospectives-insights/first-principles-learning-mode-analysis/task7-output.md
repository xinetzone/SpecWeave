...
```mermaid
flowchart LR
    subgraph 三维度对比["三个核心群体的底层维度对比"]
        direction TB
        
        subgraph 学习目标外在性["学习目标外在性（越高越偏向外部驱动）"]
            D1S["学生 ●●●●○"]
            D1W["职场 ●●●○○"]
            D1L["终身 ●○○○○"]
        end
        
        subgraph 时间碎片化程度["时间碎片化程度（越高越难有大块时间）"]
            D2S["学生 ●●●○○"]
            D2W["职场 ●●●●○"]
            D2L["终身 ●●○○○"]
        end
        
        subgraph 深度学习需求["深度学习需求（越高越需要长时连续）"]
            D3S["学生 ●●●●○"]
            D3W["职场 ●●●○○"]
            D3L["终身 ●●●●●"]
        end
        
        subgraph 自控资源不足["自控资源不足程度（越高越容易失控）"]
            D4S["学生 ●●●●○"]
            D4W["职场 ●●●●●"]
            D4L["终身 ●●○○○"]
        end
        
        subgraph 外部干扰强度["外部干扰强度（越高越容易被打断）"]
            D5S["学生 ●●●●○"]
            D5W["职场 ●●●●●"]
            D5L["终身 ●●○○○"]
        end
        
        subgraph 社交义务刚性["社交/工作义务刚性（越高越不能断联）"]
            D6S["学生 ●●●●○"]
            D6W["职场 ●●●●●"]
            D6L["终身 ●●○○○"]
        end
        
        subgraph 动机维持难度["长期动机维持难度（越高越容易放弃）"]
            D7S["学生 ●●●○○"]
            D7W["职场 ●●●●○"]
            D7L["终身 ●●●●●"]
        end
        
        subgraph 手机习惯强度["手机习惯自动性（越高越难抵抗）"]
            D8S["学生 ●●●●●"]
            D8W["职场 ●●●○○"]
            D8L["终身 ●●●○○"]
        end
