...
- **Description**:
  ...
  - 所有事实编号 F-xxx，写入 `.trae/specs/okf-wiki-ecosystem/docs-to-okf-wiki-conversion/supporting-analysis/facts.md`
...
- **Description**:
  ...
  - 设计链接转换映射表：每个旧路径 → 新路径
  - 产出 `.trae/specs/okf-wiki-ecosystem/docs-to-okf-wiki-conversion/supporting-analysis/bundle-mapping.md`
...
- **Description**:
  - 独立验证（不参与转换的子代理执行）：
    ...
    - 输出验证报告到 `.trae/specs/okf-wiki-ecosystem/docs-to-okf-wiki-conversion/supporting-analysis/verification-report.md`
    - 发现的问题逐一修复
