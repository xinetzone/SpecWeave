...
- **Output**: `.trae/specs/okf-wiki-ecosystem/pyinvoke-okf-wiki/facts.md` — 编号事实清单（≥30条，含类/方法签名、参数、行为、数据流）
- **Test Requirements**:
...
- **Output**: `.trae/specs/okf-wiki-ecosystem/pyinvoke-okf-wiki/insights.md` — 3条核心洞察（四元组：陈述/证据/反常识/行动）+ bundle 知识地图
- **Test Requirements**:
...
- **Output**:
  - `.trae/specs/okf-wiki-ecosystem/pyinvoke-okf-wiki/prompt-template.md` — 通用提示词模板
  - `.trae/specs/okf-wiki-ecosystem/pyinvoke-okf-wiki/workflow.md` — 标准化 workflow
- **Test Requirements**:
...
- **Output**: `.trae/specs/okf-wiki-ecosystem/pyinvoke-okf-wiki/review.md` — 审查记录 + 修复后的 bundle
- **Test Requirements**:
