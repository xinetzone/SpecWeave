...
- [x] Task 1: rust 仓库事实采集——编译器流水线
  ...
  - [x] 产出：`.trae/specs/okf-wiki-ecosystem/rust-lang-okf-wiki/facts-rust.md`（编号 F-rust-xxx，每条含源码路径，无"用于/目的是"等推断词）——133 条
...
- [x] Task 2: cargo 仓库事实采集
  ...
  - [x] 产出：`.trae/specs/okf-wiki-ecosystem/rust-lang-okf-wiki/facts-cargo.md`（F-cargo-xxx）——144 条
...
- [x] Task 3: rfcs 仓库事实采集
  ...
  - [x] 产出：`.trae/specs/okf-wiki-ecosystem/rust-lang-okf-wiki/facts-rfcs.md`（F-rfcs-xxx）——177 条

## I 阶段：架构洞察与知识地图（G2 门）

- [x] Task 4: 基于三份事实清单各提炼 3-5 个洞察四元组（陈述+证据+反常识+行动），设计每个 bundle 的概念分组、学习路径与概念-事实映射
  - [x] 产出：`.trae/specs/okf-wiki-ecosystem/rust-lang-okf-wiki/insights.md`（含三仓库洞察与知识地图）——12 条洞察，454 事实 100% 映射
...
- [x] Task 12: 回顾流程，将超大规模 monorepo（rust-lang/rust）分层采样经验沉淀到 `.trae/specs/okf-wiki-ecosystem/rust-lang-okf-wiki/patterns.md`（2 个模式、6 个实战反模式）；spec 目录三件套齐备、tasks 勾选完整
