...
生成区：.trae/specs/okf-wiki-ecosystem/tkinter-okf-wiki/dist/ 镜像 OKF 树；V 阶段门禁后部署至 projects/awesome-okf-xs/doc/，接入 gui 分组 index、jishu 域 index 与总索引对账（invoke gates.bundles）。
