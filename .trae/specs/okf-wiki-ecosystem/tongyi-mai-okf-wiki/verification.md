...
| `.trae/specs/okf-wiki-ecosystem/tongyi-mai-okf-wiki/facts-mobile-world.md` F-050 | 同上（台账同步） |
...
| `.trae/specs/okf-wiki-ecosystem/tongyi-mai-okf-wiki/facts-mobile-world.md` | F-050、F-066 同步重写 |
