...
## Background & Context
- 项目已有 MyST 学习资料库位于 [docs/knowledge/learning/executablebooks-myst-guide/](../../../../docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/)，包含7个核心参考文档和示例
