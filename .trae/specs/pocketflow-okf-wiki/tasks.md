...
- **Description**:
  ...
  - 创建 `.trae/specs/pocketflow-okf-wiki/` 下的各 bundle 工作子目录
- **Test Requirements**:
...
- **Description**:
  ...
  - 提取 ≥40 条编号事实（F-001起），写入 `.trae/specs/pocketflow-okf-wiki/pocketflow-core/facts.md`，同时复制到 `bundles/pocketflow/pocketflow-core/spec/facts.md`
