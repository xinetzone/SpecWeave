...
> 每个模块的完整定义（技术架构、实现步骤、资源需求、预期指标、交互方式、能力范围与约束条件）详见 [.agents/modules/](.agents/modules/) 目录下的独立文件，本文仅作概要说明。
...
| [角色协作场景](.agents/roles/collaboration-scenarios.md) | 中心化与去中心化两种协作模式、角色相互 @ 机制与预期交付物 |
