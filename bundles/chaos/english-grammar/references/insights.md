...
| **伏笔链接（Foreshadowing）** | 相关知识点正文内 | 告诉读者「这个点在后面某章会深化」 | 正文内旁注链接，如「*（此概念将在[第28章关系从句简化](28-reduced-relative-clauses.md)中展开）*」 |
| **回溯链接（Callback）** | 正文讲解新知识点时 | 回顾已学过的前置概念 | 正文内自然链接，如「正如[第13章分词](13-participles.md)所述」 |
