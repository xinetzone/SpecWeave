...
type: Concept
title: "第三章 代名词"
description: "代词（pro-forms）与代名词（pronouns）的概念、代名词与先行词的人称一致/单复数一致/性别考量、以及代名词必须且只能有一个先行词的写作原则"
prerequisites: [07]
foreshadows: [24, 25]
tags: [语法, 词类, 代词, 一致性]
...
sources:
  - id: source-ch03
    resource: "/references/source-ch03.md"
    title: "第三章 代名词信源登记"
---
...
- [07 名词短语](/concepts/07-noun-phrases.md) — 代名词替代的对象是名词短语，先行词概念建立在名词短语之上

### 进阶拓展

- [24 关系从句](/concepts/24-relative-clauses.md) — 关系代词同时连接先行词与从句，是代名词概念的延伸
- [25 主谓一致](/concepts/25-subject-verb-agreement.md) — 人称与单复数一致原则在主谓一致中的系统运用

### 关联参考

- [04 两岸术语对照](/concepts/04-terminology-cross-strait.md#pronoun) — 「代名词/代词」「所有格代名词/物主代词」术语对照
- [03 引：广读学英语](/concepts/03-extensive-reading-method.md) — 代名词使用错误需透过广读培养敏感度
