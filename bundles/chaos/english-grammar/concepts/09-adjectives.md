...
type: Concept
title: "第四章 形容词"
description: "形容词的两种主要位置（名词短语中的 attributive 与补语位置的 predicative）、名词转形容词、复合形容词、只能放在名词短语中的三类形容词、形容词排序原则、后位修饰与 a- 开头形容词、需要补充成分的形容词"
prerequisites: [08]
foreshadows: [10, 12, 13, 28]
tags: [语法, 词类, 形容词]
...
sources:
  - id: source-ch04
    resource: "/references/source-ch04.md"
    title: "第四章 形容词信源登记"
---
...
接下来这个例子，形容词的功能类似时间副词：
  ...
  - Mr. Turner is <u>the present Chairman</u>.（透纳先生是现任的主席。）
    ...
    名词短语中的形容词 present 意思是「现任的」，功用类似时间副词。亦即，整个句子可以这样讲：Tr. Turner is the Chairman at present。如果把形容词 present 直接放在补语位置，成为 The Chairman is present，意思就会转变成「主席在场」。下面这个例子的情况也类似：
      ...
      - George Pritchard is <u>an old friend</u>.（George Pritchard 是个老朋友。）
...
- <u>The new student</u> <u>stayed</u> <u>aloof</u>. S V C（新来的学生和别人保持距离。）
...
- [08 代名词](/concepts/08-pronouns.md) — 上一章词类知识
- [07 名词短语](/concepts/07-noun-phrases.md) — 名词短语构造（限定词+形容词+名词）；形容词在名词短语中的位置由第二章框架奠定

### 进阶拓展

- [10 副词](/concepts/10-adverbs.md) — 形容词与副词的判断对照
- [12 比较句法](/concepts/12-comparative-patterns.md) — 比较级与最高级形容词的句型
- [13 分词](/concepts/13-participles.md) — 现在分词短语作形容词（如 crossing the street）的深入讨论
- [28 关系从句简化](/concepts/28-reduced-relative-clauses.md) — 复合形容词与分词结构本质上源于关系从句简化

### 关联参考

- [04 两岸术语对照](/concepts/04-terminology-cross-strait.md#noun-phrase) — 「名词短语/名词片语」术语对照
