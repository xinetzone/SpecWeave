...
type: Concept
title: "第十六章 复合句"
description: "复合句是由两个以上限定从句经连词连接构成的句子，是简单句→复合句→简化从句三层次的中间层，涵盖对等从句、相关字组倒装与省略"
prerequisites: [20]
foreshadows: [22, 26]
tags: [语法, 复合句, 从句, 简化从句]
...
sources:
  - id: source-ch16
    resource: "/references/source-ch16.md"
    title: "第十六章 复合句信源登记"
---
...
- [20 对等连词](/concepts/20-coordinate-conjunctions.md) — 对等从句由对等连词连接构成，相关字组的对称要求是本章的直接基础

### 进阶拓展

- [22 名词从句](/concepts/22-noun-clauses.md) — 从对等复合句进入从属复杂句，三大从句的第一站
- [26 倒装句](/concepts/26-inversion.md) — 相关字组 not only 移至句首的倒装是倒装句的四种方式之一
