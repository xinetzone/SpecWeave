...
type: Concept
title: "第五章 副词"
description: "副词的种类（方法状态、频率、强调范围、加强语气、程度、连接、分离、介副词）及其在句中的位置选择，兼论副词位置与语意清楚性、形容词与副词的判断"
prerequisites: [09]
foreshadows: [11, 12, 23, 26, 30]
tags: [语法, 词类, 副词]
...
sources:
  - id: source-ch05
    resource: "/references/source-ch05.md"
    title: "第五章 副词信源登记"
---
...
像 always、frequently、usually、often、seldom、hardly、never…… 之类，这些副词用于修饰动作发生的频率，是修饰动词专用的副词。它的位置应该放在动词前后：一般是放在普通动词的前面、be 动词与助动词的后面。不过，这种动词的位置也很有弹性，往往可以移到句首或句尾等其他位置。
  ...
  - I <u>have never seen</u> this man before.（我以前从来没见过这个人。）
...
其他常见的强调范围的副词还包括：just、even、merely、solely、especially、particularly、specifically、mainly、purely 等。例句如下：
  ...
  - He did it purely accidentally.（他做这件事是完全出于意外。）

    副词 purely 修饰的是副词 accidentally。
...
这种副词，意思和对等连接词（ and、or、but ）类似，但是缺乏连接词的语法功能。亦即，连接副词可以用来表示前后两个从句之间的逻辑关系，但是不能用它来连接两个从句， 必须借助标点符号： 加上分号把两个从句分开，或者用句号之类断开变成两句话。
  ...
  - <u>However</u>, projections for the next fiscal year are not very optimistic.（不过，下一个会计年度的预期却不甚乐观。）
...
除了以上整理的加强语气的副词、强调范围的副词、程度副词、以及介副词这四种副词之外，还有时间副词与地方副词这两种也是可以修饰名词的副词。例如：
  ...
  - <u>All the people here</u> are your friends.（这里所有人都是你的朋友。）
...
- [09 形容词](/concepts/09-adjectives.md) — 形容词的两种主要位置与修饰原则，是本章副词位置讨论的对照基础

### 进阶拓展

- [11 介词](/concepts/11-prepositions.md) — 介副词与短语动词的问题将在介词章节详述
- [12 比较句法](/concepts/12-comparative-patterns.md) — 程度副词（rather、fairly、quite）在比较结构中的应用
- [23 副词从句](/concepts/23-adverb-clauses.md) — 分离副词的来源是简化的副词从句，完整结构见副词从句
- [26 倒装句](/concepts/26-inversion.md) — 否定意味的频率副词移到句首加强语气时必须倒装
- [30 副词从句简化](/concepts/30-reduced-adverb-clauses.md) — theoretically speaking 即副词从句简化的残留
