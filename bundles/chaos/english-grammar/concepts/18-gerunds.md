...
type: Concept
title: "第十三章 动名词"
description: "动名词是动词加上-ing当作名词使用的构造，可与普通名词、现在分词比较区分；介词后面只能用动名词，复杂构造可视为简化名词从句看待"
prerequisites: [17]
foreshadows: [19, 29]
tags: [语法, 动词, 动名词, 非限定动词]
...
sources:
  - id: source-ch13
    resource: "/references/source-ch13.md"
    title: "第十三章 动名词信源登记"
---
...
- <u>Raising prices</u> is the only way to make ends meet.（调涨价格，是想要收支平衡的唯一办法。）
...
- [17 语气](/concepts/17-moods.md) — 动名词与不定式的选择涉及语气判断：无不确定语气、不能还原成语气助动词的位置不能使用不定式

### 进阶拓展

- [19 不定式短语](/concepts/19-infinitives.md) — 动名词与不定式皆可当名词使用，两者的系统比较（皆可/只能不定式/只能动名词/意思不同）在下一章展开
- [29 名词从句简化](/concepts/29-reduced-noun-clauses.md) — 复杂的动名词构造（如 John’s smoking three packs of cigarettes a day）本质是 that 名词从句的简化
