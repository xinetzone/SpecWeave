...
type: Concept
title: "第十四章 不定式短语"
description: "不定式短语是to加原形动词的构造，本质为语气助动词简化的结果，可当名词、形容词、副词使用；完成时表达相对过去，使役动词与感官动词后须用原形动词"
prerequisites: [16, 18]
foreshadows: [20, 29, 30]
tags: [语法, 动词, 不定式, 非限定动词]
...
sources:
  - id: source-ch14
    resource: "/references/source-ch14.md"
    title: "第十四章 不定式短语信源登记"
---
...
不定式短语当作名词短语，可以作为主语、宾语、名词补语等等，分别举例如下：
  ...
  - It is very important <u>to be accurate</u>.（准确是非常重要的。）
...
在某些动词后面，如果要用动状词当宾语的话只能用不定式、不能用动名词。例如：
  ...
  - <u>The workers</u> <u>agreed</u> <u>to work overtime</u>. S V O（工人同意加班。）
...
> **小结**：不定式短语是 to + V 的构造，笔者主张：不定式就是语气助动词简化的结果——所有的主要语气助动词都可以改写成不定式（must → have to、should → ought to、will/would → be going to/be willing to、can/could → be able to、may/might → be likely to/be allowed to）。不定式的词类「不定」（当名词、形容词、副词使用都可以），语气也「不定」（属于表达「不确定」意味的「条件语气」），凡是该使用不定式的地方，都可以还原成某一个语气助动词来作合理的诠释。此外，完成时的不定式（to have V-en）表达「相对过去的时间」，使役动词与感官动词后面因结果确定、不能使用带不确定语气的不定式，须移除 to 改用原形动词（被动语态改写后 to 必须放回）。
>
> **展望**：本章将不定式短语视为短语看待——把动词短语中的语气助动词变成表示不定式的 to，产生出来的不定式短语就可以当作名词短语、形容词短语、副词短语使用。至于构造比较复杂的情形（如 asked that he should buy → asked him to buy 的名词从句简化），「简化从句的变化比较复杂，本书留待后面的章节处理」，详见[29 名词从句简化](/concepts/29-reduced-noun-clauses.md)与[30 副词从句简化](/concepts/30-reduced-adverb-clauses.md)。

## 相关概念

### 前置知识

- [16 语气助动词](/concepts/16-modal-auxiliaries.md) — 不定式是语气助动词简化的结果，must → have to 等改写关系是理解 to 的钥匙
- [18 动名词](/concepts/18-gerunds.md) — 不定式与动名词皆可当名词使用，宾语位置的选择需两者的特性比较

### 进阶拓展

- [20 对等连词](/concepts/20-coordinate-conjunctions.md) — 动词体系收官后进入复合句层次的起点
- [29 名词从句简化](/concepts/29-reduced-noun-clauses.md) — to V 作名词时是 that 名词从句的简化产物（如 remember that you must bring → remember to bring）
- [30 副词从句简化](/concepts/30-reduced-adverb-clauses.md) — to V 作副词时对应表目的的副词从句简化（如 in order to）
