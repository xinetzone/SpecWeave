...
* [concepts/](concepts/index.md) - 核心概念：12 篇概念文档，分入门组（00-05）和进阶组（06-11），覆盖从核心抽象到高级特性的完整知识体系
...
* [examples/](examples/index.md) - 使用示例：快速开始与代码用法
  * [快速开始](examples/quickstart.md)
* [references/](references/index.md) - 信源登记簿：3 篇文件，含 R 阶段事实清单、I 阶段洞察、源码登记
