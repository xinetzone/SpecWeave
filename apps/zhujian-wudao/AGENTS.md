...
└── .agents/                       ← 全部项目规范与文档
    ...
    │   ├── ...-insights-31-65.md  # ✅ 洞察 31-65（哲学层+元层）⚠️ 注意：R14已从 insights-31-52.md 重命名，旧文件名已废弃
...
| 已有洞察库（65 条） | [insights-01-30](.agents/docs/superpowers/specs/2026-06-17-zhujian-wudao-insights-01-30.md) + [insights-31-65](.agents/docs/superpowers/specs/2026-06-17-zhujian-wudao-insights-31-65.md) |
