...
`stress_model_latency.py` 集成 ModelProvider，测量模型推理延迟（200ms 基准），扫描不同抖动幅度：

| 抖动(ms) | mean | p50 | p95 | p99 | stdev | max |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 0 | 200.9 | 200.4 | 201.1 | 201.3 | 4.1 | 257.5 |
| 50 | 202.2 | 205.3 | 243.6 | 250.1 | 29.2 | 268.3 |
| 100 | 198.3 | 193.3 | 286.7 | 297.4 | 58.0 | 300.4 |
| 200 | 195.0 | 200.3 | 373.9 | 396.9 | 115.5 | 398.4 |
