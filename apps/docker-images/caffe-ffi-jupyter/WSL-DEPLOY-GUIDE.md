...
7. [开发模式](#7-开发模式)
8. [附录 A：自动化监控平台集成](#附录-a自动化监控平台集成)
9. [附录 B：快速参考卡片](#附录-b快速参考卡片)
10. [附录 C：版本兼容性](#附录-c版本兼容性)
...
进入 WSL 终端后，从 `apps/docker-images/caffe-ffi-jupyter/` 目录执行：

```bash
cd /mnt/d/spaces/SpecWeave/apps/docker-images/caffe-ffi-jupyter
...
```bash
cd /mnt/d/spaces/SpecWeave/apps/docker-images/jupyter-ssh-base
...
| 组件 | 推荐版本 | 最后验证日期 | 备注 |
|------|----------|-------------|------|
| Ubuntu | 24.04 / 26.04 <!-- verified: 2026-07-29 --> | 2026-07-29 | 22.04 仍可用但非推荐 |
| Docker | 27.x <!-- verified: 2026-07-29 --> | 2026-07-29 | 原生Docker或Docker Desktop均可 |
| Python | 3.14 <!-- verified: 2026-07-29 --> | 2026-07-29 | 需3.14+ |
| WSL | WSL2 <!-- verified: 2026-07-29 --> | 2026-07-29 | 不支持WSL1 |
