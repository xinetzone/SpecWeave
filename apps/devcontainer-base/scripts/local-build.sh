...
#   wsl -d Ubuntu-26.04 -- bash /mnt/d/spaces/SpecWeave/apps/devcontainer-base/scripts/local-build.sh [OPTIONS]
#
...
${BOLD}Examples:${NC}
  ...
  wsl -d Ubuntu-26.04 -- bash /mnt/d/spaces/SpecWeave/apps/devcontainer-base/scripts/local-build.sh --cn --native-fs
