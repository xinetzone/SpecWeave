...
在[full-clean-rebuild.sh](file:///d:/spaces/SpecWeave/apps/caffe-ffi-jupyter/scripts/full-clean-rebuild.sh#L157-L163)的Step 4（conda install）**之后**添加post-install清理：
...
**修复**：在[full-clean-rebuild.sh](file:///d:/spaces/SpecWeave/apps/caffe-ffi-jupyter/scripts/full-clean-rebuild.sh#L332)中添加channel参数：
```bash
...
构建产物已复制到 [apps/caffe-ffi-jupyter/artifacts/](file:///d:/spaces/SpecWeave/apps/caffe-ffi-jupyter/artifacts/)：
