...
x-toml-ref: "../../.meta/toml/.agents/protocols/README.toml"
---
# 协议索引与使用流程
...
| **四区域路由体系架构规范** | [four-region-routing-architecture.md](./four-region-routing-architecture.md) | 四区域（.agents/apps/projects/vendor）架构定义、三层路由协议完整版、对称目录结构规范、入口对比表规范、新增区域SOP（10项检查表）、反模式警示 | 全工作区上下文路由、顶层区域治理、新增区域标准流程、架构对称性保障 |
