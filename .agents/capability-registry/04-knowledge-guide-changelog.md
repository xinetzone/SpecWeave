...
- **v1.2** (2026-06-30): 新增知识参考索引区块（docs/knowledge、.agents/docs/retrospective/patterns、.agents/docs/development-standards、.agents/docs/retrospective），完善L0→L1引用链；快速查找指南补充知识库入口。
