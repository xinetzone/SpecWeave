...
id: "spec-writing-07"
title: "07 完整Spec模板"
source: "rules/spec-writing-guide.md#07"
x-toml-ref: "../../../.meta/toml/.agents/rules/spec-writing-guide/07-template-reference.toml"
---
...
← 上一章: [06 正反示例与检查清单](06-examples-checklist.md) | **[返回索引](../spec-writing-guide.md)** | 下一章: [08 PRD Spec格式概述](08-prd-format-overview.md) →
