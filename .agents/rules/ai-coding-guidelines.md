...
**关联规范**：
- [docs/development-standards.md - 简约设计原则](../../docs/tech/references/development-standards.md)
...
- [docs/development-standards.md - 代码风格](../../docs/tech/references/development-standards.md)
...
- [docs/development-standards.md - 测试要求](../../docs/tech/references/development-standards.md)
...
- 整合位置：
  ...
  - [docs/development-standards.md](../../docs/tech/references/development-standards.md) - 原则二、四（简约至上、目标驱动）
