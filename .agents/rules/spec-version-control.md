...
| 文档 | 内容 |
|------|------|
| [01 概述](spec-version-control/01-overview.md) | 概述（目的+适用范围） |
| [02 版本号命名规则](spec-version-control/02-version-naming.md) | 版本号命名规则（X.Y格式+主次版本变更触发条件） |
| [03 变更类型分类](spec-version-control/03-change-types.md) | 变更类型分类（added/modified/removed/deprecated） |
