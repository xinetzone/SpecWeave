...
# 1. 检查 Git 忽略规则
echo -e "\033[33m[1/9] 检查 Git 忽略规则...\033[0m"
...
# 2. 检查 vendor 目录合规性
echo -e "\033[33m[2/9] 检查 vendor 目录合规性...\033[0m"
...
# 3. 检查链接有效性
echo -e "\033[33m[3/9] 检查链接有效性...\033[0m"
...
# 4. 检查 Mermaid 语法安全
echo -e "\033[33m[4/9] 检查 Mermaid 语法安全...\033[0m"
...
# 5. 检查规格文档一致性
echo -e "\033[33m[5/9] 检查规格文档一致性...\033[0m"
...
# 6. 检查模式成熟度字段
echo -e "\033[33m[6/9] 检查模式成熟度字段...\033[0m"
...
# 7. 检查文件名规范
echo -e "\033[33m[7/9] 检查文件名规范...\033[0m"
...
# 8. 更新 Spec 执行进度看板
echo -e "\033[33m[8/9] 更新 Spec 执行进度看板...\033[0m"
...
# 9. 更新导航表
echo -e "\033[33m[9/9] 更新文档导航表...\033[0m"
