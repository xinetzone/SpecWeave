...
---
> **提炼自**：[07-caffe-cpp-slim-tvm-ffi-modernization.md](../../../../../docs/knowledge/learning/08-systems-infrastructure/caffe-architecture-wiki/07-caffe-cpp-slim-tvm-ffi-modernization.md) —— daoflows/caffe现代化改造（compat/适配层设计）
