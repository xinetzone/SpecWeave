...
| [powershell-https-cert-bypass-download.md](powershell-https-cert-bypass-download.md) | PowerShell下载HTTPS证书验证失败FAQ：4种解决方案矩阵+文件大小/魔数双重验证+一键安全下载函数，覆盖RemoteCertificateNameMismatch/SNI错误 | L1 |
