...
- 参考实现：
  - [scripts/healthcheck.sh](file:///d:/spaces/SpecWeave/apps/jupyter-ssh-base/scripts/healthcheck.sh)
  - [config/sshd_config](file:///d:/spaces/SpecWeave/apps/jupyter-ssh-base/config/sshd_config)（LogLevel=ERROR）
  - [config/supervisor/conf.d/jupyter.conf](file:///d:/spaces/SpecWeave/apps/jupyter-ssh-base/config/supervisor/conf.d/jupyter.conf)（stderr 分流）
