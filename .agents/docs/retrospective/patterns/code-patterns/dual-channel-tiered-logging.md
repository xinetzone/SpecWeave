...
x-toml-ref: "../../../../../.meta/toml/.agents/docs/retrospective/patterns/code-patterns/dual-channel-tiered-logging.toml"
---
# 分级日志双轨输出模式
...
[forum-bot.py](../../../../scripts/forum-bot.py) — `setup_logging()` 及辅助函数
