...
**约束模板已落地为标准模板**：参见 [subagent-output-quality-checklist.md](../../../../../templates/subagent-output-quality-checklist.md)
...
1. **P0约束模板**：[.agents/templates/subagent-output-quality-checklist.md](../../../../../templates/subagent-output-quality-checklist.md)
2. **Wiki验收清单**：[.agents/templates/subagent-wiki-delivery-checklist.md](../../../../../templates/subagent-wiki-delivery-checklist.md)（含内容纯净性检查项）
...
| [subagent-output-quality-checklist.md](../../../../../templates/subagent-output-quality-checklist.md) | 落地模板 | 本模式的具体落地checklist模板 |
