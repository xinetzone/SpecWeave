...
### 第一步：确定归属目录（正式文件）
查阅项目知识库入口 [docs/knowledge/README.md](../../../../../../docs/knowledge/README.md)，根据文件内容类型确定应放置的分类目录，如 `learning/`、`operations/`、`troubleshooting/` 等。
...
- [临时依赖管理规范](../../../../../protocols/dependency-management.md)
- [文件名检查脚本](../../../../../scripts/check-filename-convention.py)
- [仓库合规检查脚本](../../../../../scripts/repo-check.py)
- [知识库入口](../../../../../../docs/knowledge/README.md)
- [文件创建指令集](../../../../../commands/file-creation.md)
- [CI 综合检查 Skill](../../../../../skills/ci-check-cmd/SKILL.md)
