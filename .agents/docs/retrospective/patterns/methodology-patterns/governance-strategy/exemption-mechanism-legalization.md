...
**来源**：[L0-L3 流程分级示例模板](../../../../../templates/l0-l3-process-tier-template.md) §3.3 + [A3 实现说明](../../../reports/task-reports/retrospective-l0l3-template-design-20260706/README.md#a3-实现说明baby-前缀运行时识别)
...
- [L0-L3 流程分级示例模板](../../../../../templates/l0-l3-process-tier-template.md) — 探针实现豁免规则的设计载体（§3.3）
