...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/patterns/methodology-patterns/document-architecture/meta-atomization-bisect-overview.toml"
maturity: "L2"
validation_count: 5
reuse_count: 4
...
- [check-links.py](../../../../../scripts/check-links.py)：链接验证（步骤6必跑）
- [finalize-atomization.py](../../../../../scripts/finalize-atomization.py)：原子化收尾（断链修复+导航更新），注意使用 `--scope` 参数限定目录
