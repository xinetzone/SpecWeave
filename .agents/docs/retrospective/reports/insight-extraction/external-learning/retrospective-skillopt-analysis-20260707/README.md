...
- [Spec 三件套（保留在 spec 目录）](../../../../../../../.trae/specs/retrospectives-insights/analyze-skillopt-article/spec.md) —— spec.md / tasks.md / checklist.md / task1-output.md / task2-6-analysis.md 作为过程产物保留
...
- [SpecWeave Skill 体系规范](../../../../../../skills/README.md) —— 本分析建议的改进对象
