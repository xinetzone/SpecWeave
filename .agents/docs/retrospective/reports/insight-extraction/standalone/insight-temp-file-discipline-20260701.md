...
**违反的规范**：
- [.agents/protocols/dependency-management.md](../../../../../protocols/dependency-management.md#L16) 明确规定任务中间产物存放在 `.temp/`
- 项目根目录不应随意创建临时散文件
...
- 临时依赖管理规范：[dependency-management.md](../../../../../protocols/dependency-management.md)
