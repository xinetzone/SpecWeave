...
flowchart LR
    ...
    subgraph sg2 ["工作记忆阶段（10-30s）——最窄瓶颈"]
    ...
    subgraph sg4 ["元认知监控（Flavell, 1979）"]
        M["元认知知识"] -.-> N["监视·评估·调整"]
        O["元认知体验"] -.-> N
        N -.-> C
        N -.-> E
...
```mermaid
flowchart TD
    subgraph sg1 ["四类型学习认知机制对比矩阵"]
        direction TB
        subgraph sg2 ["机械记忆型<br/>词汇·事实·年代"]
            M1["核心机制: 复述·间隔重复"]
            M2["神经基础: 海马体依赖"]
            M3["最佳条件: 分散检索·睡眠巩固"]
            M4["干扰敏感度: 中（打断清空工作记忆）"]
        ...
        subgraph sg3 ["理解领悟型<br/>概念·原理·模型"]
            U1["核心机制: 图式重构·先备知识激活"]
            U2["神经基础: 前额叶-顶叶网络"]
        ...
        subgraph sg4 ["技能熟练型<br/>解题·操作·编程"]
        ...
        subgraph sg5 ["创造生成型<br/>写作·设计·创新"]
