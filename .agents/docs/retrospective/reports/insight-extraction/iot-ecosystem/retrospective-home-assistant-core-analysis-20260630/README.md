...
- **核心入口**：`python -m homeassistant` → [__main__.py](../../../../../../scripts/mdi/__main__.py) → [runner.py](../../../../../../../playground/chaos/libs/Nuitka/tests/distutils/example_6_uv_pyproject_flat/example_uv_flat/runner.py) → `bootstrap.py（.temp/libs/home-assistant/core/homeassistant/bootstrap.py）`
- **核心对象**：`HomeAssistant`（事件总线/服务/状态机/生命周期），见 [core.py](../../../../../../scripts/mdi/validator/core.py#L379-L540)
