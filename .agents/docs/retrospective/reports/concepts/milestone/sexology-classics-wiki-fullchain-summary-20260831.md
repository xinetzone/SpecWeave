...
| 模式 | 成熟度 | 一句话 |
|------|--------|--------|
| [溯源一致性三查](../../../../../.agents/docs/retrospective/patterns/documentation-patterns/source-trace-consistency-check.md) | L1/draft | 交付后四查：临时残留指向→译名一致性→版本差异判别→计数算术自洽 |
| [版本差异判别](../../../../../.agents/docs/retrospective/patterns/documentation-patterns/version-discrepancy-arbitration.md) | L1/draft | 多值实体裁决流程：权威核验→分版或统一→依据回写 facts |
