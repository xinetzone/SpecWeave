...
> **状态**：✅ **已归档（validated）** — 已落地实现为 [devcontainer-variants.yml Stage 6/6](../../../../../.github/workflows/devcontainer-variants.yml)，配套 [test-onnx-quantized.sh](../../../../../apps/docker-images/devcontainer-base/variants/scripts/test-onnx-quantized.sh) 20项L1-L6分层测试验证。
