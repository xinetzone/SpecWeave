...
| 产出物 | 行数 | 大小 | 位置 |
|--------|------|------|------|
| export-md-to-pdf.py | 273行 | 9.5KB | [export-md-to-pdf.py](../../../../../scripts/export-md-to-pdf.py) |
| mermaid-full-scan.py | 279行 | 9.6KB | [mermaid-full-scan.py](../../../../../scripts/mermaid-full-scan.py) |
...
| 任务复盘报告 | 120行 | 8.6KB | [README.md](../retrospective-mermaid-funnel-redesign-pdf-export-20260711/README.md) |
...
- **复用载体**：[export-md-to-pdf.py](../../../../../scripts/export-md-to-pdf.py)
...
- **复用载体**：[mermaid-full-scan.py](../../../../../scripts/mermaid-full-scan.py) + [mermaid-manual-fix-guide.md](../../../../quality/mermaid-manual-fix-guide.md)
