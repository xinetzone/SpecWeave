...
| 文件 | 变更类型 | 行数 | 说明 |
|------|---------|------|------|
| [vendor.py](../../../../../scripts/lib/checks/vendor.py) | 新增 | 521 | vendor目录合规性检查核心模块 |
| [repo-check.py](../../../../../scripts/repo-check.py) | 修改 | +3 | 添加--debug参数支持 |
| [constants.py](../../../../../scripts/constants.py) | 修改 | -1 | 移除vendor/忽略规则 |
| [test_checks_vendor.py](../../../../../scripts/tests/test_checks_vendor.py) | 修改 | +240 | 单元测试用例（59个） |
