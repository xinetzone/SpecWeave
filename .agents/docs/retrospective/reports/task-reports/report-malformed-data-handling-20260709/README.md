...
title: "畸形数据容错处理测试报告"
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/reports/task-reports/report-malformed-data-handling-20260709/README.toml"
date: "2026-07-09"
...
- 测试演示：[demo_malformed_agents.py](../../../../../scripts/tests/demo_malformed_agents.py)
- 边缘测试（含P0测试）：[test_conflict_resolution_edge_cases.py](../../../../../scripts/tests/test_conflict_resolution_edge_cases.py)
- 测试模板API：[15-testing.md](../../../../../scripts/lib/docs/15-testing.md)
