...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/reports/competitive-analysis/retrospective-specforge-insight-20260629/export-suggestions.toml"
---
# 导出建议：改进项落地路径
...
**落地步骤**：
1. 在[feature-development.md](../../../../../workflows/feature-development.md)中新增"阶段守卫"章节，定义标准阶段序列和每个阶段的允许/禁止操作
...
**落地步骤**：
1. 在[workflows/testing.md](../../../../../workflows/testing.md)中增加"BUG修复回归测试"章节
2. 在[roles/developer.md](../../../../../roles/developer.md)中增加"修复后提交回归测试"的职责
3. 在[roles/tester.md](../../../../../roles/tester.md)中增加"验证回归测试覆盖"的检查项
...
**落地步骤**：
1. 在[patterns/methodology-patterns/ai-collaboration/](../../../patterns/methodology-patterns/ai-collaboration/README.md)下新增socratic-questioning.md
