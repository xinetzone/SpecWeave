...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/reports/competitive-analysis/retrospective-specforge-insight-20260629/insight-action-backlog.toml"
...
- **落地步骤**:
  1. 在[testing.md](../../../../../workflows/testing.md)中增加"BUG修复回归测试"章节
  2. 在[developer.md](../../../../../roles/developer.md)中增加"修复后提交回归测试"的职责
  3. 在[tester.md](../../../../../roles/tester.md)中增加"验证回归测试覆盖"的检查项
