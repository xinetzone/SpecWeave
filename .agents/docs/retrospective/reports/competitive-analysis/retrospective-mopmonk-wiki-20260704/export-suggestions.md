...
title: "导出建议"
source: "."
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/reports/competitive-analysis/retrospective-mopmonk-wiki-20260704/export-suggestions.toml"
...
- [retrospective-text-to-cad-learning-20260704](../retrospective-text-to-cad-learning-20260704/README.md) — 同一天紧邻的wiki教程制作复盘，同样遇到frontmatter格式问题，是本次"重复问题"的对照案例
