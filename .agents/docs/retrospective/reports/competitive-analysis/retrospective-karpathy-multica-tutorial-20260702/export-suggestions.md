...
title: "导出建议"
source: "."
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/reports/competitive-analysis/retrospective-karpathy-multica-tutorial-20260702/export-suggestions.toml"
...
| 产出物 | 路径 | 说明 |
|--------|------|------|
| 教程主入口 | [karpathy-llm-coding-guidelines-tutorial.md](../../../../knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines-tutorial.md) | 8文档教程索引 |
| Multica平台章 | [06-multica-platform.md](../../../../knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines/README.md) | 新增500行 |
| multica-cli章（六层重构）🔄 | [07-multica-cli-skill.md](../../../../knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines/README.md) | 重构为553行，按认知阶梯六层优化 |
...
| Git UTF-8提交工具🆕 | [git-commit-utf8.py](../../../../../scripts/git-commit-utf8.py) | Windows中文commit乱码永久解决方案 |
| 教程模板🆕 | [tutorial-cognitive-ladder-template.md](../../../../../templates/tutorial-cognitive-ladder-template.md) | 新教程可直接套用六层结构 |
| 洞察模板🆕 | [insight-extraction-template.md](../../../../../templates/insight-extraction-template.md) | 洞察萃取三段式内容模板 |
