...
基于 [pattern-merge-boundary.md](../../../patterns/methodology-patterns/document-architecture/pattern-merge-boundary.md) 定义的三维重叠度框架（适用场景 / 核心机制 / 实施建议），对全部 36 个方法论模式执行交叉对比扫描。
