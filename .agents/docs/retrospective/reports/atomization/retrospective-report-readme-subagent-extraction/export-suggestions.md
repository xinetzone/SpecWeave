...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/reports/atomization/retrospective-report-readme-subagent-extraction/export-suggestions.toml"
---
# 导出建议
...
- 建议：在 [.agents/docs/development-standards.md](../../../../development-standards.md) 补充"派生产物须携带 source 溯源字段"约定
...
- 建议：更新 [.agents/README.md](../../../../../README.md) 索引，加入 modules/ 条目
- 预期收益：保持容器说明完整性，便于查阅
...
- 预期收益：实现溯源字段的自动化价值兑现
- 执行结果：已创建 [check-source-traceability.py](../../../../../scripts/check-source-traceability.py)，支持审计模式（列出全部溯源关系）与影响分析模式（`--affected <源文件>` 输出受影响产物），验证通过识别 8 个派生产物。脚本数从 5 增至 6，已同步更新 scripts/README.md 与 verification-automation.md
