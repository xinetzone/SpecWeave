...
| 质量检查脚本 | [check-skill-quality.py](../../../../../scripts/check-skill-quality.py) | 内置开放标准合规检查（14项），统一质量门禁 |
| CI流水线配置 | [ci-check.ps1](../../../../../scripts/ci-check.ps1) / [ci-check.sh](../../../../../scripts/ci-check.sh) | Step 8集成Skill质量检查，双平台支持 |
...
| 技能 | evals路径 | 用例数 |
|------|----------|--------|
| link-check-cmd | [evals.json](../../../../../skills/link-check-cmd/evals/evals.json) | 10 |
| atomic-commit-cmd | [evals.json](../../../../../skills/atomic-commit-cmd/evals/evals.json) | 10 |
| atomization-cmd | [evals.json](../../../../../skills/atomization-cmd/evals/evals.json) | 10 |
| mermaid-cmd | [evals.json](../../../../../skills/mermaid-cmd/evals/evals.json) | 10 |
| ci-check-cmd | [evals.json](../../../../../skills/ci-check-cmd/evals/evals.json) | 10 |
| retrospective-cmd | [evals.json](../../../../../skills/retrospective-cmd/evals/evals.json) | 10 |
