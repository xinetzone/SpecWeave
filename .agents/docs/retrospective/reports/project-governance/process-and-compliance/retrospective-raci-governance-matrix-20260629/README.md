...
x-toml-ref: "../../../../../../../.meta/toml/.agents/docs/retrospective/reports/project-governance/process-and-compliance/retrospective-raci-governance-matrix-20260629/README.toml"
---
# RACI治理责任矩阵落地复盘
...
1. **5个指令集RACI矩阵**：
   - [retrospective.md](../../../../../../commands/retrospective.md) — 8个复盘活动RACI
   - [insight.md](../../../../../../commands/insight.md) — 9个洞察活动RACI
   - [export-report.md](../../../../../../commands/export-report.md) — 9个导出活动RACI
   - [atomization.md](../../../../../../commands/atomization.md) — 10个原子化活动RACI
   - [atomic-commit.md](../../../../../../commands/atomic-commit.md) — 9个原子提交活动RACI

2. **治理策略总览（五层审批模型修正版）**：
   - [commands/README.md](../../../../../../commands/README.md) — 跨流程RACI总览+修正后五层审批模型（R/A双列设计）

3. **数据安全RACI同步**：
   - [role-responsibilities.md](../../../../../../rules/data-security/role-responsibilities.md) — 24个安全活动RACI格式化修正，对齐五层模型
