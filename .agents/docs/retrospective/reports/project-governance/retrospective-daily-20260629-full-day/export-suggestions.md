...
**建议：** 在 [.agents/rules/stage-guardrails.md](../../../../../rules/stage-guardrails.md) 中新增"治理基建四层递进模型"章节，明确：
...
**建议：** 在 [.agents/protocols/pre-document-reading.md](../../../../../protocols/pre-document-reading.md) 或工作流中增加规则：
...
**责任人：** developer
**验收标准：** 检查脚本包含提交规模预警功能
**完成状态：** ✅ 2026-06-30完成。创建[check-commit-size.py](../../../../../scripts/check-commit-size.py)独立脚本，支持`--commit`/`--all N`/`--threshold`/`--demo`参数，四级阈值分级（<500理想/500-1000可接受/>1000警告/>2000严重），识别单文件>300行变更并给出按四层递进/子模块/会话边界的拆分建议。
...
**核心交付物：**
1. [stage-guardrails.md](../../../../../rules/stage-guardrails.md) - 新增治理四层递进模型章节
2. [pre-document-reading.md](../../../../../protocols/pre-document-reading.md) - 新增二次暴露治理检查点
3. [code-review.md](../../../../../workflows/code-review.md) - 检查清单新增治理闭环项
4. [check-stage-guardrails.py](../../../../../scripts/check-stage-guardrails.py) - 增强治理层跳层检测
5. [check-commit-size.py](../../../../../scripts/check-commit-size.py) - 新增提交粒度预警脚本
6. [ci-check.ps1](../../../../../scripts/ci-check.ps1)/[ci-check.sh](../../../../../scripts/ci-check.sh) - 跨平台UTF-8编码安全
