...
x-toml-ref: "../../../../../../../.meta/toml/.agents/docs/retrospective/reports/project-governance/tools-and-automation/retrospective-report-code-wiki-generation/execution-retrospective.toml"
---
# 二、复盘环节
...
执行过程中先读取 `README.md`、目录结构、`.agents/README.md`、`.agents/docs/project-structure.md`、`.agents/docs/tech-stack.md`，建立项目全景，再深入 `prompt_extraction/pipeline.py`、`models.py`、`ui/app.py` 和核心模块文件。
