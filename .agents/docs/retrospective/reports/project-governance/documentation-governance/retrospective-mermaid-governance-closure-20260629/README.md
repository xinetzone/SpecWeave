...
| 建议6：Mermaid 模板内置安全提醒 | ✅ 本次完成 | [safe-starter.md](../../../../../../templates/mermaid-templates/safe-starter.md) |
| 建议5：CI 集成 check-mermaid | ✅ 已存在（验证确认） | [ci-check.ps1:43-51](../../../../../../scripts/ci-check.ps1#L43-L51) |
| 工具注释感知bug修复 | ✅ 本次发现并修复 | [mermaid.py](../../../../../../scripts/lib/checks/mermaid.py) |
...
- `.agents/docs/development-standards.md`（开发规范）
