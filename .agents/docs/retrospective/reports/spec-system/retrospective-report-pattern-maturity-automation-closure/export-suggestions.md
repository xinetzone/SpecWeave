...
- 问题：当前 [pattern-maturity-stats.py](../../../../../scripts/pattern-maturity-stats.py) 需要手动运行，尚未进入 CI 闭环。
...
| 文件 | 操作 | 说明 |
|------|------|------|
| [.agents/scripts/pattern-maturity-stats.py](../../../../../scripts/pattern-maturity-stats.py) | 新建 | 模式成熟度统计脚本 |
...
后续最值得推进的是将 [pattern-maturity-stats.py](../../../../../scripts/pattern-maturity-stats.py) 纳入 CI，并增加机器可读输出格式，使模式库统计进一步自动化。
