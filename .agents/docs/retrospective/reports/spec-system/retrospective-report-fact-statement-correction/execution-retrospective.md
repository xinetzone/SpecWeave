...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/retrospective/reports/spec-system/retrospective-report-fact-statement-correction/execution-retrospective.toml"
---
# 执行复盘
...
**决策依据**：`.agents/docs/related-links.md:7` 描述的是 AGENTS.md 标准本身被工具支持：
