...
- [05 消息网关](../learning/03-agent-platforms-tools/hermes-agent-wiki/05-messaging-gateway.md)
...
- [Token优化技术方法总览](../learning/02-agent-engineering-methodology/llm-token-optimization/02-methods/00-methods-overview.md)
...
- [Intel Neural Compressor 教程总览](../learning/02-agent-engineering-methodology/neural-compressor-wiki/00-overview.md)
...
- [安装指南](../learning/02-agent-engineering-methodology/neural-compressor-wiki/02-installation.md)
...
- [术语表与资源](../learning/02-agent-engineering-methodology/neural-compressor-wiki/08-resources.md)
...
- [02 Hermes Agent 快速安装与上手](../learning/03-agent-platforms-tools/hermes-agent-wiki/02-quickstart.md)
...
- [Token优化技术选型矩阵](../learning/02-agent-engineering-methodology/llm-token-optimization/06-decision-framework/02-selection-matrix.md)
...
- [大语言模型Token节省机制底层原理事实清单](../learning/02-agent-engineering-methodology/llm-token-optimization/01-principles/00-facts.md)

## pagedattention

- [增量推理与缓存](../learning/02-agent-engineering-methodology/llm-token-optimization/02-methods/04-inference-caching.md)
...
- [AI 四大工程概念演进：Prompt → Context → Harness → Loop](../learning/02-agent-engineering-methodology/four-engineering-concepts-wiki.md)
- [提示词工程优化](../learning/02-agent-engineering-methodology/llm-token-optimization/02-methods/01-prompt-engineering.md)
- [即用型Prompt模板库](../learning/08-systems-infrastructure/ai-powershell5-hell-wiki/06-prompt-templates.md)
