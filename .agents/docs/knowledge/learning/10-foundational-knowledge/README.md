...
> **通用基础知识层沉淀数学推理与学术研究等跨领域通识素养**。本主题收纳原独立成目录但内容较少的数学基础与学术技能Wiki，为技术学习与技术输出提供通用能力支撑。
...
> 本主题收纳了原 `04-mathematics-foundations` 与 `05-academic-skills` 两个单Wiki孤儿目录（各自仅1个Wiki，未达2-15个粒度下限），合并为一个聚合主题以满足粒度均衡原则，并预留空间容纳未来新增的数学/学术类通识Wiki。
