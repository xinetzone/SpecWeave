...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/knowledge/learning/06-business-trends-analysis/three-ai-tools-wiki/02-article-content.toml"
source: "https://mp.weixin.qq.com/s/gFlPzfjpY8zs3tOcw3o5Lg"
date: "2026-07-04"
tags: ["ai-tools", "intelligent-terminal", "claudian", "book-to-skill", "original-article"]
---
# 三个热门AI工具：微软AI终端、Claudian笔记插件、book-to-skill书籍转Skill

> **原文来源**：[微信公众号文章（逛逛GitHub）](https://mp.weixin.qq.com/s/gFlPzfjpY8zs3tOcw3o5Lg)
> **说明**：本文件为原文存档，保留原始叙述风格，未做改写。
...
book-to-skill 能把任意技术书籍编译成符合 Agent Skills 开放标准的结构化技能。
...
**上一章**：[01 - 三个热门AI工具完整指南](01-three-ai-tools.md)
**下一章**：[03 - 七概念知识沉淀报告](03-seven-concepts-report.md)
