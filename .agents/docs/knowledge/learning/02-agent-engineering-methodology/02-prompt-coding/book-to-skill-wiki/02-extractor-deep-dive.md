...
> 来源：[config.py#L16-L24](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/config.py#L16-L24)、[dependencies.py#L14-L68](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/dependencies.py#L14-L68)

## 提取器优先级链设计

核心逻辑在 [extract_single_file()](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/utils.py#L410-L599) 中。设计原则是**最佳工具优先，链式优雅降级**：
...
> 来源：[utils.py#L421-L448](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/utils.py#L421-L448)

## 多语言章节检测

这是提取器中最精巧的部分之一——支持 7 种语言的章节标题自动检测，代码在 [utils.py#L59-L124](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/utils.py#L59-L124)。
...
- 全角数字：`第１章`（日文排版常见）
- 中文数字解析：[cn_numeral_to_int()](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/utils.py#L214-L229) 支持到 999
...
- [structural_chapter_count()](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/utils.py#L151-L211)
...
[dependencies.py](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/dependencies.py) 实现了一套非常完善的可选依赖处理机制：
...
- [上一章：核心架构](01-core-architecture.md)
- [下一章：SKILL.md 生成规范详解](03-skill-md-spec.md) →
