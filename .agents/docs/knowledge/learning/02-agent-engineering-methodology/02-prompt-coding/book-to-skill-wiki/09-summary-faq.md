...
x-toml-ref: "../../../../../../../.meta/toml/.agents/docs/knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/book-to-skill-wiki/09-summary-faq.toml"
---
...
- **项目仓库**：[github.com/virgiliojr94/book-to-skill](https://github.com/virgiliojr94/book-to-skill)
- **核心文档**：
  - [README.md](https://github.com/virgiliojr94/book-to-skill/blob/main/README.md) - 项目主文档、使用指南、基准测试
  - [SKILL.md](https://github.com/virgiliojr94/book-to-skill/blob/main/SKILL.md) - 可执行规范定义，包含完整 10 步转换流程
  - [docs/ARCHITECTURE.md](https://github.com/virgiliojr94/book-to-skill/blob/main/docs/ARCHITECTURE.md) - 架构设计、组件关系
  - [docs/PERFORMANCE.md](https://github.com/virgiliojr94/book-to-skill/blob/main/docs/PERFORMANCE.md) - 性能基准、Discovery Loop Tax 测量
  - [SECURITY.md](https://github.com/virgiliojr94/book-to-skill/blob/main/SECURITY.md) - 安全策略、漏洞报告
...
- [上一章：可复用工程模式](08-transferable-patterns.md)
- 下一章：本教程已完结（09）
