...
> 创建日期：2026-07-01
> 本地源码路径：[external/agentskills](../../../../../external/agentskills/README.md)
> 验证工具：[skills-ref](../../../../../external/agentskills/skills-ref/README.md)
...
本文档已按单一职责原则原子化为15个独立章节文件，存放于 [agent-skills-wiki/](agent-skills-wiki/README.md) 目录：
