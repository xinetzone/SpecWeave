...
- [karpathy-llm-coding-guidelines](../../02-agent-engineering-methodology/karpathy-llm-coding-guidelines-tutorial.md)：Python 工程实践。该教程的代码风格、项目组织与测试实践建议适用于 scikit-build-core 项目的 CMake 与 Python 协同开发
