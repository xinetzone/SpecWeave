...
> **权威版本**：本文件为面向人类读者的导出版，权威源文件位于 [.agents/rules/raci-governance-standards.md](../rules/raci-governance-standards.md)
...
| [治理策略主文档](../commands/README.md) | 指令集目录与RACI总览 |
| [数据安全角色职责矩阵](../rules/data-security/role-responsibilities.md) | 数据安全领域RACI实践案例 |
