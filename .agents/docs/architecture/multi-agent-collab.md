...
| 层级 | 颜色 | 核心内容 | 对应规范文件 |
|------|------|---------|-------------|
| ① 启动协议层 | 🔵 蓝色 | AGENTS.md启动四步协议 + vendor嵌套路由 | [onboarding-protocol.md](../../protocols/onboarding-protocol.md) |
| ② 任务路由层 | 🟣 紫色 | 复杂度判断 + 协作模式选择 | [collaboration-scenarios.md](../../roles/collaboration-scenarios.md) |
| ③ 中心化模式 | 🟠 橙色 | Orchestrator主导的六阶段标准流程 | [roles/](../../roles/README.md) |
| ④ 去中心化模式 | 🟢 绿色 | 角色引用直连 + messaging协议 | [messaging.md](../../protocols/messaging.md) |
| ⑤ 任务交接层 | 🔴 浅粉 | YAML格式交接 + 确认/退回机制 | [handoff.md](../../protocols/handoff.md) |
| ⑥ 冲突解决层 | 🔴 红色 | 三类冲突 + 分级仲裁 + 人工升级 | [conflict-resolution.md](../../protocols/conflict-resolution.md) |
...
- [onboarding-protocol.md](../../protocols/onboarding-protocol.md) - 会话启动协议
- [handoff.md](../../protocols/handoff.md) - 任务交接协议
- [messaging.md](../../protocols/messaging.md) - 消息传递协议
- [conflict-resolution.md](../../protocols/conflict-resolution.md) - 冲突解决协议
- [collaboration-scenarios.md](../../roles/collaboration-scenarios.md) - 角色协作场景定义
