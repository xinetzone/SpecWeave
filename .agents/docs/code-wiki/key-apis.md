...
本文档包含两部分核心API说明：
1. **提示词萃取系统**（`apps/dev-tools/prompt_extraction/`）：从提示词文本中抽取结构化特征、评估质量、生成优化结果的流水线
...
提示词萃取系统的核心数据结构定义在 `apps/dev-tools/prompt_extraction/models.py`。这些 dataclass 组成了流水线各阶段之间的数据契约。

### `FeatureSet`

位置：[`apps/dev-tools/prompt_extraction/models.py`](../../../apps/dev-tools/prompt_extraction/models.py)
...
位置：[`apps/dev-tools/prompt_extraction/pipeline.py`](../../../apps/dev-tools/prompt_extraction/pipeline.py)
...
位置：[`apps/dev-tools/prompt_extraction/input/parser.py`](../../../apps/dev-tools/prompt_extraction/input/parser.py)
...
位置：[`apps/dev-tools/prompt_extraction/input/input_handler.py`](../../../apps/dev-tools/prompt_extraction/input/input_handler.py)
...
位置：[`apps/dev-tools/prompt_extraction/preprocessing/cleaner.py`](../../../apps/dev-tools/prompt_extraction/preprocessing/cleaner.py)
...
位置：[`apps/dev-tools/prompt_extraction/preprocessing/normalizer.py`](../../../apps/dev-tools/prompt_extraction/preprocessing/normalizer.py)
...
位置：[`apps/dev-tools/prompt_extraction/extraction/extractor.py`](../../../apps/dev-tools/prompt_extraction/extraction/extractor.py)
...
位置：[`apps/dev-tools/prompt_extraction/assessment/evaluator.py`](../../../apps/dev-tools/prompt_extraction/assessment/evaluator.py)
...
位置：[`apps/dev-tools/prompt_extraction/optimization/optimizer.py`](../../../apps/dev-tools/prompt_extraction/optimization/optimizer.py)
...
位置：[`apps/dev-tools/prompt_extraction/ui/app.py`](../../../apps/dev-tools/prompt_extraction/ui/app.py)
...
位置：[`lib/collaboration/conflict_resolution.py`](../../scripts/lib/collaboration/conflict_resolution.py)
...
位置：[`lib/testing/__init__.py`](../../scripts/lib/testing/__init__.py)
详细API文档：[lib/docs/15-testing.md](../../scripts/lib/docs/15-testing.md)
