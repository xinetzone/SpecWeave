...
| PowerShell / Shell | CI、本地治理、平台脚本 | [global-core-rules.md](../../global-core-rules.md#L25-L25) |
...
| `invoke` | 通过 `docs/tasks.py` 封装构建命令 |
...
对外文档站依赖和规范资产依赖是分离的：`docs/` 需要 Sphinx，而 `.agents/docs/` 本身主要是 Markdown 资产。
