---
source: "镜像自 Trae IDE builtin（源镜像已清理，原路径 skills/task-execution-summary/SKILL.md）"
name: task-execution-summary
description: "系统性总结任务从启动到完成的整个执行过程，生成高质量的结构化经验报告。
🔴 **必须使用此技能的场景**： - 用户明确说\"总结\"、\"复盘\"、\"回顾\"、\"报告\"、\"postmortem\"、\"经验教训\" - 英文表达：\"recap\"、\"write a summary\"、\"do a debrief\"、\"postmortem analysis\" - 任务完成后用户说\"完成了\"、\"结束了\"、\"搞定了\"、\"做完了\"、\"Bug修复完了\"、\"做完了个...模块\" - 项目管理场景：\"Sprint回顾\"、\"迭代总结\"、\"项目收尾\"、\"里程碑达成\"、\"整理下成果\"、\"写份报告给XX看\" - 故障处理场景：\"记录一下排查过程\"、\"整理解决方案\"、\"故障复盘\"、\"记录下过程\" - 学习成长场景：\"学习总结\"、\"知识点梳理\"、\"学习路径回顾\"、\"做了个什么项目\" - 团队协作场景：\"团队协作总结\"、\"沟通效果评估\"
🟡 **即使未提及\"总结\"，以下隐式意图也应触发**： - 用户询问\"做得怎么样\"、\"有什么收获\"、\"下次怎么做\"、\"学到了什么\" - 长时间操作后突然切换话题或停顿 - 对话中出现明显的阶段性完成标志 - 中英混合表达（如\"recap一下吧\"、\"帮我总结下刚才做的事\"）
🟢 **适用任务类型（不限）**： 软件开发、项目管理、运维故障排查、技术研究、学习培训、任何有明确起止的任务。 具体包括：功能开发完成、Bug修复结束、技术重构收尾、Sprint迭代回顾、故障排查后记录、POC验证总结、课程学习复盘、技能培训总结等。
⚠️ **不要遗漏**： 即使用户只是随口说\"帮我整理一下刚才做的事\"，也应该触发此技能！ 支持模糊匹配：错别字容忍（如\"帮整里一下\"）、口语化表达、中英混合输入、非标准措辞——只要意图是回顾已执行任务的执行过程，就应触发！ 此技能适用于 Trae IDE 环境下的所有任务类型总结需求。"
---
