...
try:
    ...
    DYNAMIC_LAYER_AVAILABLE = False
    DynamicLayer = None
    # Provide fallback imports so module-level @dataclass and class definitions don't fail
    try:
        from transformers.modeling_outputs import ModelOutput
        from transformers.generation import GenerationMixin, GenerationConfig
        from transformers.cache_utils import DynamicCache
...
if TORCH_AVAILABLE and DYNAMIC_LAYER_AVAILABLE and DynamicLayer is not None:
...
if TORCH_AVAILABLE and MASKING_AVAILABLE and hasattr(ALL_MASK_ATTENTION_FUNCTIONS, 'register'):
        ...
        **kwargs,
        ...
        if checkpoint_path is None:
            ...
            if checkpoint_path_file.exists():
                ...
                checkpoint_path = str(model_dir).replace("\\", "/")
