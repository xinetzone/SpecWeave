...
> - `tech-guide-template.docx`：技术文档模板，含封面/更新记录/多级章节/代码块/2-5列多类型表格（契约见 [references/tech-guide-template.md](references/tech-guide-template.md)，渲染示例见 [examples/tech-guide-render-example.py](examples/tech-guide-render-example.py)）
