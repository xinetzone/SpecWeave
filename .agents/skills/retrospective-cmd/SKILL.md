...
- [ ] 复盘报告引用关键数据时已执行 Grep 数据验证三查法（一查关键数据匹配、二查 `file:///` 绝对路径、三查章节完整性）——适用于分析类任务或含数据引用的复盘报告
...
| 复盘报告目录 | L2 | [docs/retrospective/reports/](../../../docs/retrospective/reports/index.md) | 存放产出物 |
