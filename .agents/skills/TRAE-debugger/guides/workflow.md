...
> **💡 Tip**: Start with Hypothesis A (High likelihood, Low effort). Refer to `c:\Users\xinzo\.trae-cn\builtin_skills\TRAE-debugger/guides/scenarios.md` for scenario-specific hypothesis templates.
