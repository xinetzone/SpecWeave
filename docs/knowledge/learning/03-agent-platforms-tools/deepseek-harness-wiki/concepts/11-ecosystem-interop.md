...
maturity: L1
type: Reference
description: 介绍 dsh 与 Claude Code hooks 桥接、Codex 一键配置、MCP 客户端支持、AGENTS.md/CLAUDE.md
  规则读取与任务委托共存策略。
generated:
...
← [10 插件开发](/concepts/10-plugin-development.md) | → [12 无头模式与 SDK](/concepts/12-headless-sdk.md)
