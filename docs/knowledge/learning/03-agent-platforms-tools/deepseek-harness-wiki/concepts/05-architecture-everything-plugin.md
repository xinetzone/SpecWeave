...
maturity: L1
type: Concept
description: 深入解读一切皆插件设计哲学、Cordis 元框架五概念、可逆效应、Bundle/Profile 分发机制与五层叠加补丁架构。
generated:
...
- id: dsh-src
  resource: external/libs/deepseek-harness源码
  title: DeepSeek Harness 源码
- id: cordis-src
  resource: external/libs/cordis源码
  title: Cordis 元框架源码
---
...
← [04 四种模式](/concepts/04-four-modes.md) | → [06 Agent 循环与事件](/concepts/06-agent-loop-events.md)
