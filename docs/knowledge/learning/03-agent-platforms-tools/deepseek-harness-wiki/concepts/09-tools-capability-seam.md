...
maturity: L2
type: Concept
description: 阐述工具系统与 Capability Seam 抽象，Service Definition、Provider、Consumer 三角色模型，以及一次替换全局生效的依赖注入解耦机制。
generated:
...
← [08 模型配置](/concepts/08-model-configuration.md) | → [10 插件开发入门](/concepts/10-plugin-development.md)
