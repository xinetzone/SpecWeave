...
maturity: L1
type: Tutorial
description: 插件开发入门，涵盖三种插件形态、inject 依赖注入、五种事件分发模式、自定义工具示例、可逆效应 disposer 与 Creator
  模式热重载。
generated:
...
- id: cordis-context
  resource: external/libs/cordis/packages/core/src/context.ts
  title: Cordis context.ts 源码
- id: cordis-service
  resource: external/libs/cordis/packages/core/src/service.ts
  title: Cordis service.ts 源码
- id: cordis-fiber
  resource: external/libs/cordis/packages/core/src/fiber.ts
  title: Cordis fiber.ts 源码
- id: cordis-events
  resource: external/libs/cordis/packages/core/src/events.ts
  title: Cordis events.ts 源码
- id: cordis-registry
  resource: external/libs/cordis/packages/core/src/registry.ts
  title: Cordis registry.ts 源码
---
...
← [09 工具系统](/concepts/09-tools-capability-seam.md) | → [11 生态互操作](/concepts/11-ecosystem-interop.md)
