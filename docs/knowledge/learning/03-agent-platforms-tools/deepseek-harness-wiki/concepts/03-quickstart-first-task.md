...
maturity: L1
type: Tutorial
description: 引导完成 Web UI 工作区选择、模型配置、第一个 Agent 任务执行，介绍权限审批弹窗、实时统计面板与 Trajectory 轨迹按钮。
generated:
...
- id: 06-qq-news
  resource: .temp/deepseek-harness-sources/06-qq-news.md
  title: QQ 新闻生态动态
---
...
← [02 安装](/concepts/02-installation-setup.md) | → [04 四种运行模式](/concepts/04-four-modes.md)
