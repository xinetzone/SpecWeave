...
maturity: L1
type: Reference
description: 详解 DeepSeek V4 Pro/Flash 默认参数、三档思考强度、凭证安全存储、多 Provider 添加、自定义 Provider
  与视觉模型配置。
generated:
...
← [07 会话日志](/concepts/07-session-log-observability.md) | → [09 工具系统](/concepts/09-tools-capability-seam.md)
