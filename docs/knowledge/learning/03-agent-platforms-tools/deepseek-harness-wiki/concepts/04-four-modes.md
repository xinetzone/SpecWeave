...
maturity: L1
type: Concept
description: 详解 Standard、Code(PTC)、Minimal、Creator 四种运行模式的能力差异、适用场景、启动方式与模式选择决策表。
generated:
...
← [03 快速上手](/concepts/03-quickstart-first-task.md) | → [05 核心架构](/concepts/05-architecture-everything-plugin.md)
