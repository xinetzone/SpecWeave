...
maturity: L1
type: Reference
description: 收集 Node 版本错误、端口占用、MISSING_CREDENTIAL、UNKNOWN_MODEL、PTY 不可用等十余个常见问题的症状、原因与解决方案。
generated:
...
然后在 Python 代码里用 SDK 调用 dsh，具体用法见 [12 无头模式与 SDK](/concepts/12-headless-sdk.md)。
...
← [12 无头模式](/concepts/12-headless-sdk.md) | → [14 适用场景与风险](/concepts/14-use-cases-limitations.md)
