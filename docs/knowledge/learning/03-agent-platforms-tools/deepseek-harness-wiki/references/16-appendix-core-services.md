...
maturity: L2
type: Reference
description: 附录速查表，列出所有 ctx.* 核心服务（seam、core、bundle 角色）、常用扩展点与五种事件分发模式快速参考。
generated:
...
sources:
- id: dsh-docs
  resource: external/libs/deepseek-harness/docs/capability-seams.zh.md
  title: DeepSeek Harness 官方文档
- id: dsh-docs
  resource: external/libs/deepseek-harness/docs/architecture.zh.md
  title: DeepSeek Harness 官方文档
- id: dsh-packages
  resource: external/libs/deepseek-harness/packages/
  title: DeepSeek Harness packages 源码
---
...
← [15 生态与资源](/references/15-ecosystem-resources.md) | 回到[00 总览](/index.md)
