...
3. [Demo-Prod六层能力模型验证报告](../../../../.agents/docs/retrospective/reports/competitive-analysis/retrospective-eve-framework-learning-20260704/framework-comparison-validation.md)
