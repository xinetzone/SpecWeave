...
基于 [graph.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/graph.py#L1-L160) 的分析，完整执行流程如下：
...
#### post_cortex_gate ([graph.py#L60-L74](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/graph.py#L60-L74))
...
#### post_executor_gate ([graph.py#L77-L97](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/graph.py#L77-L97))

Executor 执行后的分支：
- 如果生成了 tool_calls → 进入 ExecutorTools 执行工具
- 如果没有工具调用 → 直接进入 Summarizer（可能是认为任务完成或需要重新观察）

#### convergence_gate ([graph.py#L39-L57](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/graph.py#L39-L57))
...
[graph.py#L126](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/graph.py#L126) 中 `convergence` 节点设置了 `defer=True`：
...
State 是整个系统的**唯一真相来源（Single Source of Truth）**，定义在 [state.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/state.py#L1-L115)，使用 Pydantic BaseModel 构建。
...
[state.py#L55-L59](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/state.py#L55-L59) 定义了思考链字段：
...
[state.py#L62-L66](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/graph/state.py#L62-L66) 的 scratchpad 是一个简单但强大的设计：
...
**文件**: [planner.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/planner/planner.py#L1-L101) | [planner.md](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/planner/planner.md#L1-L126)
...
**文件**: [orchestrator.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/orchestrator/orchestrator.py#L1-L134)
...
**文件**: [contextor.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/contextor/contextor.py)
...
**文件**: [cortex.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/cortex/cortex.py) | [cortex.md](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/cortex/cortex.md#L1-L135)
...
**文件**: [executor.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/executor/executor.py) | [tool_node.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/executor/tool_node.py)
...
**文件**: [summarizer.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/agents/summarizer/summarizer.py)
...
**文件**: [unified_controller.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/controllers/unified_controller.py#L1-L193)
...
**文件**: [controller_factory.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/controllers/controller_factory.py)
...
**文件**: [tool_wrapper.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/tools/tool_wrapper.py) | [index.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/tools/index.py#L1-L67)
...
[index.py#L27-L49](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/tools/index.py#L27-L49) 定义了所有可用工具：
...
[agent.py](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/sdk/agent.py#L88-L1241) 中的 Agent 类遵循清晰的生命周期：
...
[agent.py#L927-L934](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/sdk/agent.py#L927-L934) 使用 astream 实现流式输出：
...
[llm-config.defaults.jsonc](file:///d:/AI/.chaos/libs/mobile-use/llm-config.defaults.jsonc#L1-L212) 定义了三套预设配置，核心思想是**按智能体职责分配不同能力等级的模型**：
...
[with_fallback](file:///d:/AI/.chaos/libs/mobile-use/minitap/mobile_use/services/llm.py) 装饰器实现：
1. 先尝试主模型调用
