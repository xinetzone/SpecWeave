...
category: learning
type: Reference
description: OCR Wiki 终章，系统总结知识体系、关键数据速查表、术语表、可迁移架构模式、同类工具对比、学习路径规划与官方资源链接。
sources:
- id: primary
  resource: "https://github.com/alibaba/open-code-review"
  title: "Open Code Review GitHub 仓库"
generated:
...
| 章节 | 文件 | 内容 |
|------|------|------|
| 00 | [00-overview.md](/) | 概述与学习目标 |
| 01 | [01-installation.md](/concepts/01-installation.md) | 安装与配置指南 |
| 02 | [02-cli-reference.md](/references/02-cli-reference.md) | CLI 命令参考 |
| 03 | [03-architecture.md](/concepts/03-architecture.md) | 核心架构 |
| 04 | [04-llm-providers.md](/concepts/04-llm-providers.md) | LLM 协议与 Provider |
| 05 | [05-tools-mcp.md](/concepts/05-tools-mcp.md) | 内置工具与 MCP 集成 |
| 06 | [06-review-rules.md](/concepts/06-review-rules.md) | 审查规则系统 |
| 07 | [07-session-telemetry.md](/concepts/07-session-telemetry.md) | 会话持久化、遥测与查看器 |
| 08 | [08-integrations.md](/concepts/08-integrations.md) | 集成与扩展 |
| 09 | [09-faq-troubleshooting.md](/references/09-faq-troubleshooting.md) | FAQ 与排错 |
| 10 | [10-summary-resources.md](/references/10-summary-resources.md) | 总结、术语表与资源（本章） |
