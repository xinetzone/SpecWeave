...
category: learning
type: Reference
description: OCR 常见问题与排错指南，涵盖 LLM 配置、文件过滤、会话恢复、性能成本、集成、卸载、调试技巧与平台兼容性问题。
sources:
- id: primary
  resource: "https://open-codereview.ai/docs/faq"
  title: "OCR 官方文档 - FAQ 与排错"
generated:
...
> **下一步**：如本章未解决你的问题，建议前往 [GitHub Issues](https://github.com/alibaba/open-code-review/issues) 反馈，附上 Manifest 文件与会话 ID 以便维护者定位问题。下一章 [10-summary-resources.md](/references/10-summary-resources.md) 汇总全文知识体系、术语表与资源链接。
