...
category: learning
type: Reference
description: OCR 集成生态梳理，涵盖 CI/CD 流水线、Agent 工具链、委托模式、Agent Skill、VS Code 扩展与 MCP 服务器集成方式。
sources:
- id: primary
  resource: "https://open-codereview.ai/docs/cicd"
  title: "OCR 官方文档 - CI/CD 集成"
generated:
