...
category: learning
type: Reference
description: OCR 可观测性三件套详解，涵盖 JSONL 会话日志、Manifest 双边界状态机、会话恢复重放、OpenTelemetry Span/Metric 体系与嵌入式查看器。
sources:
- id: primary
  resource: "https://open-codereview.ai/docs/telemetry"
  title: "OCR 官方文档 - 会话与遥测"
generated:
