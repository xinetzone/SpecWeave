...
category: learning
type: Concept
description: OCR 核心架构深度解析，涵盖六阶段流水线、Agent 模块、Subtask 两阶段执行、Main Loop、三区内存压缩、Diff/Scan 模块与 Manifest 可追溯性。
sources:
- id: primary
  resource: "https://open-codereview.ai/docs/architecture"
  title: "OCR 官方文档 - 核心架构"
generated:
...
> **下一章**：[04-llm-providers.md](/concepts/04-llm-providers.md) 将深入解析 LLM 协议、Provider 系统、Endpoint 解析策略与 Token 计数机制。
