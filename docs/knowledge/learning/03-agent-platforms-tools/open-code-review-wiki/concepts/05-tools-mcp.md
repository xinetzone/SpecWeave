...
category: learning
type: Reference
description: OCR 工具系统详解，涵盖 Registry 注册机制、Provider 接口契约、6 个内置工具、code_comment 评论机制、MCP 集成与工具自定义扩展。
sources:
- id: primary
  resource: "https://open-codereview.ai/docs/tools"
  title: "OCR 官方文档 - 工具与 MCP"
generated:
...
> **上一章**：[04-llm-providers.md](/concepts/04-llm-providers.md) 解析了 LLM 协议、Provider 系统与 Endpoint 解析策略。
>
