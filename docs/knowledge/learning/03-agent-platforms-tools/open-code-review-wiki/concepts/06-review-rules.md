...
category: learning
type: Reference
description: OCR 审查规则系统解析，涵盖四层优先级合并、ProjectRule 结构、Glob 匹配语法、内置默认排除、系统规则映射、文件过滤算法与 ocr rules check 调试命令。
sources:
- id: primary
  resource: "https://open-codereview.ai/docs/review-rules"
  title: "OCR 官方文档 - 审查规则"
generated:
