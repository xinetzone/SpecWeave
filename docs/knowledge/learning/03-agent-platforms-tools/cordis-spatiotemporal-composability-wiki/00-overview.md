---
id: cordis-wiki-00-overview
title: "Cordis 时空可组合性框架 — 概述"
source: "https://github.com/cordiverse/paper"
date: "2026-08-18"
category: "learning"
tags: ["cordis", "plugin-framework", "spatiotemporal-composability", "effect", "coeffect", "typescript", "overview", "tutorial"]
---
...
| 章节 | 标题 | 内容概要 | 难度 |
|------|------|---------|------|
| 00 | [概述](00-overview.md)（当前页） | 教程介绍、术语表、章节导航、阅读路径、项目信息 | ⭐ |
| 01 | [背景理论与论文](01-background-paper.md) | 动态可组合性两大维度、可逆效应/响应式协同效应、统一上下文、论文贡献 | ⭐⭐⭐ |
| 02 | [文件结构与 Monorepo](02-repo-structure.md) | monorepo 工作区、10 个包职责、根配置文件解析 | ⭐⭐ |
| 03 | [核心抽象与架构](03-core-architecture.md) | Context/Service/Fiber/Registry/Events/Reflect/Logger 职责与关系 | ⭐⭐⭐ |
| 04 | [效应与协同效应机制](04-effects-coeffects.md) | 可逆效应（disposable）、依赖注入、符号体系、traceable | ⭐⭐⭐⭐ |
| 05 | [插件系统与依赖注入](05-plugin-system.md) | Plugin 三种形态、@Inject、Service、provide/get | ⭐⭐⭐ |
| 06 | [生命周期与状态机](06-lifecycle.md) | Fiber 状态机、effect 逆向回收、epoch 响应式、reload/unload | ⭐⭐⭐⭐ |
| 07 | [声明式加载与配置合并](07-loader-config.md) | Loader/Entry/Group/Tree、isolate、YAML 配置、JS 表达式 | ⭐⭐⭐ |
| 08 | [热更新 HMR](08-hmr.md) | 文件监听、accepted/declined 分类、缓存清理与回滚 | ⭐⭐⭐⭐ |
| 09 | [辅助包](09-aux-packages.md) | create/group/include/logger-console/timer/utils 作用与用法 | ⭐⭐ |
| 10 | [使用示例](10-usage-examples.md) | 最小插件、依赖注入、可逆副作用、装配的代码示例与架构图 | ⭐⭐⭐ |
| 11 | [FAQ 与注意事项](11-faq-notes.md) | API 未稳定、异步效应、注入语义、HMR 前置条件等 | ⭐⭐ |
| 12 | [总结与资源](12-summary-resources.md) | 核心知识点回顾、速查表、理论渊源与资源链接 | ⭐ |
...
- [下一章：背景理论与论文](01-background-paper.md) →