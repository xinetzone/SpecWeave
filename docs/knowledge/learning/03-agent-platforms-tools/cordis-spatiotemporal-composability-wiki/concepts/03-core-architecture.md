---
id: cordis-wiki-03-core-architecture
...
- logger
type: Concept
description: 讲解Cordis核心库七大核心抽象Context/Service/Fiber/Registry/Reflect/Events/Logger的职责与协作关系。
sources:
- id: cordis-paper
...
- [上一章：文件结构与 Monorepo](/concepts/02-repo-structure.md) | [下一章：效应与协同效应机制](/concepts/04-effects-coeffects.md) →