---
id: cordis-wiki-05-plugin-system
...
- provider
type: Concept
description: 讲解Cordis插件系统三种形态、@Inject装饰器依赖声明、RegistryService装配及Service继承与provide/get实现。
sources:
- id: cordis-paper
...
- [上一章：效应与协同效应机制](/concepts/04-effects-coeffects.md) | [下一章：生命周期与状态机](/concepts/06-lifecycle.md) →