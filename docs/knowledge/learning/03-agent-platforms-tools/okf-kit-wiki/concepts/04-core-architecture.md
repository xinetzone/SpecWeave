...
sources:
  - "https://github.com/vinodborole/okf-kit/blob/main/okf_kit/"
date: "2026-08-18"
category: "learning"
tags: ["okf-kit", "architecture", "bfs", "crawler", "fetcher", "mapper", "writer", "design-patterns"]
type: "Concept"
description: "okf-kit 核心由四个模块组成——crawl.py 实现 BFS 广度优先爬取控制流程，mapper.py 负责 URL 到文件路径的确定性映射，fetch/ 目录提供可插拔的 Fetcher 抽象层（HttpFetcher/BrowserFetcher），writer.py 负责将爬取结果写入 OKF 格式的 bundle 并生成目录索引。"
generated:
