...
type: Example
description: "讲解桌面应用、Claude Code、参考使用及其他工具四种方式，给出命令行示例与多 Agent 业务场景组合案例。"
sources:
...
- [上一章：多工具集成](/concepts/05-integrations.md) ←
- [下一章：策略与运行手册](/concepts/07-strategy-playbooks.md) →
