...
type: Reference
description: "讲解一套 Agent 文件如何集成到 16 种 AI 工具，涵盖安装目录、文件格式及 per-agent/roster/plugin 三种机制。"
sources:
...
- 上一章：[脚本体系](/concepts/04-scripts-tooling.md)
- [下一章：使用示例](/examples/06-usage-examples.md) →
