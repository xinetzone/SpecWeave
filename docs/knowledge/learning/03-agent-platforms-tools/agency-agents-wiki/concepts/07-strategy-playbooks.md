...
type: Pattern
description: "讲解 NEXUS 多 Agent 编排策略、7 阶段流水线与质量门、协调模板、4 个场景 Runbook 及 7 个 Playbook。"
sources:
...
- [上一章：使用示例](/examples/06-usage-examples.md) ←
- [下一章：常见问题解答](/references/08-faq-troubleshooting.md) →
