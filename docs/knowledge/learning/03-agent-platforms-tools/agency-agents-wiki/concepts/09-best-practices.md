...
type: Pattern
description: "从 Agent 选择、安装、使用、自定义、团队落地及与 AI 编程助手结合六个维度，提炼 The Agency 的实战最佳实践，并配流程图与速查清单。"
sources:
...
- [上一章：常见问题解答](/references/08-faq-troubleshooting.md) · [下一章：总结与资源](/references/10-summary-resources.md) →
