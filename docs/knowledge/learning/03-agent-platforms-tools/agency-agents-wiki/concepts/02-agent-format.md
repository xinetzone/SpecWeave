...
type: Concept
description: "逐字段解析 Agent 文件的 YAML frontmatter 与正文 8 大章节结构，并以 AI Engineer 为例做设计意图解读。"
sources:
...
> **下一步**：在 [部门名册](/concepts/03-roster-divisions.md) 中，我们将逐部门浏览这 230+ 个 Agent，了解每个部门的标志性专家与选型建议。

---

- [上一章：文件夹架构](/concepts/01-architecture.md) ←
- [下一章：部门名册](/concepts/03-roster-divisions.md) →
