...
type: Reference
description: "作为教程收尾，一句话总结核心价值、回顾 11 章要点、给出分角色学习路径，汇总 GitHub 仓库、桌面应用、社区翻译等资源并附核心术语表。"
sources:
  - id: agency-agents-github
    resource: https://github.com/msitarzewski/agency-agents
    title: The Agency GitHub Repository
generated:
...
1. 读 [概述](/index.md) 理解 The Agency 是什么。
2. 按 [文件夹架构](/concepts/01-architecture.md) 了解仓库如何组织 Agent。
3. 跟着 [快速上手演示](/concepts/quickstart-demo-guide.md) 走一遍"克隆 → 预览 → 安装 → 激活"的完整流程。
4. 深入 [使用示例](/examples/06-usage-examples.md) 学习更多安装激活与组合技巧。
5. 遇到问题查 [FAQ](/references/08-faq-troubleshooting.md)。
...
2. 学习 [最佳实践](/concepts/09-best-practices.md) 的团队落地章节（统一标准、质量门、NEXUS）。
3. 掌握 [策略与运行手册](/concepts/07-strategy-playbooks.md) 的多 Agent 编排与 Runbook。
4. 用 [多工具集成](/concepts/05-integrations.md) 统一团队所用工具。
...
1. 研究 [Agent 文件格式](/concepts/02-agent-format.md) 的 frontmatter 与章节模板。
2. 理解 [多工具集成](/concepts/05-integrations.md)（per-agent/roster/plugin）以兼容各工具。
3. 按 [最佳实践](/concepts/09-best-practices.md) 自定义与校验。
...
| 章节 | 标题 | 链接 |
|------|------|------|
| 00 | 概述 | [00-overview.md](/index.md) |
| 01 | 文件夹架构 | [01-architecture.md](/concepts/01-architecture.md) |
| 02 | Agent 文件格式解析 | [02-agent-format.md](/concepts/02-agent-format.md) |
| 03 | 部门名册 | [03-roster-divisions.md](/concepts/03-roster-divisions.md) |
| 04 | 脚本体系 | [04-scripts-tooling.md](/concepts/04-scripts-tooling.md) |
| 05 | 多工具集成 | [05-integrations.md](/concepts/05-integrations.md) |
| 06 | 使用示例 | [06-usage-examples.md](/examples/06-usage-examples.md) |
| 07 | 策略与运行手册 | [07-strategy-playbooks.md](/concepts/07-strategy-playbooks.md) |
| 08 | 常见问题解答 | [08-faq-troubleshooting.md](/references/08-faq-troubleshooting.md) |
| 09 | 最佳实践指南 | [09-best-practices.md](/concepts/09-best-practices.md) |
| 10 | 总结与资源（本文） | [10-summary-resources.md](/references/10-summary-resources.md) |
| 📖 | 新开发者快速上手演示（配套） | [quickstart-demo-guide.md](/concepts/quickstart-demo-guide.md) |

---

- [上一章：最佳实践指南](/concepts/09-best-practices.md)
