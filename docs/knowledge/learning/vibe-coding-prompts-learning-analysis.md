...
- [核心观点提炼](#核心观点提炼)
- [第一性原理深度解析](#第一性原理深度解析)
  - [Prompt 的具体形式](#prompt-的具体形式)
  - [底层机理:打断类比推理](#底层机理打断类比推理)
  - [实战案例:AIHOT 飞书推送 BUG 修复(治标 vs 治本)](#实战案例aihot-飞书推送-bug-修复治标-vs-治本)
  - [跨领域案例:SpaceX 火箭成本重构](#跨领域案例spacex-火箭成本重构)
  - [社区反响与使用建议](#社区反响与使用建议)
- [对抗式审查深度解析](#对抗式审查深度解析)
  - [Prompt 的具体形式](#prompt-的具体形式-1)
  - [执行模式:多 Agent 并发与攻击者视角](#执行模式多-agent-并发与攻击者视角)
  - [典型 BUG 类型](#典型-bug-类型)
  - [工具实践:Claude Code Ultracode 与 Codex 多 Agent](#工具实践claude-code-ultracode-与-codex-多-agent)
- [闭环逻辑分析](#闭环逻辑分析)
- [延伸应用](#延伸应用)
- [对本项目的启示](#对本项目的启示)
- [FAQ](#faq)
...
- 可复用模式库:[docs/retrospective/patterns/](docs/retrospective/patterns/)
- 复盘体系:[docs/retrospective/](docs/retrospective/)
