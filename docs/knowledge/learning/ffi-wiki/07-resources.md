...
title: "术语表与参考资料"
x-toml-ref: "../../../../.meta/toml/docs/knowledge/learning/ffi-wiki/07-resources.toml"
...
- [interface-api-abi-protocol-wiki](../interface-api-abi-protocol-wiki/00-overview.md) — 接口/API/ABI/协议四概念基础教程，其中 ABI 章节是理解 FFI 底层机制的关键前置知识
- [idl-wiki](../idl-wiki/00-overview.md) — IDL（接口定义语言）教程，与 FFI 共同构成跨语言互操作的两种互补路径：FFI 手动绑定 vs IDL 代码生成
