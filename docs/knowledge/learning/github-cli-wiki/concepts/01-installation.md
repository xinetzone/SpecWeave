...
type: Tutorial
description: "介绍 GitHub CLI 在 Windows、macOS、Linux 各主流平台的安装方法、认证登录流程、Shell 补全配置及环境变量设置。"
generated:
...
sources:
  - id: github-cli-manual-auth
    resource: https://cli.github.com/manual/gh_auth_login
    title: "GitHub CLI 官方手册 - gh auth login"
---
...
- ← [返回目录](/index.md) | [下一章：基础命令全览](/concepts/02-basic-commands.md) →