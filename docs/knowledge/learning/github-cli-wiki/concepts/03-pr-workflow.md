...
type: Tutorial
description: "介绍使用 GitHub CLI 完成 Pull Request 全生命周期管理，包括创建、审查、合并、关闭及 Fork 工作流等进阶场景。"
generated:
...
sources:
  - id: github-cli-manual-pr
    resource: https://cli.github.com/manual/gh_pr
    title: "GitHub CLI 官方手册 - gh pr"
---
...
GitHub CLI 的 PR 相关命令均以 `gh pr` 为入口，支持所有主流 PR 操作。在开始之前，请确保已完成 [安装与配置](/concepts/01-installation.md) 中的认证步骤。
