...
type: Tutorial
description: "涵盖 GitHub CLI 高级功能，包括 API 调用、别名系统、扩展管理、搜索语法、标签管理、规则集及 JSON 输出与 jq 组合用法。"
generated:
...
sources:
  - id: github-cli-manual-api
    resource: https://cli.github.com/manual/gh_api
    title: "GitHub CLI 官方手册 - gh api"
---
...
> **前置条件**：请确保已完成 [安装与配置指南](/concepts/01-installation.md) 中的认证流程，并熟悉 [基础命令指南](/concepts/02-basic-commands.md) 中的核心命令。
...
> **下一步**：阅读 [CI/CD 集成指南](/concepts/04-actions-cicd.md) 了解如何将 `gh` 深度集成到 GitHub Actions 工作流中。（注：如该章节尚未完成，可先阅读 [GitHub CLI 官方手册](https://cli.github.com/manual/) 了解更多）