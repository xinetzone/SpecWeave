...
type: Tutorial
description: "介绍 GitHub CLI 最常用的核心命令，涵盖仓库管理、Issue 跟踪、Gist 代码片段和浏览器集成四大模块的用法与示例。"
generated:
...
sources:
  - id: github-cli-manual
    resource: https://cli.github.com/manual/gh
    title: "GitHub CLI 官方手册 - gh"
---
...
> **前置条件**：请确保已完成 [安装与配置指南](/concepts/01-installation.md) 中的认证流程，否则本节命令将无法正常工作。
...
> **下一步**：继续阅读 [PR 工作流](/concepts/03-pr-workflow.md) 了解如何使用 `gh pr` 命令管理完整的 Pull Request 工作流。