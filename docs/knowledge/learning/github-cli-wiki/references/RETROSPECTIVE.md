...
type: Report
description: "GitHub CLI Wiki 教程创建任务的复盘报告，按七概念方法论 R→I→E→Export 四阶段记录事实、洞察、模式与导出归档。"
generated:
...
sources:
  - id: spec-github-cli-wiki
    resource: ".trae/specs/core-foundation/create-github-cli-wiki-tutorial/spec.md"
    title: "GitHub CLI Wiki 教程创建规范"
---
...
| 交叉引用 | OKF 绝对路径（如 `[01-installation.md](/concepts/01-installation.md)`） |
...
| 文件 | 说明 |
|------|------|
| [index.md](/index.md) | GitHub CLI 概述与教程导航 |
| [01-installation.md](/concepts/01-installation.md) | 安装指南（Windows/macOS/Linux） |
| [02-basic-commands.md](/concepts/02-basic-commands.md) | 基础命令（auth/repo/issue/gist/api） |
| [03-pr-workflow.md](/concepts/03-pr-workflow.md) | PR 工作流（create/review/merge/checkout） |
| [04-actions-cicd.md](/concepts/04-actions-cicd.md) | Actions CI/CD 集成（run/workflow/secret/variable） |
| [05-advanced-usage.md](/concepts/05-advanced-usage.md) | 高级用法（alias/config/extension/search） |
| [06-faq-troubleshooting.md](/references/06-faq-troubleshooting.md) | 常见问题与排错 |
| [07-cheatsheet.md](/references/07-cheatsheet.md) | 命令速查表 |
