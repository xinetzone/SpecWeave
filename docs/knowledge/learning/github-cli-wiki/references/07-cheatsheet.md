...
type: Reference
description: "GitHub CLI 完整命令速查表，按功能分类组织，集成 SpecWeave 工作流最佳实践、常用自动化模式和环境变量快速参考。"
generated:
...
- [概述](/index.md) — 教程总览与架构图
- [安装与配置指南](/concepts/01-installation.md) — 环境搭建与认证
- [基础命令指南](/concepts/02-basic-commands.md) — 仓库/Issue/Gist 核心操作
- [Pull Request 工作流指南](/concepts/03-pr-workflow.md) — PR 全生命周期管理
