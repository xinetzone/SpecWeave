...
架构细节参见 [ARCHITECTURE.md](https://github.com/virgiliojr94/book-to-skill/blob/main/docs/ARCHITECTURE.md)。
...
CLI 入口配置参见 [pyproject.toml#L13-L14](https://github.com/virgiliojr94/book-to-skill/blob/main/pyproject.toml#L13-L14)。
...
根据 [pyproject.toml#L16-L30](https://github.com/virgiliojr94/book-to-skill/blob/main/pyproject.toml#L16-L30)，可选依赖分为以下几组：
...
模块名到 pip 包名的映射参见 [config.py#L26-L34](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/config.py#L26-L34)。

### 依赖探测模式

book-to-skill 运行时会自动探测依赖是否安装，并根据配置决定是否自动安装缺失依赖。共有三种模式，通过 `--install-missing` 参数或 `BOOK_SKILL_INSTALL_MISSING` 环境变量控制。

实现细节参见 [dependencies.py#L102-L116](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/dependencies.py#L102-L116)。
...
优先级来源参见 [ARCHITECTURE.md#L35-L39](https://github.com/virgiliojr94/book-to-skill/blob/main/docs/ARCHITECTURE.md#L35-L39)。
...
检查实现参见 [dependencies.py#L216-L289](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/dependencies.py#L216-L289)。
...
输出路径配置参见 [config.py#L5-L12](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/config.py#L5-L12)。
...
技术模式提取流程参见 [utils.py#L484-L526](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/utils.py#L484-L526)。
...
支持的格式列表参见 [config.py#L19-L24](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/config.py#L19-L24)：
...
- [上一章：安全模型](05-security-model.md)
- [下一章：扩展开发](07-extending-development.md) →
