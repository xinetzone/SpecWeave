...
**实现位置**：[sanitize.py](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/sanitize.py)
...
**调用时机**：所有解析器输出后、指标统计或写入 `full_text.txt` 之前（[utils.py:568](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/utils.py#L568)）。
...
**实现位置**：[parsers/docx.py](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/parsers/docx.py) 中的 `validate_docx_xml_safety` 函数（第 71-92 行）
...
**调用时机**：`extract_docx` 函数入口处（[docx.py:96](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/parsers/docx.py#L96)），在任何 XML 解析之前执行。
...
**实现位置**：
- PDF 解析器：[parsers/pdf.py](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/parsers/pdf.py) 第 54 行、第 127 行
- Calibre 解析器：[parsers/calibre.py](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/parsers/calibre.py) 第 15 行
...
同样的模式也应用于 `pdfinfo`（[pdf.py:127](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/parsers/pdf.py#L127)）和 `ebook-convert`（[calibre.py:15](https://github.com/virgiliojr94/book-to-skill/blob/main/book_to_skill/parsers/calibre.py#L15)）。
...
**实现位置**：[tools/scan_generated_skill.py](https://github.com/virgiliojr94/book-to-skill/blob/main/tools/scan_generated_skill.py)
...
- [上一章：Token 经济学与性能](04-token-economics.md)
- [下一章：安装与使用](06-installation-usage.md) →
