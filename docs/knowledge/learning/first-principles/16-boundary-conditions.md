...
在[方法论框架](file:///d:/AI/docs/knowledge/learning/first-principles/08-methodology-framework.md)第6章中，我们初步讨论了第一性原理思维的适用边界，但那只是框架中的一个小节，不够系统和深入。随着第一性原理概念在商业媒体和创业圈的流行，一个危险的倾向正在出现：将其塑造成一种"高级思维"，似乎只有用第一性原理思考才是深刻的，而类比推理被贬低为"偷懒"、"缺乏想象力"甚至"思维枷锁"。🟡
...
除了[方法论框架](file:///d:/AI/docs/knowledge/learning/first-principles/08-methodology-framework.md)中提到的误区外，第一性原理思维还有几个更根本的局限：
...
正如[方法论框架](file:///d:/AI/docs/knowledge/learning/first-principles/08-methodology-framework.md)结尾所说：掌握第一性原理思维的最终标志，不是你到处用它，而是你知道**什么时候该用，什么时候不该用，以及如何和其他思维工具结合**。本文就是对这句话的展开论证。
