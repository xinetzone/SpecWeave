...
> **核心理念**：语法是广读的工具，而非目的。非限定动词（分词、动名词、不定式）本质上都是简化从句的残留碎片，所有复合句结构都可以通过识别并省略重复元素转化为简洁表达。
...
- [架构洞察](references/insights.md) — 5个核心洞察、知识地图与交叉链接策略
- [References 索引](references/index.md) — 事实清单与信源登记列表

### 事实清单

- [facts.md](references/facts.md) — 83条事实采集清单

### 信源登记

- [source-index.md](references/source-index.md) — 原首页信源
- [source-preface.md](references/source-preface.md) — 序信源
- [source-intro.md](references/source-intro.md) — 前言信源
- [source-guide.md](references/source-guide.md) — 广读方法论信源
