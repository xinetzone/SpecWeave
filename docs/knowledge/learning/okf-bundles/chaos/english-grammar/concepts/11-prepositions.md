...
type: Concept
title: "第七章 介词"
description: "介系词短语作形容词或副词修饰语的弹性用法、短语动词的种类与拆开原则、空间/时间介系词的点线面体区分、其他常用介系词与介系词短语的位置"
prerequisites: [10]
foreshadows: [22, 24]
tags: [语法, 词类, 介词]
...
sources:
  - id: source-ch07
    resource: "/references/source-ch07.md"
    title: "第七章 介词信源登记"
---
...
这个介系词可以表示「途径」或「手段」，例如：
  ...
  - He achieved fame <u>through sheer hard work</u>.（他纯粹是靠苦干而成名的。）
...
- [10 副词](/concepts/10-adverbs.md) — 介副词（particles）的概念在副词章首次介绍，本章对照介系词与介副词的差异

### 进阶拓展

- [22 名词从句](/concepts/22-noun-clauses.md) — 介系词短语位置的模棱两可问题涉及 that 从句的句尾判断
- [24 关系从句](/concepts/24-relative-clauses.md) — 介系词短语与 which 引导的关系从句的修饰关系
