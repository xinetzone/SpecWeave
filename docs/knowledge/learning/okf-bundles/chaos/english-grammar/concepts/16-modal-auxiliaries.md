...
type: Concept
title: "第十一章 语气助动词"
description: "语气助动词配合原形动词表达条件语气，主要与次要语气助动词的一般用法与猜测用法，过去拼法配合完成时表示相对过去时间与非事实语气"
prerequisites: [15]
foreshadows: [17, 19, 27]
tags: [语法, 动词, 助动词, 语气]
...
sources:
  - id: source-ch11
    resource: "/references/source-ch11.md"
    title: "第十一章 语气助动词信源登记"
---
...
这一对语气助动词，一般用法是用来表示「准许，许可」，有时态的差别，例如：
  ...
  - You <u>may go</u> now.（你们现在可以走了。）（现在时间）
...
#### would
  ...
  - That <u>would have been</u> the mailman just now; I found some new mail in the box.（刚刚应该是邮差，我看到信箱里有新邮件。）（猜过去）
...
疑问句：
  ...
  - Do you <u>have to leave</u> now?（你现在非走不可吗？）（一般用法）
...
否定句：
  ...
  - I <u>dare not tell</u> my wife the truth.（我不敢告诉我太太真相。）
...
- [15 语态](/concepts/15-voice.md) — 动词体系的上一章，助动词与被动结构、完成时结构的配合基础

### 进阶拓展

- [17 语气](/concepts/17-moods.md) — 本章条件语气、非事实语气的概念在语气章系统展开
- [19 不定式短语](/concepts/19-infinitives.md) — must→have to、should→ought to：语气助动词与 to 不定式的演化对应链路
- [27 简化从句](/concepts/27-reduced-clauses-introduction.md) — 语气助动词简化为 to 的从句省略规则
