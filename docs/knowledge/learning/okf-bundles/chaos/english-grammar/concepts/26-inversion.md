...
type: Concept
title: "第二十一章 倒装句"
description: "四种倒装方式：引用句倒装、类似 there is/are 构造、假设语气助动词前移、否定副词前移与省略谓语倒装，及其加强语气与简洁的修辞功能"
prerequisites: [17, 20, 21]
foreshadows: [27]
tags: [语法, 句法, 倒装, 修辞]
...
sources:
  - id: source-ch21
    resource: "/references/source-ch21.md"
    title: "第二十一章 倒装句信源登记"
---
...
这时候，后面的 the weatherman says 可以视为一个可有可无的评论从句，而把前面的 the typhoon is expected to swerve north for Japan 视为主要从句。所谓评论从句，基本上是一种**插入句（embedding）**&#8203;。它插入的位置不一定是在句尾，也可以用一对逗点隔开、插入在主语动词之间。这个插入句可以选择倒装、也可以不倒装，如下：
  ...
  - The typhoon, <u>says the weatherman</u>, is expected to swerve north for Japan. 插入句（倒装）
...
上述「类似 there is/are 的构造」如果出现在关系从句中，仍然可以采用直接移动动词的方式来倒装。例如：
  ...
  2. <u>The deadly pirana</u> <u>roam</u> <u>in that river</u>. S V 地方副词（致命的食人鱼在那条河中漫游。）
...
在动词短语 will trouble 中间有个表示否定的频率副词 never，这个副词其实就是 not ever 的合并，配合助动词 will 来构成否定句。如果把这个表示否定的副词移到句首来加强语气，那么助动词 will 就会跟着它倒装到主语前面以维持否定句（will not）的构造，结果就是这个倒装句：
...
- [17 语气](/concepts/17-moods.md) — 假设语气副词从句省略 if 后的助动词前移倒装（Had I been there / Were I a millionaire）
- [20 对等连词](/concepts/20-coordinate-conjunctions.md) — So do I、neither will I 类倒装建立在对等结构与谓语省略的基础上
- [21 复合句](/concepts/21-compound-sentences.md) — 句子三层次认知框架：倒装是进入简化从句前的最后一种特殊句型

### 进阶拓展

- [27 简化从句](/concepts/27-reduced-clauses-introduction.md) — 本章之后的下一站：简化从句总论，高级句型的核心省略原则
