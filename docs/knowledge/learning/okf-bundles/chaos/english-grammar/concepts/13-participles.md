...
type: Concept
title: "第八章 分词"
description: "分词视为形容词的用法（名词短语中与补语位置），过去分词的被动/完成暗示与现在分词的进行暗示，以be动词+分词补语的简化诠释取代背公式的分析"
prerequisites: [09]
foreshadows: [14, 15, 27, 28, 30]
tags: [语法, 动词, 分词, 非限定动词]
...
sources:
  - id: source-ch08
    resource: "/references/source-ch08.md"
    title: "第八章 分词信源登记"
---
...
- [14 动词时态](/concepts/14-verb-tenses.md) — 本章「be为动词+分词为补语」的简化诠释法使时态体系大幅简化，下一章完整展开
- [15 语态](/concepts/15-voice.md) — 过去分词的「被动」语态暗示与被动态句型的系统分析
- [27 简化从句](/concepts/27-reduced-clauses-introduction.md) — 分词短语以简化从句诠释的总论框架（本章「这是后话」的伏笔）
- [28 关系从句简化](/concepts/28-reduced-relative-clauses.md) — V-ing/V-en 作定语的本质是关系从句省略 which is/that is 的简化残留
- [30 副词从句简化](/concepts/30-reduced-adverb-clauses.md) — 分词构句的完整体系，即副词从句简化为分词短语
