...
type: Concept
title: "第十章 语态"
description: "主动与被动语态的区分，五种基本句型中三种含宾语句型的被动态改写，完成时与进行时的被动态，以及连贯性、清楚性、简洁性的被动使用原则"
prerequisites: [14]
foreshadows: [16, 27, 30]
tags: [语法, 动词, 语态]
...
sources:
  - id: source-ch10
    resource: "/references/source-ch10.md"
    title: "第十章 语态信源登记"
---
...
如果是 S + V + O1 + O2 的句型，那么 O1 的位置必须是给予的对象（如 Bush）、O2 的位置则是给他的东西（如 permission）。假如 O1 的位置从缺，这个句子就会变成只有一个宾语的句型：Congress(S) gave(V) permission(O)。另一个宾语 Bush 这时候必须以介系词短语 to Bush 的方式来处理，结果就是前面的例句 4。而如果拿例句 4 来改写被动态，把唯一的宾语 permission 拿出来当主语、动词变成被动态的 was given，剩下的部分 to Bush to launch war 照抄，就会变成前面例句 3 的结果。
...
- [14 动词时态](/concepts/14-verb-tenses.md) — 完成时与进行时被动态的时态判断基础

### 进阶拓展

- [16 语气助动词](/concepts/16-modal-auxiliaries.md) — 动词体系的下一章，助动词与被动结构的配合
- [27 简化从句](/concepts/27-reduced-clauses-introduction.md) — 被动态造成两从句主语相同后即可进行从句简化的总论
- [30 副词从句简化](/concepts/30-reduced-adverb-clauses.md) — Told to wait outside 即被动副词从句简化的成果
