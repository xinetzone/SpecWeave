...
type: Concept
title: "第一章 基本句型"
description: "英文简单句的五种基本句型（S+V、S+V+O、S+V+O+O、S+V+C、S+V+O+C），主语与谓语、补语的词类、以及基本句型的分辨方法"
prerequisites: [05]
foreshadows: [07, 09, 10]
tags: [语法, 句法, 基本句型, 补语]
...
sources:
  - id: source-ch01
    resource: "/references/source-ch01.md"
    title: "第一章 基本句型信源登记"
---
...
> 📌 本书使用 <u>下划线</u> 标记句子的核心成分——主语（S）、动词（V）、宾语（O）、补语（C）。后文各章均沿用此标记体系。
...
一个完整的句子，必须能够表达完整的意思。这至少需要两个部分：**主语（subject）**&#8203;和**谓语（predicate）**&#8203;。主语，是介绍这个句子主语的部分，以主语为核心，告诉读者这个句子「主角是谁」。谓语，则是句子中担任叙述工作的部分，以**限定动词（finite verb）**&#8203;为核心，告诉读者这个主角「做了什么事」或者「是什么样」。

> **📊 谓语的两大功能对照表**
>
> | 功能类别 | 说明 | 例句 | 谓语部分 |
> |---|---|---|---|
> | **动作类谓语** | 告诉读者主语“做了什么事” | 我 **跑步**。 | 跑步 |
> | | | 她 **写作业**。 | 写作业 |
> | | | 小狗 **在叫**。 | 在叫 |
> | **性质/状态类谓语** | 告诉读者主语“是什么样” | 花园里的花 **很漂亮**。 | 很漂亮 |
> | | | 他 **很聪明**。 | 很聪明 |
> | | | 今天 **下雨了**。 | 下雨了 |
...
<u>The plane</u> <u>is</u> <u>down</u>. S V C（飞机着陆了。）
...
- [05 正文目录](/concepts/05-chapter-toc.md) — 全书章节总览，进入正文学习的第一站

### 进阶拓展

- [07 名词短语](/concepts/07-noun-phrases.md) — 主语和宾语都必须以名词短语形态出现，限定词+形容词+名词三部分构造
- [09 形容词](/concepts/09-adjectives.md) — 补语位置形容词（predicative）的深入讨论
- [10 副词](/concepts/10-adverbs.md) — 时间副词、地点副词与介副词同样可以担任补语

### 关联参考

- [04 两岸术语对照](/concepts/04-terminology-cross-strait.md#linking-verb) — 「系动词/连缀动词」术语对照
- [04 两岸术语对照](/concepts/04-terminology-cross-strait.md#dative-verb) — 「授予动词/授与动词」术语对照
- [03 引：广读学英语](/concepts/03-extensive-reading-method.md) — 判断动词及物与否须透过广读大量接触
