...
type: Concept
title: "第二十二章 简化从句"
description: "简化从句总论：省略从属从句中重复主语与空洞 be 动词的核心原则，动词处理三原则（省略 be／助动词改 to／普通动词加 -ing）与连词的取舍"
prerequisites: [26]
foreshadows: [28, 29, 30]
tags: [语法, 句法, 简化从句, 非限定动词, 修辞]
...
sources:
  - id: source-ch22
    resource: "/references/source-ch22.md"
    title: "第二十二章 简化从句信源登记"
---
...
- [26 倒装句](/concepts/26-inversion.md) — 简化从句之前最后一种特殊句型，完成中高级句型的认识闭环

### 进阶拓展

- [28 关系从句简化](/concepts/28-reduced-relative-clauses.md) — 关系从句省略关系词与 be 动词后剩余补语的五种形态
- [29 名词从句简化](/concepts/29-reduced-noun-clauses.md) — 名词从句省略 that 后简化为动名词与不定式短语
- [30 副词从句简化](/concepts/30-reduced-adverb-clauses.md) — 副词从句简化为分词构句、不定式短语等非限定结构
