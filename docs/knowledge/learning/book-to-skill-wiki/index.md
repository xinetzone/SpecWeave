...
| 章节 | 内容 |
|------|------|
| [01 核心架构](/concepts/01-core-architecture.md) | 双层架构设计：Python 提取器 + SKILL.md 规范驱动生成器 |
| [02 提取器深度解析](/concepts/02-extractor-deep-dive.md) | 格式支持矩阵、多语言章节检测、优雅降级策略 |
| [03 SKILL.md 生成规范](/concepts/03-skill-md-spec.md) | 4 种操作模式、10 步流程、Token 预算矩阵、文件模板 |
| [04 Token 经济学](/concepts/04-token-economics.md) | Discovery Loop Tax 原理、性能基准、大书访问策略 |
| [05 安全模型](/concepts/05-security-model.md) | 文档→Agent 供应链攻击面、5 层防御体系 |
| [06 安装与使用](/concepts/06-installation-usage.md) | 两种安装方式、Skill 位置、基本示例、环境预检 |
| [07 扩展开发](/concepts/07-extending-development.md) | 新增格式、自定义生成行为、工具脚本说明 |
| [08 可复用模式](/concepts/08-transferable-patterns.md) | 5 个可迁移到 SpecWeave 的工程模式 |
| [09 总结与 FAQ](/references/09-summary-faq.md) | 核心要点、常见问题、延伸阅读 |
