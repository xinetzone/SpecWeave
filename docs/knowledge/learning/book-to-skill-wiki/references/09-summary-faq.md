---
type: Reference
description: "总结 book-to-skill 的十大核心要点，解答十个常见问题（与 RAG 区别、格式支持、转换成本、大窗口、扫描版 PDF、版权、故障排查、扩展开发、安全扫描、章节检测），提供延伸阅读资源。"
generated:
...
**A**: 参考 [07 扩展开发](/concepts/07-extending-development.md) 章节，核心步骤：
...
| 章节 | 内容 |
|------|------|
| [00 总览](/index.md) | 项目介绍、核心价值、适用场景 |
| [01 核心架构](/concepts/01-core-architecture.md) | 双层架构设计：提取器 + 生成器 |
| [02 提取器深度解析](/concepts/02-extractor-deep-dive.md) | 格式支持矩阵、多语言检测、降级策略 |
| [03 SKILL.md 生成规范](/concepts/03-skill-md-spec.md) | 操作模式、10 步流程、Token 预算 |
| [04 Token 经济学](/concepts/04-token-economics.md) | Discovery Loop Tax 原理、基准数据 |
| [05 安全模型](/concepts/05-security-model.md) | 五层纵深防御、攻击面分析 |
| [06 安装与使用](/concepts/06-installation-usage.md) | 两种安装方式、基本示例、环境预检 |
| [07 扩展开发](/concepts/07-extending-development.md) | 新增格式、自定义生成、工具脚本 |
| [08 可复用模式](/concepts/08-transferable-patterns.md) | 5 个可迁移到 SpecWeave 的工程模式 |
| [09 总结与 FAQ](/references/09-summary-faq.md) | 本章节 |
