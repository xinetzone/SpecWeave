---
id: python314-stdlib-wiki-16-mystx-tests-catalog
title: "mystx 主题单元测试用例清单（54 项）"
date: "2026-08-20"
category: "learning"
tags: ["python", "python-3.14", "stdlib", "mystx", "sphinx", "theme", "testing", "pytest", "coverage", "annotationlib", "dataclasses", "traceback", "sys-monitoring"]
type: "Reference"
description: "本清单完整索引mystx Sphinx主题测试套件的全部54项单元测试，按测试文件、被测模块、断言要点与Spec要求组织，并给出运行方式与维护约定。"
sources:
  - id: "mystx-tests"
    resource: "d:\\spaces\\SpecWeave\\playground\\books\\libs\\mystx\\tests"
    title: "mystx 主题测试套件"
generated:
...
4. **新增 Python 3.14 特性**：按 Spec「诚实记录」原则，仅在 mystx 代码有实际落点时才新增对应测试，不为凑齐模块而强行引入无收益用例。相关落点评估见 [14-mystx-optimization-mapping](/concepts/14-mystx-optimization-mapping.md)，优化前后量化对比见 [15-mystx-optimization-report](/references/15-mystx-optimization-report.md)。