...
type: "Reference"
description: "traceback是Python标准库中用于提取、格式化与打印程序栈回溯信息的标准接口，比解释器默认回溯显示更灵活，且能在不持有异常对象引用时捕获异常信息。"
generated:
...
- [上一章：dataclasses](/concepts/06-dataclasses.md) →
- [下一章：跨模块综合分析](/concepts/08-cross-module-analysis.md) →