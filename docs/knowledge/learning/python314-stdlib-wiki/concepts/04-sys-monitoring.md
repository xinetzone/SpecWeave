...
date: "2026-08-18"
category: "learning"
tags: ["python", "python-3.14", "stdlib", "sys", "monitoring", "profiling", "debugging", "instrumentation", "tutorial"]
type: "Reference"
description: "sys.monitoring是Python 3.12起提供的低开销、事件驱动的运行时监控命名空间，用工具标识符、事件集合与回调三要素让调试器、覆盖率工具等按需订阅执行事件。"
generated:
...
- [上一章：contextvars](/concepts/03-contextvars.md) →
- [下一章：annotationlib](/concepts/05-annotationlib.md) →