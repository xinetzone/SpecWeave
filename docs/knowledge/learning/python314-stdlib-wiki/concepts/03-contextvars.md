...
date: "2026-08-18"
category: "learning"
tags: ["python", "python-3.14", "stdlib", "contextvars", "context", "asyncio", "concurrency", "tutorial"]
type: "Reference"
description: "contextvars模块提供了一组上下文局部变量的管理API，让每个异步任务都能持有彼此隔离的状态，从根本上避免并发代码中状态意外串扰的问题。"
generated:
...
- [上一章：contextlib](/concepts/02-contextlib.md) →
- [下一章：sys.monitoring](/concepts/04-sys-monitoring.md) →