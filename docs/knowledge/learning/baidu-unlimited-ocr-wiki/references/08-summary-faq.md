...
sources:
  - "https://mp.weixin.qq.com/s/rO2yAeDZYbAoEXc7LqX-dg?from=industrynews&color_scheme=light#rd"
date: "2026-08-03"
category: "learning"
tags: ["OCR","总结","FAQ","速查表","资源","vLLM","SGLang","批量推理"]
type: "Reference"
description: "全系列教程总结，包含5个核心Takeaways、关键信息速查表（参数/性能/部署/局限）、10个FAQ常见问题解答和延伸阅读资源，可快速查找Unlimited-OCR关键数据与解答疑问。"
generated:
...
| 章节 | 标题 | 核心内容 |
|------|------|---------|
| 00 | [概述](/index.md) | 背景痛点、项目简介、核心特性、阅读路径 |
| 01 | [核心架构与设计理念](/concepts/01-core-architecture.md) | R-SWA原理、"人抄书"类比、软遗忘哲学、静态/动态分区 |
| 02 | [性能数据与基准测试](/references/02-performance-data.md) | OmniDocBench基准、长文档表现、TPS效率对比 |
| 03 | [快速上手指南](/concepts/03-quick-start.md) | 环境要求、gundam/base双模式、Transformers/SGLang/vLLM三种部署、infer.py批量推理 |
| 04 | [局限性与风险提示](/references/04-limitations-risks.md) | 5大局限性、成熟度评估、适用场景评级、风险规避 |
| 05 | [架构创新深度启示](/concepts/05-architecture-insights.md) | 归纳偏置、软遗忘哲学、静态/动态洞见、注意力机制演进 |
| 06 | [可迁移模式与行业启示](/concepts/06-transferable-patterns.md) | MoE哲学、专用/通用分化、4000步创新路径、R-SWA迁移性分析 |
| 07 | [对SpecWeave的可行动启示](/concepts/07-specweave-implications.md) | 规范前置+对话滑窗中间件、文档预编码+按需检索机制 |
| 08 | [总结与常见问题](/references/08-summary-faq.md)（当前页） | 要点回顾、速查表、FAQ、延伸阅读 |

---

## 章节导航

← 上一章：[对SpecWeave的可行动启示](/concepts/07-specweave-implications.md)
