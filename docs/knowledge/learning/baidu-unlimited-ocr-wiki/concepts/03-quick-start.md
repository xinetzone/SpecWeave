...
type: "Tutorial"
description: "基于官方源码README和infer.py脚本整理，提供Transformers/SGLang/vLLM三种部署方式，gundam/base双图像模式，内置infer.py支持目录/PDF一键批量推理，PDF需先用PyMuPDF转图片（DPI=300）。"
generated:
...
← 上一章：[性能数据与基准测试](/references/02-performance-data.md)

[下一章：局限性与风险提示](/references/04-limitations-risks.md) →
