...
type: "Concept"
description: "OCR本质是'有参考、逐字抄录'而非'无中生有创作'，R-SWA非对称注意力机制实现参考侧全可见、输出侧128 token滑窗，配合DeepEncoder一次性编码与固定大小KV cache，用机制设计而非参数堆砌解决长文档OCR难题。"
generated:
...
[下一章：性能数据与基准测试](/references/02-performance-data.md) →
