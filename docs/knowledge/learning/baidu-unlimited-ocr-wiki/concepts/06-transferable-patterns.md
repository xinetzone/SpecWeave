...
type: "Pattern"
description: "R-SWA核心思想（参考侧全可见+输出侧滑窗+静态/动态信息分区）是适用于所有'有明确静态参考、逐token输出'任务的通用架构模式，涵盖MoE效率哲学、专用/通用模型分化、4000步创新路径及代码生成/客服对话等迁移方向。"
generated:
...
← 上一章：[架构创新深度启示](/concepts/05-architecture-insights.md)

[下一章：对SpecWeave的可行动启示](/concepts/07-specweave-implications.md) →
