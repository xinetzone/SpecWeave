...
type: "Concept"
description: "500M激活参数打败235B大模型的本质是机制创新对参数堆砌的降维打击，从第一性原理剖析R-SWA带来的归纳偏置力量、软遗忘哲学、静态/动态信息分区与视觉token不参与状态转移的架构思想革命。"
generated:
...
← 上一章：[局限性与风险提示](/references/04-limitations-risks.md)

[下一章：可迁移模式与行业启示](/concepts/06-transferable-patterns.md) →
