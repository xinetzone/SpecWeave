...
> **源码锚点**：name 验证逻辑见 [validator.py:25-67](../../../../.agents/scripts/mdi/validator.py#L25-L67)；NFKC 测试见 [test_validator.py:267-290](file:///d:/spaces/SpecWeave/external/agentskills/skills-ref/tests/test_validator.py#L267-L290)
...
> **规范锚点**：推荐限制见 [specification.mdx §Progressive disclosure](file:///d:/spaces/SpecWeave/external/agentskills/docs/specification.mdx)
