...
| 模块 | 路径 | 说明 |
|------|------|------|
| 🔧 **技术模块** | [`tech/`](/concepts/tech/intro.md) | 项目概述、安装指南、核心功能、部署配置、版本记录 |
| 🌐 **通用知识** | [`general/domain/`](/concepts/general/domain/index.md) | 终端AI编程助手领域知识、设计理念分析 |
| 🔬 **深度研究** | [`topics/`](/concepts/topics/index.md) | 设计哲学、行业洞察、竞争格局分析 |
...
1. **了解项目** → 阅读 [项目概述](/concepts/tech/intro.md)，理解 CodeWhale 的定位与核心价值
2. **安装运行** → 跟随 [安装与首次使用指南](/concepts/tech/quickstart.md)，完成环境搭建与第一个任务
3. **深入功能** → 阅读 [核心功能详解](/concepts/tech/features.md)，理解模型路由、嵌套宪法等核心机制
4. **拓展阅读** → 浏览 [领域知识](/concepts/general/domain/index.md) 和 [设计哲学](/concepts/topics/index.md)，深入理解终端AI编程助手生态
...
| 文档 | 适合人群 | 预计阅读时间 |
|------|---------|-------------|
| [项目概述](/concepts/tech/intro.md) | 所有用户 | 10 分钟 |
| [安装与首次使用指南](/concepts/tech/quickstart.md) | 新用户 | 15 分钟 |
| [核心功能详解](/concepts/tech/features.md) | 开发者 | 20 分钟 |
| [安装渠道与提供商配置](/concepts/tech/deploy.md) | 运维/配置者 | 15 分钟 |
