...
x-toml-ref: "../../../../../.meta/toml/docs/knowledge/learning/headroom-context-compression-wiki/concepts/07-quick-start.toml"
type: "Tutorial"
...
1. 按照[第四章](/concepts/04-integration-methods.md#5-mcp-server标准工具协议)配置好MCP
2. 重启Claude Desktop
...
2. **选择合适的接法**：参考[第四章：四种接入方式详解](/concepts/04-integration-methods.md)，确定长期使用的接入方式
3. **了解原理**：阅读[第三章：CCR可逆机制](/concepts/03-ccr-mechanism.md)，理解为什么压缩不会丢信息
4. **查看数据**：用`headroom stats`命令看累计省了多少Token、多少钱
5. **进阶功能**：体验[第六章的跨Agent记忆和自学习功能](/concepts/06-advanced-features.md)

如果遇到问题，先查看[第九章：FAQ与资源链接](/references/09-faq-resources.md)，或者去GitHub提Issue。

---

- ← [上一章：进阶功能：跨Agent记忆与自学习](/concepts/06-advanced-features.md)
- [下一章：深度洞察与模式萃取](/concepts/08-insights-patterns.md) →
