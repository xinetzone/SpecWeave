...
x-toml-ref: "../../../../../.meta/toml/docs/knowledge/learning/headroom-context-compression-wiki/concepts/03-ccr-mechanism.toml"
type: "Concept"
...
这是我们在[第二章](/concepts/02-compression-algorithms.md)详细讲过的压缩过程：
- 内容感知路由，选择最合适的压缩算法
- 对原始内容进行结构化压缩，生成精简版
- 压缩后的内容送入LLM上下文窗口
...
- ← [上一章：六种压缩算法详解](/concepts/02-compression-algorithms.md)
- [下一章：四种接入方式详解](/concepts/04-integration-methods.md) →
