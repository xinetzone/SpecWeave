...
x-toml-ref: "../../../../../.meta/toml/docs/knowledge/learning/headroom-context-compression-wiki/references/10-summary.toml"
type: "Reference"
...
1. **马上安装体验**：按照[第七章：快速上手指南](/concepts/07-quick-start.md)，5分钟装上，用`headroom wrap`包住你日常用的Claude/Cursor
2. **用一天感受效果**：正常使用一天，退出时看看省了多少Token——这个数字会说服你
3. **选择长期接法**：根据你的工具链，在[第四章](/concepts/04-integration-methods.md)选一个合适的接入方式长期用
...
1. **精读第八章的模式萃取**：[08-insights-patterns.md](/concepts/08-insights-patterns.md)——三个设计模式、行业趋势、开发者启示，这章是整个Wiki思想密度最高的
...
4. **研究相关项目**：看看[第九章](/references/09-faq-resources.md#3-相关参考资料)里推荐的LLMLingua、Mem0、Letta等项目，对比它们的思路差异
...
- ← [上一章：FAQ与资源链接](/references/09-faq-resources.md)
