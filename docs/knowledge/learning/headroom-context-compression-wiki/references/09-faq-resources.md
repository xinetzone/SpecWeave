...
x-toml-ref: "../../../../../.meta/toml/docs/knowledge/learning/headroom-context-compression-wiki/references/09-faq-resources.toml"
type: "Reference"
...
| 问题 | 快速排查 | 参考章节 |
|------|---------|---------|
| 命令找不到 | 检查Python版本、PATH路径 | [07-quick-start.md Q2](/concepts/07-quick-start.md#q2-headroom-命令找不到command-not-found) |
| 端口被占用 | 换端口或杀进程 | [07-quick-start.md Q4](/concepts/07-quick-start.md#q4-启动proxy时提示端口被占用) |
| MCP不生效 | 检查JSON格式、路径、重启 | [07-quick-start.md Q6](/concepts/07-quick-start.md#q6-windows上mcp配置不生效) |
...
- ← [上一章：深度洞察与模式萃取](/concepts/08-insights-patterns.md)
- [下一章：总结与Takeaways](/references/10-summary.md) →
