...
title: "三、主要 IDL 规范介绍：五大主流实现详解"
x-toml-ref: "../../../../.meta/toml/docs/knowledge/learning/idl-wiki/03-major-idl-specs.toml"
...
**上一章**：[02 - IDL 基本语法结构](02-syntax-basics.md)  
**下一章**：[04 - IDL 规范对比](04-comparison.md)
