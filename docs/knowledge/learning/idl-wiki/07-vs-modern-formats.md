...
title: "七、与现代接口描述方式对比：从 RPC IDL 到 Web IDL 与 AI-friendly IDL"
x-toml-ref: "../../../../.meta/toml/docs/knowledge/learning/idl-wiki/07-vs-modern-formats.toml"
...
# 七、与现代接口描述方式对比：从 RPC IDL 到 Web IDL 与 AI-friendly IDL
...
MDI 是项目内探索的 **"AI-friendly IDL"**，使用 Markdown 作为接口定义格式。项目复盘洞察（详见 [insight-extraction.md#L43-L47](../../../../docs/retrospective/reports/project-reports/retrospective-mdi-project-completion-20260702/insight-extraction.md#L43-L47)）明确指出：
...
**上一章**：[06 - 实际应用案例与最佳实践](06-use-cases.md)  
**下一章**：[08 - 学习资源与参考资料](08-resources.md)
