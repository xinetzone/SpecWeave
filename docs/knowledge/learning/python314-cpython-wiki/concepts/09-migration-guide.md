...
type: Tutorial
description: "Python 3.14 迁移指南，涵盖破坏性变更、弃用移除、兼容性策略与升级步骤"
sources:
  - https://docs.python.org/zh-cn/3.14/whatsnew/3.14.html#porting-to-python-3-14
date: 2026-08-19
category: learning
...
- [上一章：构建系统与平台支持](/concepts/08-build-platform.md) ←
- [下一章：实战示例](/examples/10-practical-examples.md) →
