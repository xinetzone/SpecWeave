---
id: python314-cpython-wiki-06-cpython-architecture
title: CPython 源码架构总览
type: Concept
description: "CPython 3.14 内部架构深度解析，涵盖对象模型、内存管理、编译器与执行引擎"
sources:
  - https://github.com/python/cpython/tree/v3.14.0, https://devguide.python.org/
date: 2026-08-19
category: learning
tags: ["python314", "cpython", "architecture", "ceval", "gc", "objects", "parser"]
generated:
...
- [上一章：标准库重大改进](/concepts/05-stdlib-improvements.md) ←
- [下一章：C API 与扩展开发](/references/07-c-api-changes.md) →
