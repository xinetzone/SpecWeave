...
type: Reference
description: "Python 3.14 标准库改进汇总，涵盖 asyncio、pathlib、typing、datetime 等模块增强"
sources:
  - https://docs.python.org/zh-cn/3.14/whatsnew/3.14.html#improved-modules
date: 2026-08-19
category: learning
tags: ["python314", "stdlib", "asyncio", "concurrent-futures", "pathlib", "pdb", "repl", "uuid", "argparse", "unittest", "heapq", "logging", "json", "inspect"]
generated:
...
`inspect` 模块在 3.14 中配合 PEP 649/749 增加了注解格式控制能力（详见[第 1 章 §3.5](/concepts/01-language-features.md#35-类型系统重要变更)），此处补充其他增强：
...
- [上一章：新模块详解](/concepts/04-new-modules.md) ←
- [下一章：CPython 源码架构总览](/concepts/06-cpython-architecture.md) →
