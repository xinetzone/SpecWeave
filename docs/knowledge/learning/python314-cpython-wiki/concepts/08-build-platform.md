---
id: python314-cpython-wiki-08-build-platform
title: Python 3.14 构建系统与平台支持
type: Tutorial
description: "Python 3.14 构建与平台支持指南，涵盖编译选项、平台兼容性、free-threaded 构建配置"
sources:
  - https://docs.python.org/zh-cn/3.14/whatsnew/3.14.html#build-changes, https://peps.python.org/pep-0739/, https://peps.python.org/pep-0761/, https://peps.python.org/pep-0776/
date: 2026-08-19
category: learning
tags: ["python314", "build", "platform", "jIT", "android", "emscripten", "sigstore"]
generated:
...
- [上一章：C API 与扩展开发](/references/07-c-api-changes.md) ←
- [下一章：迁移指南](/concepts/09-migration-guide.md) →
