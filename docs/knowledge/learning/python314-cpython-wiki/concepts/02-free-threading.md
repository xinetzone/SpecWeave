...
type: Concept
description: "Python 3.14 free-threaded 模式（PEP 703）深度解析，涵盖无 GIL 构建、线程安全与性能影响"
sources:
  - https://docs.python.org/zh-cn/3.14/whatsnew/3.14.html#free-threaded-cpython, https://peps.python.org/pep-0703/, https://peps.python.org/pep-0779/, https://github.com/python/cpython/blob/v3.14.0/InternalDocs/qsbr.md
date: 2026-08-19
category: learning
...
- [上一章：语言新特性](/concepts/01-language-features.md) ←
- [下一章：JIT 编译器与新执行模型](/concepts/03-jit-interpreter.md) →
