...
type: Concept
description: "Python 3.14 核心语言特性详解，包括 PEP 750 t-strings、PEP 761 异步生成器、类型系统增强等"
sources:
  - https://docs.python.org/zh-cn/3.14/whatsnew/3.14.html, https://peps.python.org/pep-0758/, https://peps.python.org/pep-0765/, https://peps.python.org/pep-0649/, https://peps.python.org/pep-0749/, https://peps.python.org/pep-0750/
date: 2026-08-19
category: learning
...
- [上一章：概述](/index.md) ←
- [下一章：自由线程（无 GIL）深度解析](/concepts/02-free-threading.md) →
