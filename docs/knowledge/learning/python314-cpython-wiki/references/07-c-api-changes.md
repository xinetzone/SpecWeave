---
id: python314-cpython-wiki-07-c-api-changes
title: Python 3.14 C API 与扩展开发
type: Reference
description: "Python 3.14 C API 变更指南，涵盖新增 API、废弃接口、free-threading 兼容性与迁移建议"
sources:
  - https://docs.python.org/zh-cn/3.14/whatsnew/3.14.html#new-c-api-features, https://peps.python.org/pep-0741/, https://peps.python.org/pep-0757/, https://peps.python.org/pep-0768/
date: 2026-08-19
category: learning
tags: ["python314", "c-api", "c-extensions", "pep741", "pep757", "limited-api"]
generated:
...
此 API 支持 `pdb -p PID` 远程附加功能（见 [05-stdlib-improvements.md §5](/concepts/05-stdlib-improvements.md#5-pdb远程调试与增强)）。
...
- [上一章：CPython 源码架构总览](/concepts/06-cpython-architecture.md) ←
- [下一章：构建系统与平台支持](/concepts/08-build-platform.md) →
