---
id: python314-cpython-wiki-12-summary-resources
title: Python 3.14 总结与资源
type: Reference
description: "Python 3.14 总结与学习资源汇总，涵盖核心特性回顾、官方文档链接、社区资源推荐"
sources:
  - https://docs.python.org/zh-cn/3.14/, https://github.com/python/cpython/tree/v3.14.0
date: 2026-08-19
category: learning
tags: ["python314", "summary", "resources", "learning-path"]
generated:
...
| 章节 | 文件 | 核心主题 |
|------|------|---------|
| 00 | [00-overview.md](/index.md) | 版本背景、特性全景、章节导航 |
| 01 | [01-language-features.md](/concepts/01-language-features.md) | t-strings、延迟注解、无括号 except、finally 警告 |
| 02 | [02-free-threading.md](/concepts/02-free-threading.md) | 自由线程原理：QSBR、BRC、关键区段、mimalloc |
| 03 | [03-jit-interpreter.md](/concepts/03-jit-interpreter.md) | JIT 原理：Tier1/2/3、Copy-and-Patch、尾调用解释器 |
| 04 | [04-new-modules.md](/concepts/04-new-modules.md) | annotationlib、concurrent.interpreters、string.templatelib、compression |
| 05 | [05-stdlib-improvements.md](/concepts/05-stdlib-improvements.md) | REPL、asyncio、pathlib、pdb、uuid、argparse 等 |
| 06 | [06-cpython-architecture.md](/concepts/06-cpython-architecture.md) | CPython 源码架构：目录结构、三层头文件、核心运行时 |
| 07 | [07-c-api-changes.md](/references/07-c-api-changes.md) | C API 变更：PEP 741/757/768、Limited API、自由线程适配 |
| 08 | [08-build-platform.md](/concepts/08-build-platform.md) | 构建选项、Android/Emscripten、Sigstore |
| 09 | [09-migration-guide.md](/concepts/09-migration-guide.md) | 迁移 checklist、废弃 API 对照、行为变更 |
| 10 | [10-practical-examples.md](/examples/10-practical-examples.md) | 8 个实战示例 |
| 11 | [11-faq-troubleshooting.md](/references/11-faq-troubleshooting.md) | FAQ、已知问题、调试技巧 |
| 12 | [12-summary-resources.md](/references/12-summary-resources.md)（本章） | 总结、学习路径、源码速查、资源 |
| 13 | [13-official-docs-roadmap.md](/references/13-official-docs-roadmap.md) | 官方文档四支柱（tutorial/library/extending/howto）导览与 3.14 映射 |
...
- [上一章：FAQ 与排障](/references/11-faq-troubleshooting.md) ←
- 下一章：本教程结束
