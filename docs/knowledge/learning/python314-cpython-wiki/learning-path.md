...
source: "https://docs.python.org/zh-cn/3.14/, https://github.com/python/cpython (tag: v3.14.0)"
date: "2026-08-19"
category: "learning"
...
- [ ] 阅读 Wiki [00-overview.md](00-overview.md)（30 分钟）
...
- [ ] 阅读 [01-language-features.md §4](01-language-features.md#4-pep-750t-strings-模板字符串)
- [ ] 阅读 [04-new-modules.md §3](04-new-modules.md#3-stringtemplatelib--模板字符串库pep-750)
- [ ] 练习任务：
...
- [ ] 阅读 [01-language-features.md §3](01-language-features.md#3-pep-649--pep-749延迟注解求值)
- [ ] 阅读 [04-new-modules.md §1](04-new-modules.md#1-annotationlib--注解操作库pep-749)
- [ ] 练习任务：
...
- [ ] 阅读 [01-language-features.md §1-2](01-language-features.md#1-pep-758无括号-except-和-except-表达式)
- [ ] 练习任务：
...
**Day 4：内置函数与标准库改进**
- [ ] 阅读 [01-language-features.md §5-6](01-language-features.md#5-内置函数变更)
- [ ] 阅读 [05-stdlib-improvements.md](05-stdlib-improvements.md)
- [ ] 练习任务：
...
- [ ] 阅读 [04-new-modules.md §2](04-new-modules.md#2-concurrentinterpreters--多解释器模块pep-734)
- [ ] 练习任务：
  1. 创建子解释器执行简单代码
...
**Day 6-7：自由线程初体验**
- [ ] 阅读 [02-free-threading.md §1-3](02-free-threading.md#1-为什么要去掉-gil)
- [ ] 练习任务：
  1. 在 `python3.14t` 下运行 [10-practical-examples.md §3](10-practical-examples.md#示例-3自由线程多线程性能基准) 的基准测试
...
**Day 8：迁移指南**
- [ ] 阅读 [09-migration-guide.md](09-migration-guide.md)
- [ ] 练习任务：
...
**Day 9-10：JIT 实验**
- [ ] 阅读 [03-jit-interpreter.md §1-6](03-jit-interpreter.md#1-python-执行模型演进)
- [ ] 练习任务：
...
- [ ] 阅读 [10-practical-examples.md](10-practical-examples.md) 获取灵感

**Day 13-14：FAQ 与排障**
- [ ] 阅读 [11-faq-troubleshooting.md](11-faq-troubleshooting.md)
- [ ] 整理你在实践中遇到的问题和解决方案
...
- [ ] 精读 [02-free-threading.md §4-8](02-free-threading.md#4-qsbrquiescent-state-based-reclamation)
  - QSBR 原理和静默点机制
  - BRC 批量引用计数和永生对象
  - 关键区段和 Parking Lot
  - mimalloc 内存分配
...
- [ ] 精读 [03-jit-interpreter.md §3-7](03-jit-interpreter.md#3-尾调用解释器tail-call-interpreter)
  - 尾调用解释器原理
  - Tier 1 自适应特化
  - Tier 2 uop 优化器
...
- [ ] 精读 [06-cpython-architecture.md](06-cpython-architecture.md)
- [ ] 源码阅读路线（按顺序）：
...
- [ ] 精读 [07-c-api-changes.md](07-c-api-changes.md) 和 [08-build-platform.md](08-build-platform.md)
- [ ] 练习任务：
