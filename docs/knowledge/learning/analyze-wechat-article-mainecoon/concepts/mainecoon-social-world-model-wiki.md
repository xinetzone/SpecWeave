...
type: Concept
description: "MaineCoon Social World Model知识库速查，含五大应用场景价值评估表、关键技术概念解析和竞争格局分析，链接至深度分析报告。"
generated:
...
> catnip.ai 团队发布的 22B 参数实时音视频基础模型知识库。模型基本信息与事实编号表见 [00-article-overview.md](/index.md)，F+V 深度分析见 [05-critique-and-methodology.md](/concepts/05-critique-and-methodology.md) §15。本页保留独特的场景评估表与竞争格局表。

---

## 1. 模型概况

> 模型基本信息、团队信息、关键技术指标（F-001~F-026 事实编号表）已迁移至 [00-article-overview.md](/index.md) §2。
...
> 4 条公理（第一性原理提炼）与 3 个 P0 级发现（对抗审查识别）的完整分析见 [05-critique-and-methodology.md](/concepts/05-critique-and-methodology.md) §15。

- **4 条公理**：AI 交互价值=信息密度×互动频率 | 商业可行性四维条件 | Social=双向信息流 | 范式跃迁三要素 → 详见 [05 §15.1.2](/concepts/05-critique-and-methodology.md#1512-公理提炼)
- **3 个 P0**：架构证据缺失 | 画面稳定≠内容连贯 | 成本≠商业模式 → 详见 [05 §15.2.5](/concepts/05-critique-and-methodology.md#1525-审查结论)
- **决策速查卡**：[decision-summary.md](/references/decision-summary.md)
- **批判性评论**：[critical-review-draft.md](/references/critical-review-draft.md)
...
> 场景价值边界推导详见 [05 §15.1.3](/concepts/05-critique-and-methodology.md#1513-自下而上重构)。
...
- 分析报告索引页：[analysis-report.md](/references/analysis-report.md)
- 文章概述与事实编号表：[00-article-overview.md](/index.md)
- F+V 深度分析（权威源）：[05-critique-and-methodology.md](/concepts/05-critique-and-methodology.md)
- 决策速查卡：[decision-summary.md](/references/decision-summary.md)
- 批判性评论：[critical-review-draft.md](/references/critical-review-draft.md)
