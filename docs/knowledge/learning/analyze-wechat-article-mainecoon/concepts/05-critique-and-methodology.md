...
x-toml-ref: "../../../../../.meta/toml/docs/knowledge/learning/analyze-wechat-article-mainecoon/concepts/05-critique-and-methodology.toml"
version: 1.1
atomized_from: "analysis-report.md"
type: Report
description: "批判性思考、SpecWeave关联分析与七概念方法论（F+V）深度审视，含6条假设剥离、4条公理推导、4视角对抗审查及16条审查意见，附五大方法论模式萃取。"
generated:
...
sources:
  - id: analysis-report
    resource: /references/analysis-report.md#13-批判性思考
    title: "MaineCoon 深度洞察分析报告"
---
# MaineCoon 批判性思考与七概念方法论分析

> 本节为 [analysis-report.md](/references/analysis-report.md) 原子化拆分的第六部分，包含批判性思考、SpecWeave 关联分析与七概念方法论（F+V）深度审视。方法论模式已萃取为独立文档，详见 [三角困境→架构级解决框架](../../../../retrospective/patterns/methodology-patterns/governance-strategy/trilemma-architectural-resolution.md) 与 [诚实承认局限性信任构建策略](../../../../retrospective/patterns/methodology-patterns/ai-collaboration/honest-limitation-acknowledgment.md)。
...
> 本章节应用七概念方法论中的 F（第一性原理）与 V（对抗审查）两个阶段，是 F+V 分析的权威源。知识库速查版本见 [mainecoon-social-world-model-wiki.md](/concepts/mainecoon-social-world-model-wiki.md)，决策速查卡见 [decision-summary.md](/references/decision-summary.md)，批判性评论见 [critical-review-draft.md](/references/critical-review-draft.md)。
