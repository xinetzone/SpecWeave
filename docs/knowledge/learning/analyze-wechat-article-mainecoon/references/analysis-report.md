...
x-toml-ref: "../../../../../.meta/toml/docs/knowledge/learning/analyze-wechat-article-mainecoon/references/analysis-report.toml"
...
atomized: 2026-08-05
type: Report
description: "MaineCoon实时音视频模型文章深度洞察分析报告索引页，含原子化导航、六大分析维度、核心洞察凝练、文章章节大纲和待验证项清单。"
generated:
...
sources:
  - id: article-cache
    resource: "../../../../.trae/specs/retrospectives-insights/_article_ff4S2ZTY.md"
    title: "微信公众号文章原文缓存"
---
...
| 序号 | 文件 | 涵盖章节 | 主题 |
|:---:|---|---|---|
| 00 | [00-article-overview.md](/index.md) | §1-2 | 文章基本信息与核心观点（含事实编号表 F-001~F-026） |
| 01 | [01-argument-structure-analysis.md](/concepts/01-argument-structure-analysis.md) | §3-4 | 论证逻辑与信息结构评估 |
| 02 | [02-content-value-and-knowledge.md](/concepts/02-content-value-and-knowledge.md) | §5-6 | 内容价值评估与关键知识点萃取 |
| 03 | [03-technical-breakthrough-analysis.md](/concepts/03-technical-breakthrough-analysis.md) | §7-8 | 技术突破深度解析与应用场景可行性评估 |
| 04 | [04-insights-and-reliability.md](/concepts/04-insights-and-reliability.md) | §9-12 | 洞见萃取（五大洞见四元组）与可靠性/时效性/专业性评估 |
| 05 | [05-critique-and-methodology.md](/concepts/05-critique-and-methodology.md) | §13-15 | 批判性思考、SpecWeave 关联分析与七概念方法论（F+V） |

### 关联文档

- [critical-review-draft.md](/references/critical-review-draft.md)：批判性评论（叙事视角，链接至 [05](/concepts/05-critique-and-methodology.md) §15 深度分析）
- [decision-summary.md](/references/decision-summary.md)：决策摘要（表格速查，链接至 [05](/concepts/05-critique-and-methodology.md) §15 深度分析）
- [mainecoon-social-world-model-wiki.md](/concepts/mainecoon-social-world-model-wiki.md)：Social World Model 知识库（场景评估表+竞争格局表，链接至 [00](/index.md)/[05](/concepts/05-critique-and-methodology.md) 深度内容）
- [archive-content-value-assessment.md](/references/archive-content-value-assessment.md)：§5 内容价值评估归档（独立文档，2026-08-05）
...
> 本节数据已原子化迁移至：
> - [00-article-overview.md](/index.md) §2.4 事实编号表（F-001~F-026，含模型/团队/成本/速度/时长/框架全部关键数据）
> - [03-technical-breakthrough-analysis.md](/concepts/03-technical-breakthrough-analysis.md) §7.1-7.4 详细技术指标对比表（成本对比、速度对比、时长对比、同类模型横向对比）
