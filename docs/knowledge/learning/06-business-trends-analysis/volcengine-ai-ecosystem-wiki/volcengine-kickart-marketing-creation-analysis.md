...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/knowledge/learning/06-business-trends-analysis/volcengine-ai-ecosystem-wiki/volcengine-kickart-marketing-creation-analysis.toml"
date: "2026-07-04"
...
| **全域创作** | 基础高阶，多模式覆盖 | 对话一键成片、自由创作、视频混剪、丰富AI特效模板，全面支持营销视频、UGC互动等多种营销场景 |
...
> **模型版本说明**：已接入Seedance 2.0模型，支持最高60秒视频，满足更多营销场景和商业化创作需求（目前仅支持视频创作部分使用2.0模型，模板暂不支持）。
...
- 素材理解：AI深度解析商品信息或上传素材，自动提炼结构化卖点、识别商品主体、评估图片质量并给出优化建议，同时支持手动补充调整
- 故事线生成：基于商品信息和用户偏好，一次性生成4条差异化视频创意，每条包含标题、风格、时长的完整框架，自动匹配好物分享、剧情带货等多种类型，支持换一换刷新和手动编辑
...
**技术亮点**：
- 自研创作VLM模型：结合电商、营销视频输出自研创作VLM模型，整体叙事逻辑更符合营销视频风格，多模态理解商品信息与视觉素材
- Agent架构：自主调度多步创作流程，驱动故事板自主规划，精准调度大语言模型、生图模型、生视频模型、语音模型、音乐模型等各类工具，结合用户输入生成逻辑性更好、更符合营销场景的视频效果
- 故事板中间态：提供可编辑的分镜脚本，实现人机协同创作
- 多平台适配：自动适配抖店、快手、小红书等电商平台素材格式
- 链接输入一键成片：支持抖音店铺商品链接/商品ID导入，平台直接针对商品内容进行分析，提取产品卖点、受众等重要信息，一键成片无需手动上传商品素材
...
| 产品介绍 | https://www.volcengine.com/docs/6664/2119705?lang=zh |
...
**文档版本**: v1.1
**初始创建**: 2026-07-04
**最近更新**: 2026-07-07（同步官方文档2026-06-17更新内容）
**更新内容**: 
- 补充素材理解"评估图片质量并给出优化建议"、"手动补充调整"功能
- 补充故事线生成"自动匹配好物分享/剧情带货类型"、"换一换刷新"功能
- 补充链接输入一键成片"提取受众信息"功能
- 补充Agent调度音乐模型的说明
- 补充Seedance 2.0模型限制说明（模板暂不支持2.0）
- 补充AI特效模板和UGC互动场景支持
- 修正文档链接名称（"快速入门"→"产品介绍"）
**来源**: 火山引擎官方产品页 + 官方文档中心（产品介绍页2026-06-17更新）+ 产品UX深度分析综合整理
