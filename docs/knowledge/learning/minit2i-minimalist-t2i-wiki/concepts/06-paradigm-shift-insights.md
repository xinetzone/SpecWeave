...
type: "Concept"
description: "MiniT2I范式转移五维洞察：从堆料到提纯的竞争逻辑转向、研究门槛降低的AlexNet时刻类比、LLM预训练微调范式向文生图的成功迁移、系统设计减法哲学及何恺明团队返璞归真研究风格传承"
generated:
...
← [上一章](/references/05-limitations-open-problems.md) | [下一章：总结与资源](/references/07-summary-faq-resources.md) →
