...
type: "Concept"
description: "MM-JiT多模态联合Transformer架构深度解析：与MM-DiT八维度对比、两层文本适配器域对齐设计、删除AdaLN分支、噪声图像携带时间步信息的关键科学洞见及架构简化量化收益"
generated:
...
← [上一章](/concepts/02-three-subtractions.md) | [下一章：实验结果与性能](/references/04-experiments-performance.md) →
