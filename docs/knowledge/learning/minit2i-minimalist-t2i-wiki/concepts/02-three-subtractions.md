...
type: "Concept"
description: "MiniT2I三大技术减法深度解析：无VAE像素空间直出降低58.7%计算量、无AdaLN回归朴素Transformer提升26.7% FID、无私有数据全公开CC12M预训练加12万微调两阶段训练范式"
generated:
...
← [上一章](/concepts/01-design-philosophy.md) | [下一章：MM-JiT架构解析](/concepts/03-mm-jit-architecture.md) →
