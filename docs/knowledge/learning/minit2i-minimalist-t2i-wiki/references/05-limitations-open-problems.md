...
type: "Reference"
description: "MiniT2I四大局限性诚实分析：像素空间patch伪影（边界梯度高17-22%）、CFG高引导系数副作用、分辨率天花板token数平方增长、文字渲染/命名实体数据瓶颈，均定位为工程/数据问题而非架构原理缺陷"
generated:
...
← [上一章](/references/04-experiments-performance.md) | [下一章：范式转移与启示](/concepts/06-paradigm-shift-insights.md) →
