...
**文件：** [.agents/global-core-rules.md](file:///d:/spaces/SpecWeave/.agents/global-core-rules.md)
...
**文件：** [.agents/roles/developer.md](file:///d:/spaces/SpecWeave/.agents/roles/developer.md)
...
**文件：** [docs/development-standards.md](file:///d:/spaces/SpecWeave/docs/development-standards.md)
...
**文件：** [.agents/rules/ai-coding-guidelines.md](file:///d:/spaces/SpecWeave/.agents/rules/ai-coding-guidelines.md)
...
同时更新了：
- [.agents/rules/README.md](file:///d:/spaces/SpecWeave/.agents/rules/README.md) - 规则清单、场景导航、角色导航
- [.agents/context-routing.md](file:///d:/spaces/SpecWeave/.agents/context-routing.md) - 上下文路由表
...
所有 AI 智能体在启动时通过上下文路由表自动加载 [ai-coding-guidelines.md](file:///d:/spaces/SpecWeave/.agents/rules/ai-coding-guidelines.md)，无需手动配置。

### 人类开发者使用

1. **快速回顾**：看 [ai-coding-guidelines.md](file:///d:/spaces/SpecWeave/.agents/rules/ai-coding-guidelines.md) 开头的「一分钟速查表」
...
[docs/knowledge/learning/karpathy-llm-coding-guidelines/](file:///d:/spaces/SpecWeave/docs/knowledge/learning/karpathy-llm-coding-guidelines/)

包含：
- [00-overview.md](file:///d:/spaces/SpecWeave/docs/knowledge/learning/karpathy-llm-coding-guidelines/00-overview.md) - 概述与背景故事
- [01-four-principles.md](file:///d:/spaces/SpecWeave/docs/knowledge/learning/karpathy-llm-coding-guidelines/01-four-principles.md) - 四条原则详解 + CLAUDE.md原文
- [02-code-examples.md](file:///d:/spaces/SpecWeave/docs/knowledge/learning/karpathy-llm-coding-guidelines/02-code-examples.md) - 真实代码正反例
- [03-quickstart.md](file:///d:/spaces/SpecWeave/docs/knowledge/learning/karpathy-llm-coding-guidelines/03-quickstart.md) - 安装使用指南
- 本文档 - SpecWeave 整合情况
- [05-resources.md](file:///d:/spaces/SpecWeave/docs/knowledge/learning/karpathy-llm-coding-guidelines/05-resources.md) - 资源链接
