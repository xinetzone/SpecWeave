...
x-toml-ref: "../../../../../../.meta/toml/.agents/docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/README.toml"
---
...
### [templates/](./templates/README.md) - 配置模板

- **myst.yml.template** - myst.yml 配置模板（含详细注释）

### [syntax/](./syntax/README.md) - 语法速查相关资源（预留目录）

### [resources/](./resources/README.md) - 其他学习资源（预留目录）
...
- **快速启动**：使用 [templates/](./templates/README.md) 中的模板快速启动项目
