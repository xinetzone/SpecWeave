...
|------|----------|-----------|-----------|----------|
| 01 | Agent 协议与接口 | Agent 通信协议、Skills 开放标准、接口四层抽象、FFI/IDL 底层技术 | 9 | [01-agent-protocols-interfaces/](01-agent-protocols-interfaces/) |
| 02 | Agent 工程方法论 | Harness/Headroom/Karpathy/LongCat 等工程方法论与 Prompt 模式 | 7 | [02-agent-engineering-methodology/](02-agent-engineering-methodology/) |
| 03 | Agent 平台与工具 | Anthropic/TRAE/浏览器/安全/量化/翻译等各类 Agent 平台与工具 | 13 | [03-agent-platforms-tools/](03-agent-platforms-tools/) |
| 04 | 文档与标记工具 | MyST Markdown、HTML 声明式更新、Python 构建工具 | 4 | [04-docs-markup-tooling/](04-docs-markup-tooling/) |
| 05 | AI 多模态内容 | AI 短剧、3D 动画、音频生成、AI 配图、文本转 CAD | 6 | [05-ai-multimodal-content/](05-ai-multimodal-content/) |
| 06 | 商业趋势分析 | AI 变现、国产模型对比、个人 IP 趋势、营销创作 | 5 | [06-business-trends-analysis/](06-business-trends-analysis/) |
| 07 | 厂商产品学习 | 向日葵远程控制系列、涂鸦 TuyaOpen AI-IoT、火山引擎系列产品 | 14 | [07-vendor-product-learning/](07-vendor-product-learning/) |
| 08 | 系统与基础设施 | WSL 命令树架构与系统学习计划 | 2 | [08-systems-infrastructure/](08-systems-infrastructure/) |
...
| Interface/API/ABI/Protocol 四层抽象 | 软件接口四层概念辨析（通用版，7 章） | [interface-api-abi-protocol-wiki/](01-agent-protocols-interfaces/interface-api-abi-protocol-wiki/) |
| Agent 视角 Interface 四层抽象 | Agent 语境下的 Interface/API/ABI/Protocol 深度解析（6 章） | [agent-interface-deep-dive/](01-agent-protocols-interfaces/agent-interface-deep-dive/) |
| FFI 外部函数接口 Wiki | FFI 原理、多语言实现、使用场景（7 章） | [ffi-wiki/](01-agent-protocols-interfaces/ffi-wiki/) |
| IDL 接口定义语言 Wiki | IDL 语法、主流规范、工具链、对比分析（9 章） | [idl-wiki/](01-agent-protocols-interfaces/idl-wiki/) |
| TVM FFI Wiki | TVM 深度学习编译器 FFI 系统深度解析（16 章） | [tvm-ffi-wiki/](01-agent-protocols-interfaces/tvm-ffi-wiki/) |
...
| MyST Markdown 完整教程 | 17 章 MyST Markdown 从入门到精通 | [myst-markdown-tutorial/](04-docs-markup-tooling/myst-markdown-tutorial/) |
| scikit-build-core Python 构建 | CMake 驱动的现代 Python 构建工具（6 章） | [scikit-build-core-wiki/](04-docs-markup-tooling/scikit-build-core-wiki/) |
...
| Wiki | 说明 | 链接 |
|------|------|------|
| AI 变现完整指南 | 从技术到商业全流程方法论（13 章原子化） | [ai-monetization-wiki/](06-business-trends-analysis/ai-monetization-wiki/) |
...
1. **四大工程概念演进** → [four-engineering-concepts-wiki.md](02-agent-engineering-methodology/four-engineering-concepts-wiki.md)——建立 AI 工程全局认知
2. **Karpathy LLM 编程准则** → [karpathy-llm-coding-guidelines-tutorial.md](02-agent-engineering-methodology/karpathy-llm-coding-guidelines-tutorial.md)——养成正确的 AI 协作编程习惯
3. **Agent 通信协议（MCP/ACP/A2A/ANP）** → [agent-communication-protocols-wiki.md](01-agent-protocols-interfaces/agent-communication-protocols-wiki.md)——理解 Agent 互联互通的基础
4. **Vibe Coding 两大 Prompt** → [vibe-coding-prompts-learning-analysis.md](02-agent-engineering-methodology/vibe-coding-prompts-learning-analysis.md)——掌握生成+验证双 Prompt 闭环
...
1. **Interface/API/ABI/Protocol 四层抽象** → [interface-api-abi-protocol-wiki/](01-agent-protocols-interfaces/interface-api-abi-protocol-wiki/)——建立接口分层的底层认知
2. **FFI 外部函数接口** → [ffi-wiki/](01-agent-protocols-interfaces/ffi-wiki/)——理解跨语言互操作
3. **IDL 接口定义语言** → [idl-wiki/](01-agent-protocols-interfaces/idl-wiki/)——掌握接口描述规范
4. **TVM FFI** → [tvm-ffi-wiki/](01-agent-protocols-interfaces/tvm-ffi-wiki/)——深度学习编译器 FFI 实战
