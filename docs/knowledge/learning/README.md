...
| - | 跨领域思维方法论 | 第一性原理思维方法（哲学/物理/商业跨领域） | 1 | [first-principles/](first-principles/) |
...
| Wiki | 说明 | 链接 |
|------|------|------|
| 第一性原理知识档案 | 哲学起源+物理应用+商业案例跨领域系统化档案，含对抗性审查质量控制、术语表、时间线、方法论框架 | [first-principles/](first-principles/) |
...
1. **第一性原理思维方法** → [first-principles/](first-principles/)——建立反类比、回归本质的思维基础（所有技术学习的元方法论）
