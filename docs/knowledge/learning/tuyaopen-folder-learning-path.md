...
x-toml-ref: "../../../.meta/toml/docs/knowledge/learning/tuyaopen-folder-learning-path.toml"
category: "learning"
...
- 子命令集合：`flash/monitor` 等在 `tos.py` 的注册表中可见，[tos.py](../../../external/TuyaOpen/tos.py#L33-L47)
