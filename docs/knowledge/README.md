...
| [LibTV AI 短剧创作工具学习 Wiki](learning/libtv-ai-shortdrama-wiki.md) | 系统学习阿枫公众号文章《LibTV 相关功能介绍》的 wiki 教程。LibTV（liblib.tv）针对 AI 漫剧人物缺少真人质感、有"AI 味"的痛点，推出人像调节、情绪调节、虚拟角色、新版脚本、3D 导演台五大功能，以按钮替代专业提示词降低创作门槛。文档涵盖核心问题分析、五大功能递进式讲解、六步短剧工作流、功能汇总表、内容评估与 FAQ。成功案例《荒年开局：我靠空间当大佬》全网 7 亿播放量。 | 2026-07-04 | libtv、ai-shortdrama、ai-video、ai-manhua、character-quality、emotion-control、3d-director、workflow |
