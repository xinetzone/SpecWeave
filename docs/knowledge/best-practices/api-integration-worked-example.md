...
> [demo_async_polling_podcast.py](../../../.agents/scripts/tests/demo_async_polling_podcast.py)。
...
| v1.1 | 2026-08-07 | 补充可运行测试脚本引用：脚本移植为 [demo_async_polling_podcast.py](../../../.agents/scripts/tests/demo_async_polling_podcast.py)，内置 mock server 覆盖五类场景 |
