...
|------|------|------|-----------|---------|-----------|
| [build_native_ext.ps1](../../../.agents/scripts/build_native_ext.ps1) | 260 | C++扩展构建 | ✅ 无 | - | ✅ 已模块化（使用NativeBuild） |
| [build_caffe_ffi.ps1](../../../.agents/scripts/build_caffe_ffi.ps1) | ~15 | 薄包装 | ✅ 无 | - | ✅ 薄包装 |
...
| 文件 | 行数 | 函数数 | 说明 |
|------|------|--------|------|
| [PathPattern.psm1](../../../.agents/scripts/lib/PathPattern.psm1) | ~80 | 1 | L0基础层：分段通配符目录解析 |
| [VsDevShell.psm1](../../../.agents/scripts/lib/VsDevShell.psm1) | ~250 | 4 | L1工具层：VS发现+DevShell加载 |
| [NativeBuild.psm1](../../../.agents/scripts/lib/NativeBuild.psm1) | ~350 | 7 | L2业务层：Conda+项目发现 |

### 应用层脚本（`.agents/scripts/`）

| 文件 | 行数 | 说明 |
|------|------|------|
| [build_native_ext.ps1](../../../.agents/scripts/build_native_ext.ps1) | ~260 | 通用C++扩展构建器（6阶段流程） |
| [build_caffe_ffi.ps1](../../../.agents/scripts/build_caffe_ffi.ps1) | ~15 | caffe-ffi薄包装 |
| [build_npu_ffi.ps1](../../../.agents/scripts/build_npu_ffi.ps1) | ~15 | npu_ffi薄包装 |
| [build_demo_ffi.ps1](../../../.agents/scripts/build_demo_ffi.ps1) | ~15 | demo_ffi薄包装 |
| [build_xuan_ext_demo.ps1](../../../.agents/scripts/build_xuan_ext_demo.ps1) | ~15 | xuan_ext_demo薄包装 |
