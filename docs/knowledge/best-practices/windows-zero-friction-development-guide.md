...
- [ ] **WC-002**：Git提交中文commit message时，使用 [git-commit-utf8.py](../../../.agents/scripts/git-commit-utf8.py) 工具，避免PowerShell 5默认GBK编码导致乱码
...
**工具引用**：
- [git-commit-utf8.py](../../../.agents/scripts/git-commit-utf8.py)：Windows中文提交安全工具
- [check-filename-convention.py](../../../.agents/scripts/check-filename-convention.py)：文件名规范检查
