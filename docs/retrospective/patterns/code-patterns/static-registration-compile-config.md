...
- **正确做法**：遵循[构建配置变更检查清单（三层覆盖）](../../../../.agents/checklists/build-config-change-checklist.md)的 L1+L2+L3 三层同步
...
- **[build-config-change-checklist.md](../../../../.agents/checklists/build-config-change-checklist.md)**：本模式中"步骤2-4 修改配置"的具体执行清单，覆盖 L1 模板 + L2 动态替换 + L3 独立脚本三层
