---
type: Pattern
id: "cpp-iife-assertion-macro"
title: "C++ IIFE+AssertHelper 流式断言宏封装最佳实践"
x-toml-ref: "../../../../.meta/toml/docs/retrospective/patterns/code-patterns/cpp-iife-assertion-macro.toml"
---
...
本模式的生产级通用实现位于：
- [assert_helper.hpp](../../../../.agents/scripts/include/assert_helper.hpp) — SpecWeave 通用版（可直接 copy 到其他项目）
