...
为避免每次手动实现隔离检查，项目已提供通用 Shell 库 [safe_cleanup.sh](../../../../.agents/scripts/shell/safe_cleanup.sh)，封装了所有安全检查：
...
完整测试：[test_safe_cleanup.sh](../../../../.agents/scripts/shell/test_safe_cleanup.sh)（15 项测试覆盖所有场景）
