...
x-toml-ref: "../../../../.meta/toml/docs/retrospective/patterns/code-patterns/relative-path-systematic-construction.toml"
related:
...
- 深层嵌套目录（docs/retrospective/patterns/...）中路径错误率极高
...
```
源文件（包含引用的文件）：
  D:\AI\docs\retrospective\patterns\architecture-patterns\example.md

目标文件（被引用的文件）：
  D:\AI\.meta\toml\docs\retrospective\patterns\architecture-patterns\example.toml
```
...
```
源: D:\AI\docs\retrospective\patterns\architecture-patterns\example.md
目标: D:\AI\.meta\toml\docs\retrospective\patterns\architecture-patterns\example.toml
共同祖先: D:\AI\                                          ↑ 到这里不一样了
```
...
从共祖向下写目标文件的路径：
```
.meta\toml\docs\retrospective\patterns\architecture-patterns\example.toml
```

组合：
```
../../../../.meta/toml/docs/retrospective/patterns/architecture-patterns/example.toml
```
...
```
示例：
源: docs/retrospective/patterns/architecture-patterns/example.md
    从文件名到根的斜杠数: docs/(1)retrospective/(2)patterns/(3)architecture-patterns/(4)
    → 4个../ → ../../../../
目标从根: .meta/toml/docs/retrospective/patterns/architecture-patterns/example.toml
组合: ../../../../.meta/toml/docs/retrospective/patterns/architecture-patterns/example.toml
```
...
| 场景 | 适用性 | 说明 |
|------|-------|------|
| **Markdown文档交叉引用** | ✅✅ 必用 | docs/下深度嵌套，路径错误高发 |
...
| 案例ID | 场景 | 验证内容 |
|--------|------|---------|
| C1 | x-toml-ref路径计算（本洞察来源） | docs/.../pattern.md → .meta/toml/.../pattern.toml，4层相对路径，多次写错后总结此方法 |
| C2 | Pattern文件related字段交叉引用 | 不同类别pattern之间的相对引用（architecture-patterns ↔ methodology-patterns ↔ code-patterns） |
| C3 | 复盘报告链接到模式文件 | docs/retrospective/reports/ → docs/retrospective/patterns/ 的同区跨目录引用 |
