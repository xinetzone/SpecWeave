...
type: Pattern
id: "setup-windows"
title: "Windows 本地开发环境配置指南"
x-toml-ref: "../../../../../../.meta/toml/docs/retrospective/patterns/code-patterns/examples/three-layer-logging/SETUP_WINDOWS.toml"
---
...
```powershell
# 1. 进入示例目录
cd docs\retrospective\patterns\code-patterns\examples\three-layer-logging
