...
tags:
  ...
  - cache-friendly
  - deep-learning
x-toml-ref: "../../../../.meta/toml/docs/retrospective/patterns/code-patterns/single-pass-perf-instrumentation.toml"
---
...
审查性能日志埋点代码时，使用 [框架扩展与性能日志CR清单](../../../../.agents/checklists/framework-extension-and-perf-logging-review.md#三性能统计日志埋点检查) 逐项对照；多阶段算子（Conv/FC/GEMM）参见§3.4多阶段检查项。
