...
## 参考实现
- PowerShell实现：
  - 通用核心：[build_native_ext.ps1](../../../../.agents/scripts/build_native_ext.ps1)（~230行，6阶段构建流程）
  - 薄包装示例：[build_caffe_ffi.ps1](../../../../.agents/scripts/build_caffe_ffi.ps1)（~15行）、build_npu_ffi.ps1、build_demo_ffi.ps1、build_xuan_ext_demo.ps1
  - 共享模块：[NativeBuild.psm1](../../../../.agents/scripts/lib/NativeBuild.psm1)
