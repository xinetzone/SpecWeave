...
tags:
  ...
  - refactoring
x-toml-ref: "../../../../.meta/toml/docs/retrospective/patterns/code-patterns/progressive-interface-extension.toml"
---
...
快速审查接口扩展代码时，使用 [框架扩展与性能日志CR清单](../../../../.agents/checklists/framework-extension-and-perf-logging-review.md#二框架接口渐进式扩展检查) 逐项对照。
