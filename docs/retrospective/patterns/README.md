...
| 目录 | 模式数 | L1 | L2 | L3 | L4 |
|------|--------|----|----|----|----|
| architecture-patterns/ | 15 | 5 | 7 | 0 | 0 |
| code-patterns/ | 25 | 1 | 5 | 0 | 2 |
| methodology-patterns/ | 136 | 51 | 40 | 7 | 0 |
| **合计** | **176** | **57** | **52** | **7** | **2** |

> > > 注：统计数据截至 2026-07-01，由 pattern-maturity.py check-index --fix 自动更新。
