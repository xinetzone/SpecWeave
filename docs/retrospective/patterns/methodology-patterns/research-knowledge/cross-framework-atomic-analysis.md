...
description: "跨多框架对比提炼原子化设计指南并回写到Agent文件的四阶段链路，将隐含设计哲学转化为显性知识。"
generated:
...
- [Agency Agents 深度学习原子化设计指南](../../../../../../docs/knowledge/engineering/deep-learning-atomic-design/deep-learning-atomic-design-guide.md)
- [AI Agent 原子化设计分析报告](../../../../../../docs/knowledge/engineering/deep-learning-atomic-design/ai-agent-atomic-design-analysis.md)
- [深度学习框架原子化组件研究报告](../../../../../../docs/knowledge/engineering/deep-learning-atomic-design/deep-learning-atomic-components.md)
