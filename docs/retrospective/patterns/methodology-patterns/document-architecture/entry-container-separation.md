...
> 详见 [提示词萃取系统入口](apps/dev-tools/prompt_extraction/)，系统架构等技术细节参见 [.agents/systems/prompt-extraction.md](.agents/systems/prompt-extraction.md)
```
...
- [meta-document-priority-principle.md](../../../../../.agents/rules/meta-document-priority-principle.md)：元文档优先原则的操作化规则
