...
| 章节 | 文件 | 内容 |
|------|------|------|
| L0 | [00-overview.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/comm/interface-api-abi/concepts/00-overview.md) | 四层抽象Mermaid图、核心区别速览表、阅读路径指南 |
| L1 | [01-interface.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/comm/interface-api-abi/concepts/01-interface.md) | Interface定义、6个核心特征、OOP/函数式场景、2个TypeScript案例 |
| L2 | [02-api.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/comm/interface-api-abi/concepts/02-api.md) ~ [04-protocol.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/comm/interface-api-abi/concepts/04-protocol.md) | API（5种类型对比+3个主流案例）、ABI（5个技术特征+ctypes案例）、Protocol（三要素+5种协议对比） |
| L3核心 | [05-comparison.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/comm/interface-api-abi/concepts/05-comparison.md) | 9维度对比表、5组关联关系、Mermaid架构层次图、5个FAQ、决策指南 |
| L4 | [06-resources.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/comm/interface-api-abi/concepts/06-resources.md) | 17术语表、三分类参考资料、4个进阶方向 |
