...
title: "Skill迁移位置治理：统一Skill存放位置的五步标准化流程"
x-toml-ref: "../../../../../.meta/toml/docs/retrospective/patterns/methodology-patterns/governance-strategy/skill-migration-position-governance.toml"
---
