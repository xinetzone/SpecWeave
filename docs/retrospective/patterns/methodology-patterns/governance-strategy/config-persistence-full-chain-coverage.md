...
- [ ] 标准7：参考 [构建配置变更检查清单](../../../../../.agents/checklists/build-config-change-checklist.md) 的三层覆盖检查通过
...
- **[构建配置变更检查清单](../../../../../.agents/checklists/build-config-change-checklist.md)**：本模式的方法论基础，检查清单是本模式的 L4 模板化产物
