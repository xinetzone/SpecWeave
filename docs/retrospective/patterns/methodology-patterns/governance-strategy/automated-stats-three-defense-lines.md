...
x-toml-ref: "../../../../../.meta/toml/docs/retrospective/patterns/methodology-patterns/governance-strategy/automated-stats-three-defense-lines.toml"
maturity: "L1"
validation_count: 1
reuse_count: 0
related_patterns:
...
| 模板 | [weekly-retrospective-template.md](../../../../../.agents/templates/weekly-retrospective-template.md) |
...
| 组件 | 文件 | 防线 |
|------|------|------|
| 路径校验+异常类 | [docgen.py](../../../../../.agents/scripts/docgen.py) `StatsSourceError`, `_validate_stats_sources()` | 防线1 |
| 环比检测+strict模式 | [docgen.py](../../../../../.agents/scripts/docgen.py) `_validate_with_snapshot()`, `cmd_stats(strict_anomaly=True)` | 防线2 |
| 周快照生成 | [docgen.py](../../../../../.agents/scripts/docgen.py) `cmd_weekly()`, `_weekly_count_test_commits()` | 防线2数据源 |
...
| 周复盘模板 | [weekly-retrospective-template.md](../../../../../.agents/templates/weekly-retrospective-template.md) | 防线3 |
| 测试（TDD） | [test_docgen.py](../../../../../.agents/scripts/tests/test_docgen.py), [test_docgen_strict_anomaly.py](../../../../../.agents/scripts/tests/test_docgen_strict_anomaly.py), [test_docgen_weekly.py](../../../../../.agents/scripts/tests/test_docgen_weekly.py) | 验证 |
