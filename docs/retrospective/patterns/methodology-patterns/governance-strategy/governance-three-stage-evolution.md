...
- [fix-prevent-close-loop.md](../../../../../.agents/rules/fix-prevent-close-loop.md)：本模式在Bug修复领域的具体SOP（已作为全局规则执行）
- [three-stage-universal-principle.md](../../../../../.agents/rules/three-stage-universal-principle.md)：三阶段是普遍规律，治理三阶段是其中一个领域
