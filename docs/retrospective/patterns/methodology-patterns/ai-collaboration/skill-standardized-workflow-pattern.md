...
source: "d:\\AI\\.chaos\\libs\\awesun-usecase-skill-example\\skills\\feishu-install-pc\\SKILL.md + docs/knowledge/learning/07-vendor-product-learning/sunlogin/sunlogin-ai-developer-ecosystem-wiki.md#第九章典型应用场景案例集"
