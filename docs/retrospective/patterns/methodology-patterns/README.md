...
| document-architecture | 文档架构与原子化 | 27 | 文档重构、原子化拆分、文档治理、结构设计、教程认知阶梯、内容加工漏斗、双向导航 | [查看](CATEGORIES.md#document-architecture--文档架构与原子化) |
| tools-automation | 工具工程与自动化 | 25 | 工具决策、自动化、工具链、安全修改、共享库引力、度量画像、网页提取工具选择 | [查看](CATEGORIES.md#tools-automation--工具工程与自动化) |
| governance-strategy | 治理与优先级策略 | 25 | 治理模型、优先级决策、问题解决、流程规范、提交质量门 | [查看](CATEGORIES.md#governance-strategy--治理与优先级策略) |
| ai-collaboration | AI协作与提示词设计 | 20 | AI Skill设计、提示词工程、人机协作、团队共享AI同事、主动介入Agent | [查看](CATEGORIES.md#ai-collaboration--ai协作与提示词设计) |
