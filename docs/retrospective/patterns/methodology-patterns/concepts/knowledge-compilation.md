...
description: "对高频深度使用的结构化知识源一次性深度编译为Agent可推理Skill，运行时高效调用，相比RAG获得数量级token效率提升。"
generated:
...
- 三个热门AI工具七概念知识沉淀报告（源文件已随 learning 板块迁移/移除，新归宿见 projects/awesome-okf-xs/doc/bundles/）
