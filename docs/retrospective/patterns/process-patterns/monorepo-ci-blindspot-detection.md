...
tags:
  ...
  - build-systems
  - quality-gate
x-toml-ref: "../../../../.meta/toml/docs/retrospective/patterns/process-patterns/monorepo-ci-blindspot-detection.toml"
---
...
审查CI配置变更时，使用 [框架扩展与性能日志CR清单](../../../../.agents/checklists/framework-extension-and-perf-logging-review.md#四monorepo-ci覆盖检查) 逐项对照。
