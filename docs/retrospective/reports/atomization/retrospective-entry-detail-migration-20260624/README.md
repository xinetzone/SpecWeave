...
source = "docs/retrospective/reports/atomization/retrospective-entry-detail-migration-20260624.md"
+++
...
| 章节 | 权威来源 | 说明 |
|------|---------|------|
| 项目概述 | [project-overview.md](project-overview.md) | 提交全景、变更量、交付物清单 |
