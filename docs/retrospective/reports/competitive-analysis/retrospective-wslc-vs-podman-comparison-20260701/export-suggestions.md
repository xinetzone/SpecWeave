...
> wslc 一手源（`external/WSL`）为临时检出，正式查阅请参考已归档的 [wsl-learning-plan.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/systems/wsl/concepts/wsl-learning-plan.md)（含三语言 API 投影、错误码表、架构细节整合）或在线官方文档 [wsl.dev](https://wsl.dev/)。
