...
- [.agents/commands/seven-concepts.md](../../../../.agents/commands/seven-concepts.md) — 七概念方法论规范
...
- **文件**：[harness-architecture-layered-model.md](../../../../docs/retrospective/patterns/methodology-patterns/governance-strategy/harness-architecture-layered-model.md)
- **成熟度**：L1
- **核心内容**：
...
- **文件**：[subagent-responsibility-layering.md](../../../../docs/retrospective/patterns/methodology-patterns/governance-strategy/subagent-responsibility-layering.md)
- **成熟度**：L1
- **核心内容**：
