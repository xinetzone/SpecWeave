...
- [retrospective-agnes-free-api-learning-20260704](../retrospective-agnes-free-api-learning-20260704/README.md) — 同类 Spec Mode + Sub-Agent 委派 + Web内容提取任务复盘，本任务复用其复盘结构格式
...
- 源任务 spec 目录：`analyze-volcengine-searchinfinity` — 本次任务的 Spec 三件套
