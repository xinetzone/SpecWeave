...
source = "SpecWeave 项目全部资产 + TRAE 大赛官网 + 报名指南 + 抖音流量扶持表单 + 赛事细则 + 保姆级教程 + 初赛参赛指南 + 创意文档学习资料 + 晋级公示 + FAQ 分析"
+++
...
| [创意文档学习资料](https://bytedance.larkoffice.com/wiki/INVIwWx7KiKGgMk4mxacDReFnwb) | 实操指南 | 报名6步流程、3套Prompt模板、5项AI质检清单、HTML生成上传细节 | 高 | 标准化Prompt模板→同质化风险、HTML自动生成机制 |
| [晋级&获奖公示](https://bytedance.larkoffice.com/wiki/WN1CwOygLiyM7BkW8X3cMgh7nob) | 公示入口 | 报名审核通过名单（按工作日滚动更新）、初赛结果公示时间、昵称一致性要求 | 最高（官方公示） | **竞争规模确认**（已通过超12,000人）、7月21日初赛结果、全程不更换昵称 |
