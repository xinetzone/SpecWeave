...
title: "洞察萃取"
source: "docs/knowledge/learning/07-vendor-product-learning/sunlogin/sunlogin-offline-hardware-wiki/"
...
- **改进沉淀**：已创建[mdi-document-template.md](../../../../../.agents/templates/mdi-document-template.md)（6字段预填模板），并将frontmatter完整性校验加入wiki-pre-creation-three-checks，新建文件零字段遗漏
...
### 4.2 MDI v1.0合规最佳实践
本次任务获得的元数据合规经验：
1. **模板前置**：创建文件第一步就粘贴完整的YAML frontmatter模板（6个字段），填完元数据再写内容——已固化为[mdi-document-template.md](../../../../../.agents/templates/mdi-document-template.md)
...
2. **反模式：元数据最后补全**
   ...
   - 预防：[mdi-document-template.md](../../../../../.agents/templates/mdi-document-template.md)预填模板+wiki-pre-creation-three-checks校验
