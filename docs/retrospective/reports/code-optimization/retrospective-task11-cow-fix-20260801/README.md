...
| 产出物 | 位置 | 说明 |
|--------|------|------|
| Python Blob _tensor_to_numpy修复 | [_core.py](../../../../../projects/xuanspace/libs/caffe-ffi/python/caffe_ffi/_core.py) | 引用循环修复，_blob_ref迁移到arr.base.obj |
| C++ Blob共享状态标志 | [blob.hpp](../../../../../projects/xuanspace/libs/caffe-ffi/include/caffe_ffi/blob.hpp) / [blob.cpp](../../../../../projects/xuanspace/libs/caffe-ffi/src/caffe_ffi/blob.cpp) | data_shared_/diff_shared_标志、COW逻辑修正、Reshape语义修正、空tensor refcount=0 |
| tasks.md更新 | [tasks.md](../../../../../.trae/specs/caffe-framework/caffe-ffi-p2b-split-perf-csv/tasks.md#L279-L291) | Task 11标记完成，记录7项修复内容 |
| CHANGELOG更新 | [CHANGELOG.md](../../../../../.agents/scripts/CHANGELOG.md) | Unreleased段记录COW机制与内存泄漏修复 |
