...
| 文件路径 | 行数 | 说明 |
|----------|------|------|
| [lib/NativeBuild.psm1](../../../../../.agents/scripts/lib/NativeBuild.psm1) | ~440 | 核心模块：Conda发现、项目自动发现（VsDevShell/PathPattern re-export） |
| [lib/VsDevShell.psm1](../../../../../.agents/scripts/lib/VsDevShell.psm1) | ~260 | 通用模块：VS多策略发现+DevShell加载+PATH自动恢复 |
| [lib/PathPattern.psm1](../../../../../.agents/scripts/lib/PathPattern.psm1) | ~107 | 通用模块：分段通配符路径解析 |
| [build_native_ext.ps1](../../../../../.agents/scripts/build_native_ext.ps1) | ~230 | 通用参数化构建脚本，6阶段进度输出 |
| [build_caffe_ffi.ps1](../../../../../.agents/scripts/build_caffe_ffi.ps1) | ~15 | caffe-ffi 薄包装脚本 |
| [build_npu_ffi.ps1](../../../../../.agents/scripts/build_npu_ffi.ps1) | ~15 | npu-ffi 薄包装脚本 |
| [build_demo_ffi.ps1](../../../../../.agents/scripts/build_demo_ffi.ps1) | ~15 | demo-ffi 薄包装脚本 |
| [build_xuan_ext_demo.ps1](../../../../../.agents/scripts/build_xuan_ext_demo.ps1) | ~15 | xuan-ext-demo 薄包装脚本 |
| [build_caffe_ffi.bat](../../../../../.agents/scripts/build_caffe_ffi.bat) | ~5 | CMD双击启动器（自动调用pwsh） |
| [verify_caffe_ffi.ps1](../../../../../.agents/scripts/verify_caffe_ffi.ps1) | ~10 | caffe-ffi 导入验证 |
| [verify_native_ext.ps1](../../../../../.agents/scripts/verify_native_ext.ps1) | ~50 | 通用扩展导入验证 |
| [tests/test_build_scripts.Tests.ps1](../../../../../.agents/scripts/tests/test_build_scripts.Tests.ps1) | ~400 | Pester单元测试，117个测试用例 |
| [tests/test_vsdevshell.Tests.ps1](../../../../../.agents/scripts/tests/test_vsdevshell.Tests.ps1) | ~300 | VsDevShell模块单元测试，33个测试用例 |
| [tests/test_pathpattern.Tests.ps1](../../../../../.agents/scripts/tests/test_pathpattern.Tests.ps1) | ~400 | PathPattern模块单元测试，46个测试用例 |
