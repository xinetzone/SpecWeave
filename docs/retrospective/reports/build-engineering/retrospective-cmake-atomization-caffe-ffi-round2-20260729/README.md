...
| 脚本 | 路径 | 测试用例 |
|------|------|---------|
| CMake命名规范检查 | [cmake_naming.py](../../../../../.agents/scripts/lib/checks/cmake_naming.py) | 32个pytest用例 |
| 回归测试 | [test_checks_cmake_naming.py](../../../../../.agents/scripts/tests/test_checks_cmake_naming.py) | 覆盖FindBLAS冲突/Detect替代/大小写/目录名等场景 |
