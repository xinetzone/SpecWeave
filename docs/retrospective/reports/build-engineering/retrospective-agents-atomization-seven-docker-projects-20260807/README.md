...
运行 [check-rules-id-uniqueness.ps1](../../../../../.agents/scripts/check-rules-id-uniqueness.ps1) 结果：
...
| 属性 | 值 |
|------|-----|
| 脚本路径 | [check-rules-id-uniqueness.ps1](../../../../../.agents/scripts/check-rules-id-uniqueness.ps1) |
...
### 工具产出
- 🆕 [check-rules-id-uniqueness.ps1](../../../../../.agents/scripts/check-rules-id-uniqueness.ps1) — Rules ID唯一性批量检查脚本
