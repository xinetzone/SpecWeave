...
| 文件 | 类型 | 行数 | 说明 |
|------|------|------|------|
| [check-cmd-log-compliance.py](../../../../../.agents/scripts/check-cmd-log-compliance.py) | 新增 | 281行 | CMD-LOG合规检查器核心脚本 |
| [fix-cmd-log-compliance.py](../../../../../.agents/scripts/fix-cmd-log-compliance.py) | 新增 | 220行 | 批量自动修复脚本（dry-run/apply/verify三模式） |
| [ci-check.ps1](../../../../../.agents/scripts/ci-check.ps1) | 修改 | +12行 | Windows CI添加步骤19 |
| [ci-check.sh](../../../../../.agents/scripts/ci-check.sh) | 修改 | +11行 | Linux/Mac CI添加步骤19 |
...
| ID | 文件 | 修复前 | 修复后 |
|----|------|--------|--------|
| **A1** | [retrospective-cmd/SKILL.md](../../../../../.agents/skills/retrospective-cmd/SKILL.md#L114-L118) | §7仅说"必须按CMD-LOG规范输出结构化日志"，未提铁律一关键词 | 插入blockquote：⚠️ **铁律一（🔴强制）**：S0 CMD_START必须是第一条输出... |
| **A2** | [insight-cmd/SKILL.md](../../../../../.agents/skills/insight-cmd/SKILL.md) | 同上 | 同上 |
| **A3** | [export-report-cmd/SKILL.md](../../../../../.agents/skills/export-report-cmd/SKILL.md) | 同上 | 同上 |
| **A4** | [atomization-cmd/SKILL.md](../../../../../.agents/skills/atomization-cmd/SKILL.md) | 同上 | 同上 |
| **A5** | [atomic-commit-cmd/SKILL.md](../../../../../.agents/skills/atomic-commit-cmd/SKILL.md) | §4后已有CMD_START要求，但未出现"铁律一"关键词 | 补充"铁律一（🔴强制）"标注 |
| **A6** | [mermaid-cmd/SKILL.md](../../../../../.agents/skills/mermaid-cmd/SKILL.md) | §8仅说"遵循项目CMD-LOG规范"，未提铁律一关键词 | 插入铁律一blockquote |
| **A7** | [pattern-extraction-cmd/SKILL.md](../../../../../.agents/skills/pattern-extraction-cmd/SKILL.md) + [04-cmd-log-quality.md](../../../../../.agents/skills/pattern-extraction-cmd/SKILL/04-cmd-log-quality.md) | 主入口无CMD-LOG说明，L2子文档缺少铁律关键词 | 主入口新增铁律引用行，L2插入blockquote |
...
**方案**：[fix-cmd-log-compliance.py](../../../../../.agents/scripts/fix-cmd-log-compliance.py)默认dry-run（只预览不写入），必须显式`--apply`才实际修改文件，`--verify`修复后自动运行检查器验证。
