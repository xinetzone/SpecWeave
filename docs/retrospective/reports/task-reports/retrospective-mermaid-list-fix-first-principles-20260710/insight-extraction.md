...
这是[format-evidence-over-memory-pattern.md](../../../patterns/methodology-patterns/governance-strategy/format-evidence-over-memory-pattern.md)（格式证据优先于记忆）和[前置文档读取协议](../../../../../.agents/protocols/pre-document-reading.md)背后的底层认知科学原理，已独立归档为[index-over-memorization.md](../../../patterns/methodology-patterns/governance-strategy/index-over-memorization.md)（索引优于记忆原则）。
