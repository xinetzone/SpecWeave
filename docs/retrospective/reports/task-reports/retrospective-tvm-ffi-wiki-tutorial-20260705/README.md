...
> **产出物位置**：[tvm-ffi-wiki/](../../../../knowledge/learning/01-agent-protocols-interfaces/tvm-ffi-wiki/)
...
- **Spec目录**：[.trae/specs/standards-tools/create-tvm-ffi-wiki-tutorial/](../../../../../.trae/specs/standards-tools/create-tvm-ffi-wiki-tutorial/)
- **教程目录**：[docs/knowledge/learning/01-agent-protocols-interfaces/tvm-ffi-wiki/](../../../../knowledge/learning/01-agent-protocols-interfaces/tvm-ffi-wiki/)
- **相关教程**：[interface-api-abi-protocol-wiki/](../../../../knowledge/learning/01-agent-protocols-interfaces/interface-api-abi-protocol-wiki/)、[idl-wiki/](../../../../knowledge/learning/01-agent-protocols-interfaces/idl-wiki/)
