...
| [example-demo-dimension.md](../../../../../.agents/templates/analysis-dimension-templates/example-demo-dimension.md) | 示例/Demo类分析维度模板 |
| [skills-plugin-dimension.md](../../../../../.agents/templates/analysis-dimension-templates/skills-plugin-dimension.md) | Skills/插件类分析维度模板 |
...
| 文件 | 说明 |
|------|------|
| [retrospective-analysis-dimension-template-library/](../../../../../.trae/specs/retrospective-analysis-dimension-template-library/) | 复盘分析Spec（3个文件） |
| [preflight-exploration-practice/](../../../../../.trae/specs/retrospectives-insights/preflight-exploration-practice/) | Pre-flight预探索实践Spec |
