...
| 类型 | 文件 | 行数 | 说明 |
|------|------|------|------|
| 新建 | [risk_interceptor.py](../../../../../.agents/scripts/lib/risk_interceptor.py) | ~450 | 高风险操作拦截共享库 |
| 新建 | [check-risky-commands.py](../../../../../.agents/scripts/check-risky-commands.py) | ~213 | CLI检查工具，支持-v/-vv/-vvv日志 |
| 修改 | [constants.py](../../../../../.agents/scripts/lib/check_pattern_quality/constants.py) | +27 | 创新模式V2检查正则常量 |
| 修改 | [check_content.py](../../../../../.agents/scripts/lib/check_pattern_quality/check_content.py) | +99 | check_innovation_pattern_v2检查函数 |
| 修改 | [checker.py](../../../../../.agents/scripts/lib/check_pattern_quality/checker.py) | +2 | 注册V2检查到流水线 |
| 修改 | [pre_commit.py](../../../../../.agents/scripts/hooks/pre_commit.py) | +96 | 集成模式V2质量检查到pre-commit |
