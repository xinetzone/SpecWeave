...
| Mermaid修复指南 | 1089行 | 34.9KB | [mermaid-manual-fix-guide.md](../../../../tech/references/mermaid-manual-fix-guide.md) |
...
- **复用载体**：[mermaid-full-scan.py](../../../../../.agents/scripts/mermaid-full-scan.py) + [mermaid-manual-fix-guide.md](../../../../tech/references/mermaid-manual-fix-guide.md)
