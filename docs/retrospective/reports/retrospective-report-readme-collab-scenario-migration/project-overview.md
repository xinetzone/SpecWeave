+++
id = "retrospective-report-readme-collab-scenario-migration-overview"
date = "2026-06-23"
type = "project-overview"
source = "docs/retrospective/reports/retrospective-report-readme-collab-scenario-migration.md#一、执行概览"
+++
