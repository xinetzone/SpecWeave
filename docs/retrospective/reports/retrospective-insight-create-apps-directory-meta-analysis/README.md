...
date = "2026-06-23"
type = "index"
source = "docs/retrospective/reports/retrospective-insight-create-apps-directory-meta-analysis.md"
+++
...
| 章节 | 权威来源 | 说明 |
|------|---------|------|
| 项目概述 | [project-overview.md](project-overview.md) | 交互全景、任务输入、核心指标 |
