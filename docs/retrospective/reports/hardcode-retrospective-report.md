---
type: Report
id: "hardcode-retrospective-report"
title: "项目硬编码问题系统性复盘报告"
x-toml-ref: "../../../.meta/toml/docs/retrospective/reports/hardcode-retrospective-report.toml"
---
...
| 开发规范 | `.agents/docs/development-standards.md` | 项目开发规范 |
