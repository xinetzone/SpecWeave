...
| 上一章 | 目录 | 下一章 | 相关文档 |
|--------|------|--------|---------|
| [01-phase1-facts.md](01-phase1-facts.md) | [README.md](README.md) | [07-improvement-recommendations.md](07-improvement-recommendations.md) / [08-p1-split-plan.md](08-p1-split-plan.md) | [MDI模式应用指南](../../../../../.agents/scripts/mdi/PATTERN-APPLICATION.md) |
