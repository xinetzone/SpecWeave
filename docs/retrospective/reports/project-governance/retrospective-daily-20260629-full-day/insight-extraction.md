...
| 类别 | 交付物 | 说明 |
|---|---|---|
| **架构文档** | [governance-methodology-architecture.md](file:///d:/spaces/SpecWeave/docs/knowledge/governance-methodology-architecture.md) | 治理方法论体系架构总览（~498行），整合核心模型+5个元模式+协作关系+应用指南 |
| **规范更新** | [stage-guardrails.md](file:///d:/spaces/SpecWeave/.agents/rules/stage-guardrails.md) 四层模型章节 | B1规范定义，含Mermaid流程图+验收标准+反模式 |
| **规范更新** | [pre-document-reading.md](file:///d:/spaces/SpecWeave/.agents/protocols/pre-document-reading.md) 二次暴露检查点 | 六步闭环流程+触发条件+角色职责 |
| **检测脚本** | [check-stage-guardrails.py](file:///d:/spaces/SpecWeave/.agents/scripts/check-stage-guardrails.py) 跳层检测 | B2离线检测，识别治理层跳级交付 |
| **检测脚本** | [check-commit-size.py](file:///d:/spaces/SpecWeave/.agents/scripts/check-commit-size.py) | B2离线检测，提交粒度四级预警 |
| **编码安全** | [ci-check.ps1](file:///d:/spaces/SpecWeave/.agents/scripts/ci-check.ps1)/[ci-check.sh](file:///d:/spaces/SpecWeave/.agents/scripts/ci-check.sh) | 跨平台UTF-8编码设置 |
