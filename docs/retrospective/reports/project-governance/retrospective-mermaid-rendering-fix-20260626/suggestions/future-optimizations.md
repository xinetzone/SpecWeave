...
**现状**：已在 [.agents/templates/mermaid-templates/](../../../../../../.agents/templates/mermaid-templates/README.md) 提供 5 种常用图表的安全格式模板。
...
**现状**：规则已写入项目记忆（`project_memory.md`）和[开发规范](../../../../../../docs/development-standards.md)。
