...
> - 通用误报过滤规则引擎：[lib/rules.py](../../../../../../../.agents/scripts/lib/rules.py) + [config/false-positive-rules.toml](../../../../../../../.agents/scripts/config/false-positive-rules.toml)
>
> 🔗 **关联模式升级**：
...
- ✅ "先查共享库"开发约定 → `docs/development-standards.md` + `AGENTS.md`
- ✅ 定期重构审计 → CI第10步集成
