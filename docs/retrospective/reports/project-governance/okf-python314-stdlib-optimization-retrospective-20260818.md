...
> 内存与微基准的采集方法、适用边界详见学习笔记 [13-okf-optimization-report](../../../../projects/awesome-okf-xs/doc/bundles/jishu/python/stdlib/concepts/13-okf-optimization-report.md)（原 learning 板块已于 2026-09 迁移至 bundles）。
