...
共修改9处，文件：[adversarial-review.md](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/ai/ai-engineering-methodology/concepts/evaluation/agent-eval-methodology-wiki/appendices/adversarial-review.md)
...
wiki知识库 [adversarial-review-wiki/](../../../../../projects/awesome-okf-xs/doc/bundles/jishu/ai/ai-engineering-methodology/concepts/methodology/adversarial-review-wiki/README.md) 下共10个文件、40+处引用仍使用旧的"四大攻击者（安全/性能/边界/时序）"定义：
...
- 新增工具：[scan-adversarial-wiki.py](../../../../../.agents/scripts/scan-adversarial-wiki.py) 可复用扫描脚本

**模式沉淀**：本次案例将`version-ripple-grep-sweep`模式从L1升级为L2（validation_count=2），新增"内容四分类法"核心策略。

## 代码SSOT确认

代码定义位置：[knowledge_adversarial.py](../../../../../.agents/scripts/lib/knowledge_adversarial.py#L49-L115)
