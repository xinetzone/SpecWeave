...
| IA-06 | 5个L2模式升级为L3标准化 | insight-extraction §七 | P2 | ✅ 完成 | [patterns/](../../../../patterns/index.md) |
| IA-07 | 新L2模式补充索引 | insight-extraction §七 | P2 | ✅ 完成 | [CATEGORIES.md](../../../../patterns/methodology-patterns/CATEGORIES.md) |
| IA-08 | 认知升级写入开发规范 | insight-extraction §七 | P2 | ✅ 完成 | [development-standards.md](../../../../../tech/references/development-standards.md) |
...
- **可复用模式库**：[patterns/](../../../../patterns/index.md)
