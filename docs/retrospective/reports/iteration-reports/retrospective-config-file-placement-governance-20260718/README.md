...
| 文件 | 行数 | 字节数 | 说明 |
|------|------|--------|------|
| [config-file-placement-convention.md](../../../../knowledge/best-practices/config-file-placement-convention.md) | 432 | 31071 | 7 章节 + 反模式 |
...
- [config-file-placement-convention.md](../../../../knowledge/best-practices/config-file-placement-convention.md)
