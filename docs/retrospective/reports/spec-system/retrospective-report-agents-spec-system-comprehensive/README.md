...
source = "docs/retrospective/reports/spec-system/retrospective-report-agents-spec-system-comprehensive.md"
+++
...
| 章节 | 权威来源 | 说明 |
|------|---------|------|
| 项目概述 | [project-overview.md](project-overview.md) | 项目背景、目标分层、交付物全景、需求演进时间线 |
