...
- [x] 在项目的构建说明中，明确推荐用 `CC=/opt/conda/bin/gcc CXX=/opt/conda/bin/g++` 构建 → 已更新 [README.md](../../../../../index.md) 和 [entrypoint.sh](../../../../../../../external/multica-ai/multica/docker/entrypoint.sh)
...
- [x] 把本次的“重构三步法”加入到团队工程文档 → 已更新 [development-standards.md](../../../../../tech/references/development-standards.md)
