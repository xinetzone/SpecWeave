...
| 2026-06-17-zhujian-wudao-insights-31-52.md | 洞察库·下 | 1868 | 1769/1931/2354 | -21%~+5% | 哲学层+元层（洞察31-65） |
...
| L2 决策层 | insights-01-30 + insights-31-52 | 记录"为什么" | 开发者+AI |
...
gantt
    ...
    section P0 架构阻塞
    场景标签统一     :done, p01, 2026-06-17, 1d
    生活实践日问补全  :done, p02, 2026-06-17, 1d
    定位决策确认     :active, p0new, 2026-06-25, 1d
    section P1 支撑缺失
    开发者群体洞察   :done, p11, 2026-06-18, 1d
    版权合规律洞察   :done, p12, 2026-06-18, 1d
    竞争格局洞察     :done, p13, 2026-06-18, 1d
    跨文件链接修复   :done, p14, 2026-06-18, 1d
    section P2 完备性
    创作者瓶颈洞察   :done, p21, 2026-06-18, 1d
    行无行AI回复     :pending, p23, 2026-06-18, 7d
    帛书核心概念展开 :pending, p24, 2026-06-18, 7d
    section P3 规范性
    文件名一致化     :pending, p33, 2026-06-18, 7d
    定期回顾/流失预警 :pending, p34, 2026-06-18, 7d
    睡前静心场景     :pending, p35, 2026-06-18, 7d
    AGENTS.md补充    :pending, p37, 2026-06-25, 1d
```
...
| 位置 | 问题 | 严重度 |
|------|------|--------|
| insights-31-52.md 头部 | 文件名含31-52，实际内容至65 | P3 |
| insights-31-52.md 头部行数 | 声明1769/1931行，实测1868行 | P3 |
| transferable-methods.md 头部 | 声明540行，实测363行 | P3 |
| AGENTS.md 文件地图 | 缺transferable-methods条目，洞察数标"54条" | P3 |
| review.md §九统计 | 部分文件行数与本次实测有偏差（源于PowerShell wc统计差异） | P3 |
