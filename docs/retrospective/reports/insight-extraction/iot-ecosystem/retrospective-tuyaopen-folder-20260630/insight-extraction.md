...
title: "TuyaOpen 目录全链路复盘 — 洞察与萃取"
x-toml-ref: "../../../../../../.meta/toml/docs/retrospective/reports/insight-extraction/iot-ecosystem/retrospective-tuyaopen-folder-20260630/insight-extraction.toml"
---
...
- **事实支撑**：项目定位强调“跨平台 C/C++ SDK + 云低延迟多模态 AI（拖拽工作流）+ 顶尖模型集成”，[README_zh.md](../../../../../../../playground/debug/TuyaOpen-dev-skills/README_zh.md#L44-L55)
