...
- **核心入口**：`python -m homeassistant` → [__main__.py](../../../../../../.agents/scripts/mdi/__main__.py) → [runner.py](../../../../../../playground/chaos/libs/Nuitka/tests/distutils/example_6_uv_pyproject_flat/example_uv_flat/runner.py) → [bootstrap.py](file:///d:/AI/.temp/libs/home-assistant/core/homeassistant/bootstrap.py)
