...
title: "火山引擎 Mobile Use Agent 文档学习+洞察+更新wiki — 洞察提取报告"
x-toml-ref: "../../../../../../.meta/toml/docs/retrospective/reports/insight-extraction/external-learning/retrospective-volcengine-mobile-use-agent-learning-20260707/insight-extraction.toml"
---
...
| 价值层 | 作用 | 示例 |
|--------|------|------|
| L1 导航 | 帮助读者跳转相关内容 | "详见 `ACEP 云手机/README.md`" |
