...
x-toml-ref: "../../../../../../../.meta/toml/docs/retrospective/reports/insight-extraction/external-learning/retrospective-sphinx-graphql-okf-combination-insights-20260805/insights/insight-05-anti-insight-pseudo-needs.toml"
---
...
> 本反洞察的决策方法已沉淀为方法论模式，可供其他组合分析场景直接复用：

**[🧭 组合价值三重检验模式](../../../../../patterns/methodology-patterns/governance-strategy/combination-value-triple-test.md)**  
*技术组合决策过滤器：避免"为组合而组合"的过度设计，用真实痛点/方案缺口/ROI为正三原则过滤伪需求*
