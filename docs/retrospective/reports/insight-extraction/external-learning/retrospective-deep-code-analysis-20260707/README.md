...
source: "../../../../../../.trae/specs/retrospectives-insights/analyze-deep-code-article"
...
- [Spec 三件套（保留在 spec 目录）](../../../../../../.trae/specs/retrospectives-insights/analyze-deep-code-article/) —— spec.md / tasks.md / checklist.md 过程产物
...
- [阶段守卫规则体系](../../../../../../.agents/rules/stage-guardrails.md) —— 权限控制对照分析的参照对象
