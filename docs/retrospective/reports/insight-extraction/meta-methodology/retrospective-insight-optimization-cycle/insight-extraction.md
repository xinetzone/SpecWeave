...
- `cross_refs`: [three-tier-governance.md](../../../../patterns/methodology-patterns/governance-strategy/three-tier-governance.md)（三层治理是理念落地架构）、[spec-as-code-automated-gates.md](../../../../patterns/methodology-patterns/tools-automation/spec-as-code-automated-gates.md)（规范即代码自动化门禁）、[ci-check-cmd](../../../../../../.agents/skills/ci-check-cmd/SKILL.md)（CI八项检查流水线）
...
4. **文档维护 CI/CD 集成** ✅ 已完成：将链接检查 + 导航表生成纳入 CI/CD 流水线（[ci-check-cmd](../../../../../../.agents/skills/ci-check-cmd/SKILL.md)）
