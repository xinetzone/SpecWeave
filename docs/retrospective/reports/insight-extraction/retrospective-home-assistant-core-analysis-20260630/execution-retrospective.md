...
- 并发去重（domain 级 Future 复用）：见 [setup.py](../../../../../external/anthropics/claude-quickstarts/browser-use-demo/setup.py#L148-L190)
- 依赖与 after_dependencies 的“死锁防护式调度”：见 [setup.py](../../../../../external/anthropics/claude-quickstarts/browser-use-demo/setup.py#L193-L234)
- 尽早处理 requirements + 尽早 import 以提前暴露异常：见 [setup.py](../../../../../external/anthropics/claude-quickstarts/browser-use-demo/setup.py#L330-L345)
