...
tags = ["insight", "extraction", "HomeAssistant", "architecture", "asyncio"]
+++
...
3. **Why-3：为什么工程化层面会阻塞？**  
   因为它对 Python 版本与依赖 pin 有极强约束，且工具链围绕“主仓库统一治理”构建（见 [pyproject.toml](file:///d:/AI/.temp/libs/home-assistant/core/pyproject.toml#L24-L84)）。
