...
```mermaid
flowchart TD
    subgraph sg1 ["应用层（内容/场景）"]
        A1["课程App"]
        A2["笔记App"]
        A3["题库App"]
        A4["阅读App"]
    end
    subgraph sg2 ["认知支持层（学习模式）"]
    ...
    B2 --> A1
    B2 --> A2
    style sg1 fill:#e8f5e9,stroke:#388e3c
    style sg2 fill:#e3f2fd,stroke:#1976d2,stroke-width:2px
    style sg3 fill:#f5f5f5,stroke:#9e9e9e
```
