...
id: "knowledge-base"
title: "知识库"
x-toml-ref: "../../../.meta/toml/docs/tech/references/knowledge-base.toml"
---
...
| 复盘文档体系 | [docs/retrospective/](../../retrospective/index.md) | 项目复盘报告、可复用模式（代码/架构/方法论）、模板、决策框架、知识概念 |
...
详见 [docs/retrospective/README.md](../../retrospective/index.md)。
