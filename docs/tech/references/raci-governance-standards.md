...
title: "RACI 治理规范与模板"
x-toml-ref: "../../../.meta/toml/docs/tech/references/raci-governance-standards.toml"
---
...
> **权威版本**：本文件为面向人类读者的导出版，权威源文件位于 [.agents/rules/raci-governance-standards.md](../../../.agents/rules/raci-governance-standards.md)

## 相关文档

| 文档 | 说明 |
|------|------|
| [角色最小化原则](../../retrospective/patterns/methodology-patterns/governance-strategy/role-minimization-principle.md) | RACI扩展优先于角色新增的80%规则 |
| [五层治理架构](../../retrospective/patterns/methodology-patterns/governance-strategy/five-layer-governance-architecture.md) | 治理体系分层架构 |
| [三层规则执行](../../retrospective/patterns/methodology-patterns/governance-strategy/three-layer-rule-enforcement.md) | 规则执行的三层体系 |
| [治理策略主文档](../../../.agents/commands/README.md) | 指令集目录与RACI总览 |
| [数据安全角色职责矩阵](../../../.agents/rules/data-security/role-responsibilities.md) | 数据安全领域RACI实践案例 |
