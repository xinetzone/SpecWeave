...
| 跑全仓检查 | Python、PowerShell 7 或 Bash | [`ci-check.ps1`](../../../.agents/scripts/ci-check.ps1) / [`ci-check.sh`](../../../.agents/scripts/ci-check.sh) |
| 构建文档站 | Python、Sphinx、invoke | [docs/tasks/docs.py](../../../docs/tasks/docs.py#L72-L130) |
...
- [ci-check.ps1](../../../.agents/scripts/ci-check.ps1#L1-L357)
- [ci-check.sh](../../../.agents/scripts/ci-check.sh#L1-L219)
...
来源见 [docgen.py](../../../.agents/scripts/docgen.py#L1-L17)。
...
这些任务最终都转发到 [docs/tasks/docs.py](../../../docs/tasks/docs.py#L72-L130) 中的 `build/html/linkcheck/doctest/clean`。
...
| 你修改了哪里 | 建议优先运行 |
|---|---|
| 全仓 Markdown 链接（含 `docs/` 文档中心） | `python .agents\scripts\check-links.py` |
