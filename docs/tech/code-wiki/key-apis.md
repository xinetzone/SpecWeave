...
source:
  ...
  - ../../../.agents/scripts/build-ref-index.py
  - ../../../.agents/scripts/lib/project.py
  - ../../../.agents/scripts/lib/frontmatter.py
  - ../../../.agents/scripts/lib/link_fixer/cli.py
  - ../../../.agents/scripts/lib/spec_loader.py
  - ../../../.agents/scripts/lib/stage_guardrails/state/manager.py
  - ../../../.agents/scripts/lib/stage_guardrails/boundary.py
  - ../../../.agents/scripts/lib/stage_guardrails/runtime.py
  - ../../../.agents/scripts/sg_dashboard/models.py
  - ../../../.agents/scripts/sg_dashboard/parser.py
status: stable
...
- 位置：[agents.py](../../../.agents/scripts/agents.py#L171-L242)
...
- 位置：[docgen.py](../../../.agents/scripts/docgen.py#L124-L158)
- 作用：扫描目标目录中的 Markdown 文档并更新带 marker 的导航区块
- 依赖：
  - [resolve_project_root()](../../../.agents/scripts/lib/project.py#L18-L53)
  - [parse_frontmatter_unified()](../../../.agents/scripts/lib/frontmatter.py#L508-L536)
  - `lib.markdown.update_marker_region`
- 典型场景：刷新根 `README.md`、`docs/index.md` 等导航表（文档中心迁移后，扫描目标为根 `docs/`）

### `build_index()`

- 位置：[build-ref-index.py](../../../.agents/scripts/build-ref-index.py#L171-L210)
...
- 位置：[project.py](../../../.agents/scripts/lib/project.py#L18-L53)
- 作用：从任意锚点文件向上查找项目根目录
- 查找策略：
...
- 位置：[frontmatter.py](../../../.agents/scripts/lib/frontmatter.py#L508-L536)
...
- 位置：[link_fixer/cli.py](../../../.agents/scripts/lib/link_fixer/cli.py#L32-L110)
...
- 位置：[spec_loader.py](../../../.agents/scripts/lib/spec_loader.py#L320-L327)
- 作用：表示单个已加载规范文件的元数据
- 关键字段：`path`、`layer`、`content`、`char_count`、`loaded_from`

### `LoadResult`

- 位置：[spec_loader.py](../../../.agents/scripts/lib/spec_loader.py#L329-L373)
- 作用：聚合一次规范加载的结果
- 关键能力：
  - 统计各层已加载文件数
  - 跟踪 `missing_specs`
...
- 位置：[spec_loader.py](../../../.agents/scripts/lib/spec_loader.py#L376-L497)
...
- 位置：[state/manager.py](../../../.agents/scripts/lib/stage_guardrails/state/manager.py#L21-L115)
- 作用：维护单个会话的阶段状态机
- 管理内容：
  - 当前阶段与当前角色
  - 阶段转换记录
...
- 位置：[boundary.py](../../../.agents/scripts/lib/stage_guardrails/boundary.py#L450-L549)
...
- 位置：[runtime.py](../../../.agents/scripts/lib/stage_guardrails/runtime.py#L83-L207)
...
- 位置：[sg_dashboard/models.py](../../../.agents/scripts/sg_dashboard/models.py#L25-L39)
- 作用：表示单条结构化日志
- 关键字段：`event`、`stage`、`role`、`session`、`ctx`、`source_file`、`line_num`

### `SessionStats`

- 位置：[sg_dashboard/models.py](../../../.agents/scripts/sg_dashboard/models.py#L41-L63)
- 作用：表示单个会话的统计快照
- 统计内容：阶段进入/退出、操作检查/放行/拦截、跳转申请、错误数、会话完成状态

### `AggregateStats`

- 位置：[sg_dashboard/models.py](../../../.agents/scripts/sg_dashboard/models.py#L65-L107)
- 作用：表示跨会话聚合结果
- 派生属性：
  - `interception_rate`
  - `approval_rate`
...
- 位置：[sg_dashboard/parser.py](../../../.agents/scripts/sg_dashboard/parser.py#L39-L77)
