...
| ⑦ 交付验收层 | 🟦 青色 | 质量门禁 + 产出物归档 + 记录留存 | [development-standards.md](../references/development-standards.md) |
...
- [development-standards.md](../references/development-standards.md) - 开发规范与质量门禁
