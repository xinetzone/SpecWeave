...
x-toml-ref: "../../.meta/toml/docs/topics/reuse-and-generalization.toml"
---
# 泛化与资产复用
...
- 系统入口：[apps/dev-tools/prompt_extraction/](../../apps/dev-tools/prompt_extraction/README.md)（Streamlit UI 入口：[ui/app.py](../../apps/dev-tools/prompt_extraction/ui/app.py)）
...
- 项目亮点与核心优势见 [project-highlights.md](../tech/references/project-highlights.md)
- 方法论模式库见 [retrospective/patterns/](../retrospective/patterns/index.md)
